...
load("//third_party/xla:workspace.bzl", olympus_xla_workspace = "repo")

olympus_xla_workspace()
...
python_init_repositories(
    ...
    local_wheel_workspaces = ["//olympuslib:olympus.bzl"],
    requirements = {
...
load("//olympuslib:olympus_python_wheel.bzl", "olympus_python_wheel_repository")

olympus_python_wheel_repository(
    name = "olympus_wheel",
    version_key = "_version",
    version_source = "//olympus:version.py",
)
...
python_wheel_version_suffix_repository(
    name = "olympus_wheel_version_suffix",
)
