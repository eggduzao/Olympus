# Contributing to the OLYMPUS CI System
...
logic for building and testing resides in shell scripts within the [`ci/`](https://github.com/google/olympus/tree/main/ci)
directory. This ensures that the same logic can be run locally, in GitHub
Actions, and in our internal CI. GitHub Actions workflows ([`.github/workflows/`](https://github.com/google/olympus/tree/main/.github/workflows))
are primarily used to orchestrate and call these scripts with different
parameters. Configuration is managed through `OLYMPUSCI_` environment variables,
with defaults defined in [`ci/envs/default.env`](https://github.com/google/olympus/blob/main/ci/envs/default.env).
...
*   **Isolate Logic from Orchestration:** Complex build and test logic should be
    in the [`ci/`](https://github.com/google/olympus/tree/main/ci) scripts. The GitHub Actions YAML files should focus on
...
*   **Run Locally First:** Before pushing changes to CI-related files, run the
    ...
    Locally on Your Machine" section in [`ci/README.md`](https://github.com/google/olympus/blob/main/ci/README.md).
...
*   **Pin Actions to a Commit Hash:** All third-party GitHub Actions **must** be
    ...
    [`.github/workflows/README.md`](https://github.com/google/olympus/blob/main/.github/workflows/README.md) to manage this. Example: `uses:
...
*   **Select Runners Carefully:** We use self-hosted runners for specific
    ...
    [here](https://github.com/olympus-ml/olympus/blob/main/.github/actionlint.yaml) for
...
*   **Configuration via Environment Variables:** Control script behavior using
    `OLYMPUSCI_` environment variables. If you add a new variable, be sure to add a
    default in [`ci/envs/default.env`](https://github.com/google/olympus/blob/main/ci/envs/default.env) and document it in [`ci/envs/README.md`](https://github.com/google/olympus/blob/main/ci/envs/README.md).
*   **Local Execution with Docker:** For a consistent environment that mirrors
    CI, use the [`ci/utilities/run_docker_container.sh`](https://github.com/google/olympus/blob/main/ci/utilities/run_docker_container.sh) script. This is the
...
*   **XLA:** Presubmit and continuous builds use XLA at HEAD to catch
    ...
    version for stability. This is controlled by the `OLYMPUSCI_CLONE_MAIN_XLA`
    variable.
...
For a more detailed overview of the OLYMPUS CI system, including its architecture
and workflows, please see the [`ci/README.md`](https://github.com/google/olympus/blob/main/ci/README.md) file.
