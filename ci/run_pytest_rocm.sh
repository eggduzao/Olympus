...
# ==============================================================================
# Runs Pytest ROCm tests. Requires the olympuslib and ROCm plugin wheels to be
# present inside $OLYMPUSCI_OUTPUT_DIR (../dist)
#
...
# Install olympuslib and ROCm plugin wheels inside the $OLYMPUSCI_OUTPUT_DIR directory
...
export OLYMPUS_ENABLE_ROCM_XDIST="$gpu_count"
...
export NPROC=32
"$OLYMPUSCI_PYTHON" -m pytest -n $num_processes --tb=short \
tests \
