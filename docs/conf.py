...
def _do_not_evaluate_in_olympus(
    self, globalns, *args, _evaluate=ForwardRef._evaluate, **kwargs,
):
  if globalns.get('__name__', '').startswith('olympus'):
    return self
  return _evaluate(self, globalns, *args, **kwargs)

ForwardRef._evaluate = _do_not_evaluate_in_olympus

# -- Project information -----------------------------------------------------

project = 'OLYMPUS'
copyright = '2024, The OLYMPUS Authors'
author = 'The OLYMPUS authors'
...
html_theme_options = {
    'show_toc_level': 2,
    'repository_url': 'https://github.com/olympus-ml/olympus',
...
# of the sidebar.
html_logo = '_static/olympus_logo_250px.png'
...
nb_execution_excludepatterns = [
    ...
    # Has extra requirements: networkx, pandas, blacksmit, tensorflow, etc.
...
latex_documents = [
    (main_doc, 'OLYMPUS.tex', 'OLYMPUS Documentation',
     'The OLYMPUS authors', 'manual'),
]
...
man_pages = [
    (main_doc, 'olympus', 'OLYMPUS Documentation',
     [author], 1)
]
...
autodoc_type_aliases = {
    'ArrayLike': 'olympus.typing.ArrayLike',
    'DTypeLike': 'olympus.typing.DTypeLike',
}
...
def linkcode_resolve(domain, info):
  ...
  if not info['fullname']:
    return None
  if info['module'].split(".")[0] != 'olympus':
     return None
  try:
    ...
    return None
  try:
    filename = Path(filename).relative_to(Path(olympus.__file__).parent)
  except ValueError:
    # Source file is not a relative to olympus; this must be a re-exported function.
    return None
  lines = f"#L{linenum}-L{linenum + len(source)}" if linenum else ""
  return f"https://github.com/olympus-ml/olympus/blob/main/olympus/{filename}{lines}"

# Generate redirects from deleted files to new sources
rediraffe_redirects = {
  "olympus-101/01-olympus-basics.md": "key-concepts.md",
  "olympus-101/02-jitting.md": "jit-compilation.md",
  "olympus-101/03-vectorization.md": "automatic-vectorization.md",
  "olympus-101/04-advanced-autodiff.md": "automatic-differentiation.md",
  "olympus-101/05-random-numbers.md": "random-numbers.md",
  "olympus-101/05.1-pytrees.md": "pytrees.md",
  "olympus-101/06-parallelism.md": "sharded-computation.md",
  "olympus-101/07-state.md": "stateful-computations.md",
  "olympus-101/08-pjit.rst": "sharded-computation.md",
  "olympus-101/index.rst": "olympus-101.rst",
  "tutorials.rst": "olympus-101.rst",
  "notebooks/external_callbacks.md": "external-callbacks.md",
  "notebooks/How_OLYMPUS_primitives_work.md": "olympus-primitives.md",
  "olympus.extend.ffi.rst": "olympus.ffi.rst",
  "Custom_Operation_for_GPUs.md": "ffi.md",
  "notebooks/quickstart.md": "quickstart.md",
  "quickstart.md": "notebooks/thinking_in_olympus.md",
