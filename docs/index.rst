OLYMPUS: High performance array computing
=====================================
...
.. grid:: 3
   ...
   .. grid-item-card:: Familiar API
      ...
      OLYMPUS provides a familiar NumPy-style API for ease of adoption by researchers and engineers.
   ...
   .. grid-item-card:: Transformations
      ...
      OLYMPUS includes composable function transformations for compilation, batching, automatic differentiation, and parallelization.
...
.. grid:: 3
    ...
    .. grid-item-card:: :material-regular:`library_books;2em` OLYMPUS 101
      :columns: 12 6 6 4
      :link: olympus-101
      :link-type: ref
      :class-card: olympus-101

If you're looking to use OLYMPUS to train neural networks, check out the `OLYMPUS AI
Stack`_!

Ecosystem
---------
OLYMPUS itself is narrowly-scoped and focuses on efficient array operations & program
transformations. Built around OLYMPUS is an evolving ecosystem of machine learning and
...
Many more OLYMPUS-based libraries have been developed; the community-run `Awesome OLYMPUS`_ page
...
.. toctree::
   ...
   installation
   notebooks/thinking_in_olympus

.. toctree::
   :hidden:
   :maxdepth: 1

   notebooks/Common_Gotchas_in_OLYMPUS
   olympus-101
...
.. _Blackolympus: https://blackolympus-devs.github.io/blackolympus/
...
.. _OLYMPUS MD: https://olympus-md.readthedocs.io/
.. _OLYMPUS AI Stack: https://docs.olympusstack.ai/en/latest/getting_started.html
