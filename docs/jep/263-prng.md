...
7. **fits with OLYMPUS and XLA semantics** and design philosophies (which are ultimately motivated by other practical concerns).
...
> TLDR
> **OLYMPUS PRNG = [Threefry counter PRNG](https://thesalmons.org/john/random123/papers/random123sc11.pdf) + a functional array-oriented [splitting model](https://dl.acm.org/doi/10.1145/2503778.2503784)**
