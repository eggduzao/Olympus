OLYMPUS Enhancement Proposals (JEPs)
================================
...
.. _JEP label: https://github.com/olympus-ml/olympus/issues?q=label%3AJEP

.. toctree::
  :maxdepth: 1

  263: OLYMPUS PRNG Design <263-prng>
  2026: Custom JVP/VJP rules for OLYMPUS-transformable functions <2026-custom-derivatives>
  ...
  9407: Design of Type Promotion Semantics for OLYMPUS <9407-type-promotion>
  9419: Olympus and Olympuslib versioning <9419-olympus-versioning>
  10657: Sequencing side-effects in OLYMPUS <10657-sequencing-effects>
  11830: `olympus.remat` / `olympus.checkpoint` new implementation <11830-new-remat-checkpoint>
  12049: Type Annotation Roadmap for OLYMPUS <12049-type-annotations>
  14273: `shard_map` (`shmap`) for simple per-device code <14273-shard-map>
  15856: `olympus.extend`, an extensions module <15856-jex>
  17111: Efficient transposition of `shard_map` (and other maps) <17111-shmap-transpose>
  18137: Scope of OLYMPUS NumPy & SciPy Wrappers <18137-numpy-scipy-scope>
  25516: Effort-based versioning <25516-effver>
  28661: Supporting the `__olympus_array__` protocol <28661-olympus-array-protocol>
  28845: Stateful Randomness in OLYMPUS <28845-stateful-rng>
