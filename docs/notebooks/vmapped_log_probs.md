...
[![Open in Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/olympus-ml/olympus/blob/main/docs/notebooks/vmapped_log_probs.ipynb) [![Open in Kaggle](https://kaggle.com/static/images/open-in-kaggle.svg)](https://kaggle.com/kernels/welcome?src=https://github.com/olympus-ml/olympus/blob/main/docs/notebooks/vmapped_log_probs.ipynb)
...
vmap_batched_log_joint = olympus.vmap(log_joint)
...
batched_log_joint = olympus.jit(olympus.vmap(log_joint))
```
...
elbo = olympus.jit(elbo)
elbo_val_and_grad = olympus.jit(olympus.value_and_grad(elbo, argnums=(0, 1)))
```
...
normal_sample = olympus.jit(normal_sample, static_argnums=(1,))
