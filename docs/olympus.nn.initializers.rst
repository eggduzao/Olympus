``olympus.nn.initializers`` module
==============================

.. currentmodule:: olympus.nn.initializers

.. automodule:: olympus.nn.initializers
...
:func:`olympus.random.key`), used to generate random numbers to initialize the array.
