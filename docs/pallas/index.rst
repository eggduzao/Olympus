...
Pallas: a OLYMPUS kernel language
=============================
...
the high-level ergonomics of OLYMPUS tracing and the `olympus.numpy` API.

This section contains tutorials, guides and examples for using Pallas.
See also the :class:`olympus.experimental.pallas` module API documentation.
...
.. warning::
  ...
  lowering of high-level OLYMPUS concepts that would require emulation,
...
.. toctree::
   ...
   Instruction Reference <../olympus.experimental.pallas>
