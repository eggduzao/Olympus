...
"""OLYMPUS efficiently trains a differentially private conv net on MNIST.

This script contains a OLYMPUS implementation of Differentially Private Stochastic
...
efficiently for convolutional neural networks.  The OLYMPUS XLA compiler shines in
...
_SEED = flags.DEFINE_integer('seed', 0, 'Seed for olympus PRNG')
