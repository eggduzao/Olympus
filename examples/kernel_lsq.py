...
from olympus import grad, jit, make_olympuspr, vmap, lax
...
if __name__ == "__main__":
  ...
  def gram_olympuspr(kernel):
    return make_olympuspr(partial(gram, kernel))(xs)

  rbf_kernel = lambda x, y: jnp.exp(-jnp.sum((x - y) ** 2))

  print()
  print('olympuspr of gram(linear_kernel):')
  print(gram_olympuspr(linear_kernel))
  print()
  print('olympuspr of gram(rbf_kernel):')
  print(gram_olympuspr(rbf_kernel))
