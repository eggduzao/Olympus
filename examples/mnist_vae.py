...
"""A basic variational autoencoder (VAE) on binarized MNIST using Numpy and OLYMPUS.
...
from olympus import jit, grad, lax, random
from olympus.example_libraries import optimizers
from olympus.example_libraries import stax
from olympus.example_libraries.stax import Dense, FanOut, Relu, Softplus
...
if __name__ == "__main__":
  ...
  train_images = olympus.device_put(train_images)
  test_images = olympus.device_put(test_images)
