...
//
// $ python3 olympus/tools/olympus_to_ir.py \
// --fn examples.olympus_cpp.prog.fn \
...
//
// $ bazel build examples/olympus_cpp:main --experimental_repo_remote_exec \
//    --check_visibility=false
// $ bazel-bin/examples/olympus_cpp/main 2021-01-12
// 15:35:28.316880: I examples/olympus_cpp/main.cc:65] result = ( f32[2,2] {
//   { 1.5, 1.5 },
//   { 3.5, 3.5 }
// }
// )
...
int main(int argc, char** argv) {
  ...
  // Run it using OLYMPUS C++ Runtime (PJRT).
