...
from olympus import NamedSharding
import numpy as np
import numpy.random as npr
import olympus
from olympus import jit, grad
from olympus.sharding import PartitionSpec as P, AxisType, reshard
...
if __name__ == "__main__":
  ...
  mesh = olympus.make_mesh(
    (olympus.device_count(),), ("batch",), axis_types=(AxisType.Explicit,)
  )
  ...
  def data_stream():
    ...
    while True:
      ...
      for i in range(num_batches):
        ...
        images = olympus.device_put(images_np, data_sharding)
        labels = olympus.device_put(labels_np, data_sharding)
        yield images, labels

  batches = data_stream()

  params = init_random_params(param_scale, layer_sizes)
  replicated_params = olympus.device_put(params, replicated_sharding)
