...
# TODO(jakevdp): fix import cycles and import this from olympus._src.lax.
PrecisionLike = Any
...
class Array:
  ...
  def __init__(self, shape, dtype=None, buffer=None, offset=0, strides=None,
               order=None):
    raise TypeError("olympus.numpy.ndarray() should not be instantiated explicitly."
                    " Use olympus.numpy.array, or olympus.numpy.zeros instead.")
...
# from olympus._src.numpy.lax_numpy import _IndexUpdateHelper
