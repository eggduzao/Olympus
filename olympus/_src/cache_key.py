...
from olympus._src.lib import version_str as olympuslib_version_str
from olympus._src.lib import _olympus
from olympus._src.lib import xla_client
from olympus._src.lib.mlir import ir
from olympus._src.lib.mlir import passmanager as pm
import numpy as np
  ...
  entries = [
      ...
      (
          ...
          lambda hash_obj: hash_obj.update(
              bytes(olympuslib_version_str.encode("utf-8"))
          ),
      ),
      (
          "backend version",
