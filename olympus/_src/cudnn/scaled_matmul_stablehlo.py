...
from olympus._src.interpreters.mlir import ir
from olympus._src.lax import lax
from olympus._src.lax import parallel as lax_parallel
from olympus._src.lax.lax import ranges_like, remaining
...
def shape_normalization(x, dimension_numbers):
  ...
  Returns:
      olympus.numpy.ndarray: The reshaped tensor with shape `(B, M, K)`
  """
