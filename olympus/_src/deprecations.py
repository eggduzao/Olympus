...
#
# Example usage:
# from olympus._src.interpreters.pxla import (
...
#   # Added Feb 8, 2023:
#   "Mesh": (
#     "olympus.interpreters.pxla.Mesh is deprecated. Use olympus.sharding.Mesh.",
#     _deprecated_Mesh,
#   ),
# }
#
...
register('olympus-checkpoint-concrete')
register('olympus-nn-one-hot-float-input')
register('olympus-numpy-arange-complex')
register('olympus-numpy-astype-complex-to-real')
register('olympus-numpy-clip-args')
register('olympus-scipy-special-sph-harm')
register('olympus-pmap-shmap-merge')
