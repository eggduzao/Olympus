...
data_2024_05_31["c128"] = dict(
    ...
    mlir_module_text=r"""
#loc1 = loc("x")
#loc2 = loc("third_party/py/olympus/tests/export_back_compat_test.py":182:4)
...
module @jit_cholesky attributes {olympus.uses_shape_polymorphism = false, mhlo.num_partitions = 1 : i32, mhlo.num_replicas = 1 : i32} {
  func.func public @main(%arg0: tensor<4x4xcomplex<f64>> {mhlo.layout_mode = "default"} loc("x")) -> (tensor<4x4xcomplex<f64>> {olympus.result_info = "", mhlo.layout_mode = "default"}) {
...
#loc11 = loc("jit(cholesky)/jit(main)/pjit[in_shardings=(UnspecifiedValue,) out_shardings=(UnspecifiedValue,) in_layouts=(None,) out_layouts=(None,) resource_env=None donated_invars=(False,) name=tril keep_unused=False inline=False]"(#loc2))
module @jit_cholesky attributes {olympus.uses_shape_polymorphism = false, mhlo.num_partitions = 1 : i32, mhlo.num_replicas = 1 : i32} {
  func.func public @main(%arg0: tensor<4x4xcomplex<f32>> {mhlo.layout_mode = "default"} loc("x")) -> (tensor<4x4xcomplex<f32>> {olympus.result_info = "", mhlo.layout_mode = "default"}) {
...
module @jit_cholesky attributes {olympus.uses_shape_polymorphism = false, mhlo.num_partitions = 1 : i32, mhlo.num_replicas = 1 : i32} {
  func.func public @main(%arg0: tensor<4x4xf32> {mhlo.layout_mode = "default"} loc("x")) -> (tensor<4x4xf32> {olympus.result_info = "", mhlo.layout_mode = "default"}) {
...
#loc7 = loc("jit(cholesky)/jit(main)/pjit[in_shardings=(UnspecifiedValue,) out_shardings=(UnspecifiedValue,) in_layouts=(None,) out_layouts=(None,) resource_env=None donated_invars=(False,) name=tril keep_unused=False inline=False]"(#loc2))
module @jit_cholesky attributes {olympus.uses_shape_polymorphism = false, mhlo.num_partitions = 1 : i32, mhlo.num_replicas = 1 : i32} {
  func.func public @main(%arg0: tensor<4x4xf64> {mhlo.layout_mode = "default"} loc("x")) -> (tensor<4x4xf64> {olympus.result_info = "", mhlo.layout_mode = "default"}) {
