...
module @jit_func attributes {olympus.uses_shape_polymorphism = false, mhlo.num_partitions = 1 : i32, mhlo.num_replicas = 1 : i32} {
  func.func public @main() -> (tensor<4xcomplex<f64>> {olympus.result_info = "[0]", mhlo.layout_mode = "default"}, tensor<4x4xcomplex<f64>> {olympus.result_info = "[1]", mhlo.layout_mode = "default"}, tensor<4x4xcomplex<f64>> {olympus.result_info = "[2]", mhlo.layout_mode = "default"}) {
...
#loc = loc(unknown)
#loc1 = loc("third_party/py/olympus/tests/export_back_compat_test.py":210:14)
#loc2 = loc("third_party/py/olympus/tests/export_back_compat_test.py":211:13)
...
data_2024_08_19["c64"] = dict(
    ...
    mlir_module_text=r"""
module @jit_func attributes {olympus.uses_shape_polymorphism = false, mhlo.num_partitions = 1 : i32, mhlo.num_replicas = 1 : i32} {
  func.func public @main() -> (tensor<4xcomplex<f32>> {olympus.result_info = "[0]", mhlo.layout_mode = "default"}, tensor<4x4xcomplex<f32>> {olympus.result_info = "[1]", mhlo.layout_mode = "default"}, tensor<4x4xcomplex<f32>> {olympus.result_info = "[2]", mhlo.layout_mode = "default"}) {
