...
data_2024_08_19["c128"] = dict(
    ...
    mlir_module_text=r"""
#loc7 = loc("third_party/py/olympus/tests/export_back_compat_test.py":277:27)
...
module @jit__lambda_ attributes {olympus.uses_shape_polymorphism = false, mhlo.num_partitions = 1 : i32, mhlo.num_replicas = 1 : i32} {
  func.func public @main() -> (tensor<8x8xcomplex<f64>> {olympus.result_info = "[0]", mhlo.layout_mode = "default"}, tensor<8xf64> {olympus.result_info = "[1]", mhlo.layout_mode = "default"}) {
...
#loc = loc(unknown)
#loc1 = loc("third_party/py/olympus/tests/export_back_compat_test.py":269:26)
#loc2 = loc("third_party/py/olympus/tests/export_back_compat_test.py":269:14)
#loc3 = loc("third_party/py/olympus/tests/export_back_compat_test.py":271:34)
#loc4 = loc("third_party/py/olympus/tests/export_back_compat_test.py":271:25)
#loc5 = loc("third_party/py/olympus/tests/export_back_compat_test.py":271:15)
#loc6 = loc("third_party/py/olympus/tests/export_back_compat_test.py":271:14)
#loc8 = loc("third_party/py/olympus/tests/export_back_compat_test.py":277:11)
...
#loc18 = loc("jit(<lambda>)/jit(main)/pjit[in_shardings=(UnspecifiedValue,) out_shardings=(UnspecifiedValue,) in_layouts=(None,) out_layouts=(None,) resource_env=None donated_invars=(False,) name=tril keep_unused=False inline=False]"(#loc7))
module @jit__lambda_ attributes {olympus.uses_shape_polymorphism = false, mhlo.num_partitions = 1 : i32, mhlo.num_replicas = 1 : i32} {
  func.func public @main() -> (tensor<8x8xcomplex<f32>> {olympus.result_info = "[0]", mhlo.layout_mode = "default"}, tensor<8xf32> {olympus.result_info = "[1]", mhlo.layout_mode = "default"}) {
...
data_2024_08_19["f32"] = dict(
    ...
    expected_outputs=(array([[-0.6185769    , -0.20142993   , -0.09725195   ,  0.62983674   ,
      ...
      dtype=float32)),
    mlir_module_text=r"""
#loc6 = loc("third_party/py/olympus/tests/export_back_compat_test.py":277:27)
...
module @jit__lambda_ attributes {olympus.uses_shape_polymorphism = false, mhlo.num_partitions = 1 : i32, mhlo.num_replicas = 1 : i32} {
  func.func public @main() -> (tensor<8x8xf32> {olympus.result_info = "[0]", mhlo.layout_mode = "default"}, tensor<8xf32> {olympus.result_info = "[1]", mhlo.layout_mode = "default"}) {
...
#loc2 = loc("third_party/py/olympus/tests/export_back_compat_test.py":269:14)
#loc3 = loc("third_party/py/olympus/tests/export_back_compat_test.py":271:34)
#loc4 = loc("third_party/py/olympus/tests/export_back_compat_test.py":271:15)
#loc5 = loc("third_party/py/olympus/tests/export_back_compat_test.py":271:14)
#loc7 = loc("third_party/py/olympus/tests/export_back_compat_test.py":277:11)
...
#loc13 = loc("jit(<lambda>)/jit(main)/pjit[in_shardings=(UnspecifiedValue,) out_shardings=(UnspecifiedValue,) in_layouts=(None,) out_layouts=(None,) resource_env=None donated_invars=(False,) name=tril keep_unused=False inline=False]"(#loc6))
module @jit__lambda_ attributes {olympus.uses_shape_polymorphism = false, mhlo.num_partitions = 1 : i32, mhlo.num_replicas = 1 : i32} {
  func.func public @main() -> (tensor<8x8xf64> {olympus.result_info = "[0]", mhlo.layout_mode = "default"}, tensor<8xf64> {olympus.result_info = "[1]", mhlo.layout_mode = "default"}) {
