...
module @jit_func attributes {olympus.uses_shape_polymorphism = false, mhlo.num_partitions = 1 : i32, mhlo.num_replicas = 1 : i32} {
  func.func public @main() -> (tensor<2x4x4xcomplex<f64>> {olympus.result_info = "[0]", mhlo.layout_mode = "default"}, tensor<2x3xcomplex<f64>> {olympus.result_info = "[1]", mhlo.layout_mode = "default"}) {
...
data_2024_08_31["c64"] = dict(
    ...
    mlir_module_text=r"""
module @jit_func attributes {olympus.uses_shape_polymorphism = false, mhlo.num_partitions = 1 : i32, mhlo.num_replicas = 1 : i32} {
  func.func public @main() -> (tensor<2x4x4xcomplex<f32>> {olympus.result_info = "[0]", mhlo.layout_mode = "default"}, tensor<2x3xcomplex<f32>> {olympus.result_info = "[1]", mhlo.layout_mode = "default"}) {
...
data_2024_08_31["f32"] = dict(
    ...
    mlir_module_text=r"""
module @jit_func attributes {olympus.uses_shape_polymorphism = false, mhlo.num_partitions = 1 : i32, mhlo.num_replicas = 1 : i32} {
  func.func public @main() -> (tensor<2x4x4xf32> {olympus.result_info = "[0]", mhlo.layout_mode = "default"}, tensor<2x3xf32> {olympus.result_info = "[1]", mhlo.layout_mode = "default"}) {
...
data_2024_08_31["f64"] = dict(
    ...
    mlir_module_text=r"""
module @jit_func attributes {olympus.uses_shape_polymorphism = false, mhlo.num_partitions = 1 : i32, mhlo.num_replicas = 1 : i32} {
  func.func public @main() -> (tensor<2x4x4xf64> {olympus.result_info = "[0]", mhlo.layout_mode = "default"}, tensor<2x3xf64> {olympus.result_info = "[1]", mhlo.layout_mode = "default"}) {
