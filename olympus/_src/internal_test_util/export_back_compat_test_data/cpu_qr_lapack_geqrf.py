...
module @jit__lambda_ attributes {olympus.uses_shape_polymorphism = false, mhlo.num_partitions = 1 : i32, mhlo.num_replicas = 1 : i32} {
  func.func public @main() -> (tensor<3x3xcomplex<f64>> {olympus.result_info = "result[0]"}, tensor<3x3xcomplex<f64>> {olympus.result_info = "result[1]"}) {
...
#loc = loc(unknown)
#loc1 = loc("third_party/py/olympus/tests/export_back_compat_test.py":411:26)
#loc2 = loc("third_party/py/olympus/tests/export_back_compat_test.py":411:14)
#loc3 = loc("third_party/py/olympus/tests/export_back_compat_test.py":412:11)
...
data_2025_04_02['c64'] = dict(
    ...
    mlir_module_text=r"""
module @jit__lambda_ attributes {olympus.uses_shape_polymorphism = false, mhlo.num_partitions = 1 : i32, mhlo.num_replicas = 1 : i32} {
  func.func public @main() -> (tensor<3x3xcomplex<f32>> {olympus.result_info = "result[0]"}, tensor<3x3xcomplex<f32>> {olympus.result_info = "result[1]"}) {
    %c = stablehlo.constant dense<-1> : tensor<i32> loc(#loc)
...
data_2025_04_02['f32'] = dict(
    ...
    mlir_module_text=r"""
module @jit__lambda_ attributes {olympus.uses_shape_polymorphism = false, mhlo.num_partitions = 1 : i32, mhlo.num_replicas = 1 : i32} {
  func.func public @main() -> (tensor<3x3xf32> {olympus.result_info = "result[0]"}, tensor<3x3xf32> {olympus.result_info = "result[1]"}) {
    %c = stablehlo.constant dense<-1> : tensor<i32> loc(#loc)
...
data_2025_04_02['f64'] = dict(
    ...
    mlir_module_text=r"""
module @jit__lambda_ attributes {olympus.uses_shape_polymorphism = false, mhlo.num_partitions = 1 : i32, mhlo.num_replicas = 1 : i32} {
  func.func public @main() -> (tensor<3x3xf64> {olympus.result_info = "result[0]"}, tensor<3x3xf64> {olympus.result_info = "result[1]"}) {
    %c = stablehlo.constant dense<-1> : tensor<i32> loc(#loc)
