...
module @jit_func attributes {olympus.uses_shape_polymorphism = false, mhlo.num_partitions = 1 : i32, mhlo.num_replicas = 1 : i32} {
  func.func public @main(%arg0: tensor<4x4xcomplex<f64>> loc("input")) -> (tensor<4x4xcomplex<f64>> {olympus.result_info = "[0]"}, tensor<4x4xcomplex<f64>> {olympus.result_info = "[1]"}) {
...
#loc1 = loc("input")
module @jit_func attributes {olympus.uses_shape_polymorphism = false, mhlo.num_partitions = 1 : i32, mhlo.num_replicas = 1 : i32} {
  func.func public @main(%arg0: tensor<4x4xcomplex<f32>> loc("input")) -> (tensor<4x4xcomplex<f32>> {olympus.result_info = "[0]"}, tensor<4x4xcomplex<f32>> {olympus.result_info = "[1]"}) {
...
#loc1 = loc("input")
module @jit_func attributes {olympus.uses_shape_polymorphism = false, mhlo.num_partitions = 1 : i32, mhlo.num_replicas = 1 : i32} {
  func.func public @main(%arg0: tensor<4x4xf32> loc("input")) -> (tensor<4x4xf32> {olympus.result_info = "[0]"}, tensor<4x4xf32> {olympus.result_info = "[1]"}) {
...
#loc1 = loc("input")
module @jit_func attributes {olympus.uses_shape_polymorphism = false, mhlo.num_partitions = 1 : i32, mhlo.num_replicas = 1 : i32} {
  func.func public @main(%arg0: tensor<4x4xf64> loc("input")) -> (tensor<4x4xf64> {olympus.result_info = "[0]"}, tensor<4x4xf64> {olympus.result_info = "[1]"}) {
