...
module @jit_func attributes {olympus.uses_shape_polymorphism = false, mhlo.num_partitions = 1 : i32, mhlo.num_replicas = 1 : i32} {
  func.func public @main(%arg0: tensor<2x4x4xcomplex<f64>> {mhlo.layout_mode = "default"} loc("input")) -> (tensor<2x4x4xcomplex<f64>> {olympus.result_info = "[0]", mhlo.layout_mode = "default"}, tensor<2x4xf64> {olympus.result_info = "[1]", mhlo.layout_mode = "default"}, tensor<2x4x4xcomplex<f64>> {olympus.result_info = "[2]", mhlo.layout_mode = "default"}) {
...
#loc1 = loc("input")
module @jit_func attributes {olympus.uses_shape_polymorphism = false, mhlo.num_partitions = 1 : i32, mhlo.num_replicas = 1 : i32} {
  func.func public @main(%arg0: tensor<2x4x4xcomplex<f32>> {mhlo.layout_mode = "default"} loc("input")) -> (tensor<2x4x4xcomplex<f32>> {olympus.result_info = "[0]", mhlo.layout_mode = "default"}, tensor<2x4xf32> {olympus.result_info = "[1]", mhlo.layout_mode = "default"}, tensor<2x4x4xcomplex<f32>> {olympus.result_info = "[2]", mhlo.layout_mode = "default"}) {
    %c = stablehlo.constant dense<2> : tensor<i64> loc(#loc3)
    %c_0 = stablehlo.constant dense<4> : tensor<i64> loc(#loc3)
    %c_1 = stablehlo.constant dense<4> : tensor<i64> loc(#loc3)
...
#loc1 = loc("input")
module @jit_func attributes {olympus.uses_shape_polymorphism = false, mhlo.num_partitions = 1 : i32, mhlo.num_replicas = 1 : i32} {
  func.func public @main(%arg0: tensor<2x4x4xf32> {mhlo.layout_mode = "default"} loc("input")) -> (tensor<2x4x4xf32> {olympus.result_info = "[0]", mhlo.layout_mode = "default"}, tensor<2x4xf32> {olympus.result_info = "[1]", mhlo.layout_mode = "default"}, tensor<2x4x4xf32> {olympus.result_info = "[2]", mhlo.layout_mode = "default"}) {
    %c = stablehlo.constant dense<2> : tensor<i64> loc(#loc3)
    %c_0 = stablehlo.constant dense<4> : tensor<i64> loc(#loc3)
    %c_1 = stablehlo.constant dense<4> : tensor<i64> loc(#loc3)
...
#loc1 = loc("input")
module @jit_func attributes {olympus.uses_shape_polymorphism = false, mhlo.num_partitions = 1 : i32, mhlo.num_replicas = 1 : i32} {
  func.func public @main(%arg0: tensor<2x4x4xf64> {mhlo.layout_mode = "default"} loc("input")) -> (tensor<2x4x4xf64> {olympus.result_info = "[0]", mhlo.layout_mode = "default"}, tensor<2x4xf64> {olympus.result_info = "[1]", mhlo.layout_mode = "default"}, tensor<2x4x4xf64> {olympus.result_info = "[2]", mhlo.layout_mode = "default"}) {
    %c = stablehlo.constant dense<2> : tensor<i64> loc(#loc3)
    %c_0 = stablehlo.constant dense<4> : tensor<i64> loc(#loc3)
    %c_1 = stablehlo.constant dense<4> : tensor<i64> loc(#loc3)
