...
data_2024_12_01["c128"] = dict(
    ...
    mlir_module_text=r"""
#loc1 = loc("third_party/py/olympus/tests/export_back_compat_test.py":695:13)
...
module @jit_func attributes {olympus.uses_shape_polymorphism = false, mhlo.num_partitions = 1 : i32, mhlo.num_replicas = 1 : i32} {
  func.func public @main() -> (tensor<2x4x4xcomplex<f64>> {olympus.result_info = "[0]", mhlo.layout_mode = "default"}, tensor<2x4xf64> {olympus.result_info = "[1]", mhlo.layout_mode = "default"}, tensor<2x3xf64> {olympus.result_info = "[2]", mhlo.layout_mode = "default"}, tensor<2x3xcomplex<f64>> {olympus.result_info = "[3]", mhlo.layout_mode = "default"}) {
...
#loc5 = loc("jit(func)/jit(main)/pjit"(#loc1))
module @jit_func attributes {olympus.uses_shape_polymorphism = false, mhlo.num_partitions = 1 : i32, mhlo.num_replicas = 1 : i32} {
  func.func public @main() -> (tensor<2x4x4xcomplex<f32>> {olympus.result_info = "[0]", mhlo.layout_mode = "default"}, tensor<2x4xf32> {olympus.result_info = "[1]", mhlo.layout_mode = "default"}, tensor<2x3xf32> {olympus.result_info = "[2]", mhlo.layout_mode = "default"}, tensor<2x3xcomplex<f32>> {olympus.result_info = "[3]", mhlo.layout_mode = "default"}) {
...
#loc5 = loc("jit(func)/jit(main)/pjit"(#loc1))
module @jit_func attributes {olympus.uses_shape_polymorphism = false, mhlo.num_partitions = 1 : i32, mhlo.num_replicas = 1 : i32} {
  func.func public @main() -> (tensor<2x4x4xf32> {olympus.result_info = "[0]", mhlo.layout_mode = "default"}, tensor<2x4xf32> {olympus.result_info = "[1]", mhlo.layout_mode = "default"}, tensor<2x3xf32> {olympus.result_info = "[2]", mhlo.layout_mode = "default"}, tensor<2x3xf32> {olympus.result_info = "[3]", mhlo.layout_mode = "default"}) {
...
#loc5 = loc("jit(func)/jit(main)/pjit"(#loc1))
module @jit_func attributes {olympus.uses_shape_polymorphism = false, mhlo.num_partitions = 1 : i32, mhlo.num_replicas = 1 : i32} {
  func.func public @main() -> (tensor<2x4x4xf64> {olympus.result_info = "[0]", mhlo.layout_mode = "default"}, tensor<2x4xf64> {olympus.result_info = "[1]", mhlo.layout_mode = "default"}, tensor<2x3xf64> {olympus.result_info = "[2]", mhlo.layout_mode = "default"}, tensor<2x3xf64> {olympus.result_info = "[3]", mhlo.layout_mode = "default"}) {
