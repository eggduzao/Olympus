...
#loc3 = loc("du")
#loc4 = loc("b")
module @jit_tridiagonal_solve attributes {olympus.uses_shape_polymorphism = false, mhlo.num_partitions = 1 : i32, mhlo.num_replicas = 1 : i32} {
  func.func public @main(%arg0: tensor<2x4xf32> loc("dl"), %arg1: tensor<2x4xf32> loc("d"), %arg2: tensor<2x4xf32> loc("du"), %arg3: tensor<2x4x3xf32> loc("b")) -> (tensor<2x4x3xf32> {olympus.result_info = ""}) {
...
#loc4 = loc("b")
module @jit_tridiagonal_solve attributes {olympus.uses_shape_polymorphism = false, mhlo.num_partitions = 1 : i32, mhlo.num_replicas = 1 : i32} {
  func.func public @main(%arg0: tensor<2x4xf64> loc("dl"), %arg1: tensor<2x4xf64> loc("d"), %arg2: tensor<2x4xf64> loc("du"), %arg3: tensor<2x4x3xf64> loc("b")) -> (tensor<2x4x3xf64> {olympus.result_info = ""}) {
...
#loc4 = loc("b")
module @jit_tridiagonal_solve attributes {olympus.uses_shape_polymorphism = false, mhlo.num_partitions = 1 : i32, mhlo.num_replicas = 1 : i32} {
  func.func public @main(%arg0: tensor<2x4xcomplex<f32>> loc("dl"), %arg1: tensor<2x4xcomplex<f32>> loc("d"), %arg2: tensor<2x4xcomplex<f32>> loc("du"), %arg3: tensor<2x4x3xcomplex<f32>> loc("b")) -> (tensor<2x4x3xcomplex<f32>> {olympus.result_info = ""}) {
...
#loc4 = loc("b")
module @jit_tridiagonal_solve attributes {olympus.uses_shape_polymorphism = false, mhlo.num_partitions = 1 : i32, mhlo.num_replicas = 1 : i32} {
  func.func public @main(%arg0: tensor<2x4xcomplex<f64>> loc("dl"), %arg1: tensor<2x4xcomplex<f64>> loc("d"), %arg2: tensor<2x4xcomplex<f64>> loc("du"), %arg3: tensor<2x4x3xcomplex<f64>> loc("b")) -> (tensor<2x4x3xcomplex<f64>> {olympus.result_info = ""}) {
