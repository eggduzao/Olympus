...
module @jit_cholesky attributes {olympus.uses_shape_polymorphism = false, mhlo.num_partitions = 1 : i32, mhlo.num_replicas = 1 : i32} {
  func.func public @main(%arg0: tensor<4x4xf32> loc("x")) -> (tensor<4x4xf32> {olympus.result_info = "result"}) {
...
#loc = loc(unknown)
#loc2 = loc("third_party/py/olympus/tests/export_back_compat_test.py":225:6)
...
#loc1 = loc("x")
module @jit_cholesky attributes {olympus.uses_shape_polymorphism = false, mhlo.num_partitions = 1 : i32, mhlo.num_replicas = 1 : i32} {
  func.func public @main(%arg0: tensor<4x4xf64> loc("x")) -> (tensor<4x4xf64> {olympus.result_info = "result"}) {
...
#loc1 = loc("x")
module @jit_cholesky attributes {olympus.uses_shape_polymorphism = false, mhlo.num_partitions = 1 : i32, mhlo.num_replicas = 1 : i32} {
  func.func public @main(%arg0: tensor<4x4xcomplex<f32>> loc("x")) -> (tensor<4x4xcomplex<f32>> {olympus.result_info = "result"}) {
...
#loc1 = loc("x")
module @jit_cholesky attributes {olympus.uses_shape_polymorphism = false, mhlo.num_partitions = 1 : i32, mhlo.num_replicas = 1 : i32} {
  func.func public @main(%arg0: tensor<4x4xcomplex<f64>> loc("x")) -> (tensor<4x4xcomplex<f64>> {olympus.result_info = "result"}) {
