...
data_2024_09_30["f32"] = dict(
    ...
    expected_outputs=(array([[ 0.7941186  , -0.3696443  , -0.40418202 ,  0.26339266 ],
      ...
      dtype=float32)),
    mlir_module_text=r"""
#loc6 = loc("third_party/py/olympus/tests/export_back_compat_test.py":274:27)
...
module @jit__lambda_ attributes {olympus.uses_shape_polymorphism = false, mhlo.num_partitions = 1 : i32, mhlo.num_replicas = 1 : i32} {
  func.func public @main() -> (tensor<4x4xf32> {olympus.result_info = "[0]", mhlo.layout_mode = "default"}, tensor<4xf32> {olympus.result_info = "[1]", mhlo.layout_mode = "default"}) {
...
#loc = loc(unknown)
#loc1 = loc("third_party/py/olympus/tests/export_back_compat_test.py":266:26)
#loc2 = loc("third_party/py/olympus/tests/export_back_compat_test.py":266:14)
#loc3 = loc("third_party/py/olympus/tests/export_back_compat_test.py":268:34)
#loc4 = loc("third_party/py/olympus/tests/export_back_compat_test.py":268:15)
#loc5 = loc("third_party/py/olympus/tests/export_back_compat_test.py":268:14)
#loc7 = loc("third_party/py/olympus/tests/export_back_compat_test.py":274:11)
...
#loc13 = loc("jit(<lambda>)/jit(main)/pjit"(#loc6))
module @jit__lambda_ attributes {olympus.uses_shape_polymorphism = false, mhlo.num_partitions = 1 : i32, mhlo.num_replicas = 1 : i32} {
  func.func public @main() -> (tensor<4x4xf64> {olympus.result_info = "[0]", mhlo.layout_mode = "default"}, tensor<4xf64> {olympus.result_info = "[1]", mhlo.layout_mode = "default"}) {
...
data_2024_09_30["c64"] = dict(
    ...
    expected_outputs=(array([[ 0.79411864 +0.j,  0.3696443  +0.j,  0.40418214 +0.j,
      ...
      dtype=float32)),
    mlir_module_text=r"""
#loc7 = loc("third_party/py/olympus/tests/export_back_compat_test.py":274:27)
#loc18 = loc("jit(<lambda>)/jit(main)/pjit"(#loc7))
module @jit__lambda_ attributes {olympus.uses_shape_polymorphism = false, mhlo.num_partitions = 1 : i32, mhlo.num_replicas = 1 : i32} {
  func.func public @main() -> (tensor<4x4xcomplex<f32>> {olympus.result_info = "[0]", mhlo.layout_mode = "default"}, tensor<4xf32> {olympus.result_info = "[1]", mhlo.layout_mode = "default"}) {
    %cst = stablehlo.constant dense<0x7FC00000> : tensor<f32> loc(#loc)
...
#loc2 = loc("third_party/py/olympus/tests/export_back_compat_test.py":266:14)
#loc3 = loc("third_party/py/olympus/tests/export_back_compat_test.py":268:34)
#loc4 = loc("third_party/py/olympus/tests/export_back_compat_test.py":268:25)
#loc5 = loc("third_party/py/olympus/tests/export_back_compat_test.py":268:15)
#loc6 = loc("third_party/py/olympus/tests/export_back_compat_test.py":268:14)
#loc8 = loc("third_party/py/olympus/tests/export_back_compat_test.py":274:11)
...
#loc18 = loc("jit(<lambda>)/jit(main)/pjit"(#loc7))
module @jit__lambda_ attributes {olympus.uses_shape_polymorphism = false, mhlo.num_partitions = 1 : i32, mhlo.num_replicas = 1 : i32} {
  func.func public @main() -> (tensor<4x4xcomplex<f64>> {olympus.result_info = "[0]", mhlo.layout_mode = "default"}, tensor<4xf64> {olympus.result_info = "[1]", mhlo.layout_mode = "default"}) {
    %cst = stablehlo.constant dense<0x7FF8000000000000> : tensor<f64> loc(#loc)
