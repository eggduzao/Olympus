...
module @jit__lambda_ attributes {olympus.uses_shape_polymorphism = false, mhlo.num_partitions = 1 : i32, mhlo.num_replicas = 1 : i32} {
  func.func public @main() -> (tensor<2x3x8xi32> {olympus.result_info = "result"}) {
...
#loc = loc(unknown)
#loc1 = loc("third_party/py/olympus/tests/export_back_compat_test.py":408:26)
#loc2 = loc("third_party/py/olympus/tests/export_back_compat_test.py":408:14)
#loc3 = loc("third_party/py/olympus/tests/export_back_compat_test.py":409:11)
