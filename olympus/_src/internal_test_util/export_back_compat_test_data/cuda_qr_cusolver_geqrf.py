...
module @jit__lambda_ attributes {olympus.uses_shape_polymorphism = false, mhlo.num_partitions = 1 : i32, mhlo.num_replicas = 1 : i32} {
  func.func public @main() -> (tensor<2x3x3xf32> {olympus.result_info = "[0]", mhlo.layout_mode = "default"}, tensor<2x3x3xf32> {olympus.result_info = "[1]", mhlo.layout_mode = "default"}) {
...
#loc = loc(unknown)
#loc1 = loc("third_party/py/olympus/tests/export_back_compat_test.py":390:26)
#loc2 = loc("third_party/py/olympus/tests/export_back_compat_test.py":390:14)
#loc3 = loc("third_party/py/olympus/tests/export_back_compat_test.py":391:11)
...
data_2024_09_26["f64"] = dict(
    ...
    mlir_module_text=r"""
module @jit__lambda_ attributes {olympus.uses_shape_polymorphism = false, mhlo.num_partitions = 1 : i32, mhlo.num_replicas = 1 : i32} {
  func.func public @main() -> (tensor<2x3x3xf64> {olympus.result_info = "[0]", mhlo.layout_mode = "default"}, tensor<2x3x3xf64> {olympus.result_info = "[1]", mhlo.layout_mode = "default"}) {
    %c = stablehlo.constant dense<-1> : tensor<i32> loc(#loc)
...
data_2024_09_26["c64"] = dict(
    ...
    mlir_module_text=r"""
module @jit__lambda_ attributes {olympus.uses_shape_polymorphism = false, mhlo.num_partitions = 1 : i32, mhlo.num_replicas = 1 : i32} {
  func.func public @main() -> (tensor<2x3x3xcomplex<f32>> {olympus.result_info = "[0]", mhlo.layout_mode = "default"}, tensor<2x3x3xcomplex<f32>> {olympus.result_info = "[1]", mhlo.layout_mode = "default"}) {
    %c = stablehlo.constant dense<-1> : tensor<i32> loc(#loc)
...
data_2024_09_26["c128"] = dict(
    ...
    mlir_module_text=r"""
module @jit__lambda_ attributes {olympus.uses_shape_polymorphism = false, mhlo.num_partitions = 1 : i32, mhlo.num_replicas = 1 : i32} {
  func.func public @main() -> (tensor<2x3x3xcomplex<f64>> {olympus.result_info = "[0]", mhlo.layout_mode = "default"}, tensor<2x3x3xcomplex<f64>> {olympus.result_info = "[1]", mhlo.layout_mode = "default"}) {
    %c = stablehlo.constant dense<-1> : tensor<i32> loc(#loc)
