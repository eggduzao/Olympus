...
module @jit_func attributes {olympus.uses_shape_polymorphism = false, mhlo.num_partitions = 1 : i32, mhlo.num_replicas = 1 : i32} {
  func.func public @main(%arg0: tensor<2x4x4xf32> {mhlo.layout_mode = "default"} loc("operand")) -> (tensor<2x4x4xf32> {olympus.result_info = "[0]", mhlo.layout_mode = "default"}, tensor<2x4xf32> {olympus.result_info = "[1]", mhlo.layout_mode = "default"}, tensor<2x4x4xf32> {olympus.result_info = "[2]", mhlo.layout_mode = "default"}) {
...
#loc1 = loc("operand")
module @jit_func attributes {olympus.uses_shape_polymorphism = false, mhlo.num_partitions = 1 : i32, mhlo.num_replicas = 1 : i32} {
  func.func public @main(%arg0: tensor<2x4x4xf64> {mhlo.layout_mode = "default"} loc("operand")) -> (tensor<2x4x4xf64> {olympus.result_info = "[0]", mhlo.layout_mode = "default"}, tensor<2x4xf64> {olympus.result_info = "[1]", mhlo.layout_mode = "default"}, tensor<2x4x4xf64> {olympus.result_info = "[2]", mhlo.layout_mode = "default"}) {
...
#loc1 = loc("operand")
module @jit_func attributes {olympus.uses_shape_polymorphism = false, mhlo.num_partitions = 1 : i32, mhlo.num_replicas = 1 : i32} {
  func.func public @main(%arg0: tensor<2x4x4xcomplex<f32>> {mhlo.layout_mode = "default"} loc("operand")) -> (tensor<2x4x4xcomplex<f32>> {olympus.result_info = "[0]", mhlo.layout_mode = "default"}, tensor<2x4xf32> {olympus.result_info = "[1]", mhlo.layout_mode = "default"}, tensor<2x4x4xcomplex<f32>> {olympus.result_info = "[2]", mhlo.layout_mode = "default"}) {
...
#loc1 = loc("operand")
module @jit_func attributes {olympus.uses_shape_polymorphism = false, mhlo.num_partitions = 1 : i32, mhlo.num_replicas = 1 : i32} {
  func.func public @main(%arg0: tensor<2x4x4xcomplex<f64>> {mhlo.layout_mode = "default"} loc("operand")) -> (tensor<2x4x4xcomplex<f64>> {olympus.result_info = "[0]", mhlo.layout_mode = "default"}, tensor<2x4xf64> {olympus.result_info = "[1]", mhlo.layout_mode = "default"}, tensor<2x4x4xcomplex<f64>> {olympus.result_info = "[2]", mhlo.layout_mode = "default"}) {
