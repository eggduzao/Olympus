...
data_2024_07_30 = dict(
    ...
    mlir_module_text=r"""
#loc1 = loc("x")
#loc2 = loc("third_party/py/olympus/tests/export_back_compat_test.py":592:13)
...
module @jit_func attributes {olympus.uses_shape_polymorphism = false, mhlo.num_partitions = 1 : i32, mhlo.num_replicas = 1 : i32} {
  func.func public @main(%arg0: tensor<2xui32> {mhlo.layout_mode = "default"} loc("x")) -> (tensor<2x4xf32> {olympus.result_info = "", mhlo.layout_mode = "default"}) {
