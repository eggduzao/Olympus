...
module @jit_func attributes {olympus.uses_shape_polymorphism = false, mhlo.num_partitions = 1 : i32, mhlo.num_replicas = 1 : i32} {
  func.func public @main(%arg0: tensor<2x4x4xf32> loc("x")) -> (tensor<2x4x4xf32> {olympus.result_info = "[0]"}, tensor<2x4xf32> {olympus.result_info = "[1]"}, tensor<2x3xf32> {olympus.result_info = "[2]"}, tensor<2x3xf32> {olympus.result_info = "[3]"}) {
...
#loc = loc(unknown)
#loc2 = loc("third_party/py/olympus/tests/export_back_compat_test.py":831:13)
...
#loc1 = loc("x")
module @jit_func attributes {olympus.uses_shape_polymorphism = false, mhlo.num_partitions = 1 : i32, mhlo.num_replicas = 1 : i32} {
  func.func public @main(%arg0: tensor<2x4x4xf64> loc("x")) -> (tensor<2x4x4xf64> {olympus.result_info = "[0]"}, tensor<2x4xf64> {olympus.result_info = "[1]"}, tensor<2x3xf64> {olympus.result_info = "[2]"}, tensor<2x3xf64> {olympus.result_info = "[3]"}) {
...
#loc1 = loc("x")
module @jit_func attributes {olympus.uses_shape_polymorphism = false, mhlo.num_partitions = 1 : i32, mhlo.num_replicas = 1 : i32} {
  func.func public @main(%arg0: tensor<2x4x4xcomplex<f32>> loc("x")) -> (tensor<2x4x4xcomplex<f32>> {olympus.result_info = "[0]"}, tensor<2x4xf32> {olympus.result_info = "[1]"}, tensor<2x3xf32> {olympus.result_info = "[2]"}, tensor<2x3xcomplex<f32>> {olympus.result_info = "[3]"}) {
    %cst = stablehlo.constant dense<0x7FC00000> : tensor<f32> loc(#loc)
...
#loc1 = loc("x")
module @jit_func attributes {olympus.uses_shape_polymorphism = false, mhlo.num_partitions = 1 : i32, mhlo.num_replicas = 1 : i32} {
  func.func public @main(%arg0: tensor<2x4x4xcomplex<f64>> loc("x")) -> (tensor<2x4x4xcomplex<f64>> {olympus.result_info = "[0]"}, tensor<2x4xf64> {olympus.result_info = "[1]"}, tensor<2x3xf64> {olympus.result_info = "[2]"}, tensor<2x3xcomplex<f64>> {olympus.result_info = "[3]"}) {
    %cst = stablehlo.constant dense<0x7FF8000000000000> : tensor<f64> loc(#loc)
