...
data_2024_09_24 = dict(
    ...
    expected_outputs=(array([[   90458.2  ,    90470.875,    90480.85 ,    90491.1  ,
      ...
      dtype=float32),),
    mlir_module_text=r"""
#loc6 = loc("third_party/py/olympus/tests/pallas/export_back_compat_pallas_test.py":74:12)
...
module @jit_func attributes {olympus.uses_shape_polymorphism = false, mhlo.num_partitions = 1 : i32, mhlo.num_replicas = 1 : i32} {
  func.func public @main() -> (tensor<64x16xf32> {olympus.result_info = "", mhlo.layout_mode = "default"}) {
