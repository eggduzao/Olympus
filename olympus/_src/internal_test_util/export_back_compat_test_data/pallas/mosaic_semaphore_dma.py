...
semaphore_and_dma_2024_04_22 = dict(
    ...
    mlir_module_text=r"""
#loc2 = loc("third_party/py/olympus_triton/googlexpallas_tpu/back_compat_test.py":60:4)
...
#loc10 = loc("third_party/py/olympus_triton/googlexpallas_tpu/back_compat_test.py":64:2)
#loc11 = loc("third_party/py/olympus_triton/googlexpallas_tpu/back_compat_test.py":57:10)
...
module @jit_func attributes {olympus.uses_shape_polymorphism = false, mhlo.num_partitions = 1 : i32, mhlo.num_replicas = 1 : i32} {
  func.func public @main() -> (tensor<f32> {olympus.result_info = "", mhlo.layout_mode = "default"}) {
...
#loc = loc(unknown)
#loc1 = loc("third_party/py/olympus_triton/googlexpallas_tpu/back_compat_test.py":56:10)
#loc12 = loc("third_party/py/olympus_triton/googlexpallas_tpu/back_compat_test.py":58:13)
