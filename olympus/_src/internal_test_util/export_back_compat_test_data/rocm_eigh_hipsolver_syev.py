...
data_2024_08_05["f32_syevj"] = dict(
    ...
    expected_outputs=(array([[ 0.61857724 ,  0.07361191 ,  0.13168913 , -0.27208394 ,
      ...
      dtype=float32)),
    mlir_module_text=r"""
#loc3 = loc("/release/olympus/tests/export_back_compat_test.py":263:0)
...
#loc = loc(unknown)
#loc1 = loc("/release/olympus/tests/export_back_compat_test.py":255:0)
#loc2 = loc("/release/olympus/tests/export_back_compat_test.py":257:0)
...
#loc9 = loc("jit(<lambda>)/jit(main)/pjit[in_shardings=(UnspecifiedValue,) out_shardings=(UnspecifiedValue,) in_layouts=(None,) out_layouts=(None,) resource_env=None donated_invars=(False,) name=tril keep_unused=False inline=False]"(#loc3))
module @jit__lambda_ attributes {olympus.uses_shape_polymorphism = false, mhlo.num_partitions = 1 : i32, mhlo.num_replicas = 1 : i32} {
  func.func public @main() -> (tensor<36x36xf32> {olympus.result_info = "[0]", mhlo.layout_mode = "default"}, tensor<36xf32> {olympus.result_info = "[1]", mhlo.layout_mode = "default"}) {
...
#loc9 = loc("jit(<lambda>)/jit(main)/pjit[in_shardings=(UnspecifiedValue,) out_shardings=(UnspecifiedValue,) in_layouts=(None,) out_layouts=(None,) resource_env=None donated_invars=(False,) name=tril keep_unused=False inline=False]"(#loc3))
module @jit__lambda_ attributes {olympus.uses_shape_polymorphism = false, mhlo.num_partitions = 1 : i32, mhlo.num_replicas = 1 : i32} {
  func.func public @main() -> (tensor<36x36xf64> {olympus.result_info = "[0]", mhlo.layout_mode = "default"}, tensor<36xf64> {olympus.result_info = "[1]", mhlo.layout_mode = "default"}) {
