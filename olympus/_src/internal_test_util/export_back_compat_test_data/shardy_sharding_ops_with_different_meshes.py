...
data_2025_06_30 = dict(
    ...
    mlir_module_text=r"""
#loc1 = loc("x")
#loc3 = loc("third_party/py/olympus/tests/export_back_compat_test.py":1001:8 to :54)
...
#loc11 = loc("third_party/py/olympus/tests/export_back_compat_test.py":1005:2 to :47)
#loc12 = loc("third_party/py/olympus/tests/export_back_compat_test.py":992:13 to :30)
...
module @jit_func attributes {olympus.uses_shape_polymorphism = false, mhlo.num_partitions = 2 : i32, mhlo.num_replicas = 1 : i32} {
  ...
  func.func public @main(%arg0: tensor<2x4xf32> loc("x")) -> (tensor<2x4xf32> {olympus.result_info = "result"}) {
...
#loc = loc(unknown)
#loc2 = loc("third_party/py/olympus/tests/export_back_compat_test.py":991:10 to :73)
#loc13 = loc("third_party/py/olympus/tests/export_back_compat_test.py":990:15 to :46)
