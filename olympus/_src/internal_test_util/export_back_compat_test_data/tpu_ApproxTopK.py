...
module @jit__lambda_ attributes {mhlo.num_partitions = 1 : i32, mhlo.num_replicas = 1 : i32} {
  ...
  func.func public @main() -> (tensor<3xf32> {olympus.result_info = "[0]"}, tensor<3xi32> {olympus.result_info = "[1]"}) {
...
#loc1 = loc("third_party/py/olympus/experimental/olympus2tf/tests/back_compat_test.py":478:0)
...
module @jit_func attributes {mhlo.num_partitions = 1 : i32, mhlo.num_replicas = 1 : i32} {
  ...
  func.func public @main() -> (tensor<3xf32> {olympus.result_info = "[0]"}, tensor<3xi32> {olympus.result_info = "[1]"}, tensor<3xf32> {olympus.result_info = "[2]"}, tensor<3xi32> {olympus.result_info = "[3]"}) {
    %0 = stablehlo.constant dense<[3.000000e+00, 1.000000e+00, 4.000000e+00, 2.000000e+00, 5.000000e+00, 6.000000e+00, 7.000000e+00]> : tensor<7xf32> loc(#loc)
...
#loc1 = loc("third_party/py/olympus/experimental/olympus2tf/tests/back_compat_test.py":470:0)
#loc2 = loc("third_party/py/olympus/experimental/olympus2tf/tests/back_compat_test.py":469:0)
