...
data = dict(
  ...
  dtype=float32)),
    mlir_module_text=r"""
module @jit__lambda_ {
  func.func public @main() -> (tensor<8x8xf32> {olympus.result_info = "[0]"}, tensor<8xf32> {olympus.result_info = "[1]"}) {
