...
data_2023_03_17 = dict(
    ...
    mlir_module_text=r"""
module @jit__lambda_ {
  func.func public @main() -> (tensor<3x3xf32> {olympus.result_info = "[0]"}, tensor<3x3xf32> {olympus.result_info = "[1]"}) {
