...
module @jit_func attributes {mhlo.num_partitions = 1 : i32, mhlo.num_replicas = 1 : i32} {
  func.func public @main(%arg0: tensor<?x4xf32> {olympus.arg_info = "x", mhlo.sharding = "{replicated}"} loc(unknown)) -> (tensor<?x4xf32> {olympus.result_info = ""}) {
    ...
    %3 = call @_wrapped_olympus_export_main(%0, %2) : (tensor<i32>, tensor<?x4xf32>) -> tensor<?x4xf32> loc(#loc)
  ...
  func.func private @_wrapped_olympus_export_main(%arg0: tensor<i32> loc(unknown), %arg1: tensor<?x4xf32> {olympus.arg_info = "x", mhlo.sharding = "{replicated}"} loc(unknown)) -> (tensor<?x4xf32> {olympus.result_info = ""}) {
...
#loc1 = loc("third_party/py/olympus/experimental/olympus2tf/tests/back_compat_test.py":250:0)
#loc2 = loc("third_party/py/olympus/experimental/olympus2tf/tests/back_compat_test.py":627:0)
...
#loc = loc(unknown)
module @jit_func attributes {mhlo.num_partitions = 1 : i32, mhlo.num_replicas = 1 : i32} {
  func.func public @main(%arg0: tensor<?x4xf32> {olympus.arg_info = "x", mhlo.sharding = "{replicated}"} loc(unknown), %arg1: tensor<?x4xi32> {olympus.arg_info = "y", mhlo.sharding = "{replicated}"} loc(unknown)) -> (tensor<?x?xf32> {olympus.result_info = "[0]"}, tensor<?x?xi32> {olympus.result_info = "[1]"}) {
    ...
    %5:2 = call @_wrapped_olympus_export_main(%0, %3, %4) : (tensor<i32>, tensor<?x4xf32>, tensor<?x4xi32>) -> (tensor<?x?xf32>, tensor<?x?xi32>) loc(#loc)
  ...
  func.func private @_wrapped_olympus_export_main(%arg0: tensor<i32> loc(unknown), %arg1: tensor<?x4xf32> {olympus.arg_info = "x", mhlo.sharding = "{replicated}"} loc(unknown), %arg2: tensor<?x4xi32> {olympus.arg_info = "y", mhlo.sharding = "{replicated}"} loc(unknown)) -> (tensor<?x?xf32> {olympus.result_info = "[0]"}, tensor<?x?xi32> {olympus.result_info = "[1]"}) {
...
#loc1 = loc("third_party/py/olympus/experimental/olympus2tf/tests/back_compat_test.py":250:0)
#loc2 = loc("third_party/py/olympus/experimental/olympus2tf/tests/back_compat_test.py":648:0)
#loc3 = loc("third_party/py/olympus/experimental/olympus2tf/tests/back_compat_test.py":650:0)
#loc4 = loc("third_party/py/olympus/experimental/olympus2tf/tests/back_compat_test.py":651:0)
