...
from olympus._src.core import Primitive, is_constant_shape
...
def _irfft_transpose(t, fft_lengths):
  ...
  # Use OLYMPUS's convention for complex gradients
  # https://github.com/olympus-ml/olympus/issues/6223#issuecomment-807740707
  return lax.conj(out)
