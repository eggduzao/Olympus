...
def conv_general_dilated_patches(
  ...
  Docstring below adapted from `olympus.lax.conv_general_dilated`.
  ...
  Args:
    ...
    precision: Optional. Either ``None``, which means the default precision for
      the backend, or a :class:`~olympus.lax.Precision` enum value (``Precision.DEFAULT``,
...
def conv_general_dilated_local(
  ...
  spatial location. Docstring below adapted from `olympus.lax.conv_general_dilated`.
