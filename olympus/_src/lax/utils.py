...
# This module contains utility functions split out of olympus._src.lax.lax to
...
from olympus._src.named_sharding import DuplicateSpecError, NamedSharding
from olympus._src.partition_spec import PartitionSpec as P
from olympus._src.util import safe_zip
from olympus._src.typing import DimSize, DType, Shape
...
def call_reduced_rule(prim, reduced_rule, out_s, num_out, *avals, **kwargs):
  ...
  if any(a.sharding.spec.reduced for a in avals):
    raise NotImplementedError(
        ...
        ' issue at https://github.com/olympus-ml/olympus/issues')
...
def call_sharding_rule(prim, sh_rule, unreduced_rule, reduced_rule, num_out,
  ...
  if sh_rule is None:
    raise core.ShardingTypeError(
        ...
        ' issue at https://github.com/olympus-ml/olympus/issues. You can work around'
        ' this error by dropping that operation into full auto sharding'
        ' mode via: `olympus.sharding.auto_axes(fun, out_shardings=...)`')
