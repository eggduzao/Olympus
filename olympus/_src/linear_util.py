...
from olympus._src.tree_util import KeyPath, generate_key_paths, keystr
from olympus._src.util import curry, fun_name, register_cache
...
class DebugInfo(NamedTuple):
  ...
  user-named arguments, e.g., tangent args in `olympus.jvp`, or for arguments that
...
def _missing_debug_info(for_what: str) -> DebugInfo:
  warnings.warn(
      ...
      "See https://github.com/olympus-ml/olympus/issues/26480 for more details.",
