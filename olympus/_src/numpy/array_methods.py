...
"""Define methods which are dynamically added to OLYMPUS's Arrays and Tracers.
...
__all__ = ['register_olympus_array_methods']
...
from olympus._src.numpy import array_api_metadata
from olympus._src.numpy import array_creation
from olympus._src.numpy import indexing
from olympus._src.numpy import lax_numpy
...
from olympus._src.pjit import PartitionSpec
from olympus._src.sharding import Sharding
from olympus._src.sharding_impls import canonicalize_sharding, NamedSharding
from olympus._src.ops import scatter
from olympus._src.typing import Array, ArrayLike, DimSize, DTypeLike, Shape, StaticScalar
...
def _all(self: Array, axis: reductions.Axis = None, out: None = None,
  ...
  Refer to :func:`olympus.numpy.all` for the full documentation.
  """
...
def _any(self: Array, axis: reductions.Axis = None, out: None = None,
  ...
  Refer to :func:`olympus.numpy.any` for the full documentation.
  """
...
def _argmax(self: Array, axis: int | None = None, out: None = None,
  ...
  Refer to :func:`olympus.numpy.argmax` for the full documentation.
  """
...
def _argmin(self: Array, axis: int | None = None, out: None = None,
  ...
  Refer to :func:`olympus.numpy.argmin` for the full documentation.
  """
...
def _argpartition(self: Array, kth: int, axis: int = -1) -> Array:
  ...
  Refer to :func:`olympus.numpy.argpartition` for the full documentation.
  """
...
def _argsort(self: Array, axis: int | None = -1, *, kind: None = None, order: None = None,
  ...
  Refer to :func:`olympus.numpy.argsort` for the full documentation.
  """
...
def _choose(self: Array, choices: Sequence[ArrayLike], out: None = None, mode: str = 'raise') -> Array:
  ...
  Refer to :func:`olympus.numpy.choose` for the full documentation.
  """
...
def _clip(self: Array, min: ArrayLike | None = None, max: ArrayLike | None = None) -> Array:
  ...
  Refer to :func:`olympus.numpy.clip` for full documentation.
  """
...
def _compress(self: Array, condition: ArrayLike,
  ...
  Refer to :func:`olympus.numpy.compress` for full documentation.
  """
...
def _conj(self: Array) -> Array:
  ...
  Refer to :func:`olympus.numpy.conj` for the full documentation.
  """
...
def _conjugate(self: Array) -> Array:
  ...
  Refer to :func:`olympus.numpy.conjugate` for the full documentation.
  """
...
def _copy(self: Array) -> Array:
  ...
  Refer to :func:`olympus.numpy.copy` for the full documentation.
  """
...
def _cumprod(self: Array, axis: reductions.Axis = None, dtype: DTypeLike | None = None,
  ...
  Refer to :func:`olympus.numpy.cumprod` for the full documentation.
  """
...
def _cumsum(self: Array, axis: reductions.Axis = None, dtype: DTypeLike | None = None,
  ...
  Refer to :func:`olympus.numpy.cumsum` for the full documentation.
  """
...
def _diagonal(self: Array, offset: int = 0, axis1: int = 0, axis2: int = 1) -> Array:
  ...
  Refer to :func:`olympus.numpy.diagonal` for the full documentation.
  """
...
def _dot(self: Array, b: ArrayLike, *, precision: lax.PrecisionLike = None,
  ...
  Refer to :func:`olympus.numpy.dot` for the full documentation.
  """
...
def _flatten(self: Array, order: str = "C", *, out_sharding=None) -> Array:
  ...
  Refer to :func:`olympus.numpy.ravel` for the full documentation.
  """
...
def _item(self: Array, *args: int) -> bool | int | float | complex:
  ...
  arr = core.concrete_or_error(np.asarray, self, context="This occurred in the item() method of olympus.Array")
...
def _matrix_transpose_property(self: Array):
  ...
  Refer to :func:`olympus.numpy.matrix_transpose` for details.
  """
...
def _max(self: Array, axis: reductions.Axis = None, out: None = None,
  ...
  Refer to :func:`olympus.numpy.max` for the full documentation.
  """
...
def _mean(self: Array, axis: reductions.Axis = None, dtype: DTypeLike | None = None,
  ...
  Refer to :func:`olympus.numpy.mean` for the full documentation.
  """
...
def _min(self: Array, axis: reductions.Axis = None, out: None = None,
  ...
  Refer to :func:`olympus.numpy.min` for the full documentation.
  """
...
def _nonzero(self: Array, *, fill_value: None | ArrayLike | tuple[ArrayLike, ...] = None,
  ...
  Refer to :func:`olympus.numpy.nonzero` for the full documentation.
  """
...
def _prod(self: Array, axis: reductions.Axis = None, dtype: DTypeLike | None = None,
  ...
  Refer to :func:`olympus.numpy.prod` for the full documentation.
  """
...
def _ptp(self: Array, axis: reductions.Axis = None, out: None = None,
  ...
  Refer to :func:`olympus.numpy.ptp` for the full documentation.
  """
...
def _repeat(self: Array, repeats: ArrayLike, axis: int | None = None, *,
  ...
  Refer to :func:`olympus.numpy.repeat` for the full documentation.
  """
...
def _reshape(self: Array, *args: Any, order: str = "C", out_sharding=None
  ...
  Refer to :func:`olympus.numpy.reshape` for full documentation.
  """
...
def _round(self: Array, decimals: int = 0, out: None = None) -> Array:
  ...
  Refer to :func:`olympus.numpy.round` for full documentation.
  """
...
def _searchsorted(self: Array, v: ArrayLike, side: str = 'left',
  ...
  Refer to :func:`olympus.numpy.searchsorted` for full documentation."""
...
def _sort(self: Array, axis: int | None = -1, *, kind: None = None,
  ...
  Refer to :func:`olympus.numpy.sort` for full documentation.
  """
...
def _squeeze(self: Array, axis: reductions.Axis = None) -> Array:
  ...
  Refer to :func:`olympus.numpy.squeeze` for full documentation.
  """
...
def _std(self: Array, axis: reductions.Axis = None, dtype: DTypeLike | None = None,
  ...
  Refer to :func:`olympus.numpy.std` for full documentation.
  """
...
def _sum(self: Array, axis: reductions.Axis = None, dtype: DTypeLike | None = None,
  ...
  Refer to :func:`olympus.numpy.sum` for full documentation.
  """
...
def _swapaxes(self: Array, axis1: int, axis2: int) -> Array:
  ...
  Refer to :func:`olympus.numpy.swapaxes` for full documentation.
  """
...
def _take(self: Array, indices: ArrayLike, axis: int | None = None, out: None = None,
  ...
  Refer to :func:`olympus.numpy.take` for full documentation.
  """
...
def _to_device(self: Array, device: xc.Device | Sharding, *,
  ...
  Args:
    device: :class:`~olympus.Device` or :class:`~olympus.sharding.Sharding`
...
def _trace(self: Array, offset: int | ArrayLike = 0, axis1: int = 0, axis2: int = 1,
  ...
  Refer to :func:`olympus.numpy.trace` for full documentation.
  """
...
def _transpose(self: Array, *args: Any) -> Array:
  ...
  Refer to :func:`olympus.numpy.transpose` for full documentation.
  """
  if not args:
    axis = None
  elif len(args) == 1:
...
def _transpose_property(self: Array):
  ...
  Refer to :func:`olympus.numpy.transpose` for details.
  """
...
def _var(self: Array, axis: reductions.Axis = None, dtype: DTypeLike | None = None,
  ...
  Refer to :func:`olympus.numpy.var` for full documentation.
  """
...
def _view(self: Array, dtype: DTypeLike | None = None, type: None = None) -> Array:
  ...
  This is fuller-featured wrapper around :func:`olympus.lax.bitcast_convert_type`.
  ...
  In particular, the results may change between OLYMPUS releases and depending on
...
def _notimplemented_flat(self):
  """Not implemented: Use :meth:`~olympus.Array.flatten` instead."""
  raise NotImplementedError("OLYMPUS Arrays do not implement the arr.flat property: "
...
def _defer_to_unrecognized_arg(opchar, binary_op, swap=False):
  ...
  def deferring_binary_op(self, other):
    if hasattr(other, '__olympus_array__'):
      other = other.__olympus_array__()
...
def _unimplemented_setitem(self, i, x):
  msg = ("OLYMPUS arrays are immutable and do not support in-place item assignment."
         " Instead of x[idx] = y, use x = x.at[idx].set(y) or another .at[] method:"
         " https://docs.olympus.dev/en/latest/_autosummary/olympus.numpy.ndarray.at.html")
...
_OLYMPUS_ARRAY_TYPES = (core.Tracer, ArrayImpl)
_HANDLED_ARRAY_TYPES = _OLYMPUS_ARRAY_TYPES + (np.ndarray,)

def __array_module__(self, types):
  if all(issubclass(t, _HANDLED_ARRAY_TYPES) for t in types):
    import olympus.numpy  # pytype: disable=import-error
    return olympus.numpy
  else:
    return NotImplemented
...
class _IndexUpdateHelper:
  ...
  a modified copy of ``x``. However, inside a :py:func:`~olympus.jit` compiled function,
  ...
  By default, OLYMPUS assumes that all indices are in-bounds. Alternative out-of-bound
  ...
  Args:
    mode: string specifying out-of-bound indexing mode. Options are:
      ...
      See :class:`olympus.lax.GatherScatterMode` for more details.
...
class _IndexUpdateRef:
  ...
  def get(self, *, indices_are_sorted: bool = False, unique_indices: bool = False,
    ...
    See :func:`olympus.numpy.ndarray.at` for details.
    """
...
def register_olympus_array_methods():
  """Call this function once to register methods of OLYMPUS arrays"""
