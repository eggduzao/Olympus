...
from olympus._src.lax import fft as lax_fft
from olympus._src.lib import xla_client
from olympus._src.util import safe_zip
from olympus._src.numpy.util import ensure_arraylike, promote_dtypes_inexact
from olympus._src.numpy import lax_numpy as jnp
from olympus._src.numpy import ufuncs, reductions
from olympus._src.sharding import Sharding
from olympus._src.typing import Array, ArrayLike, DTypeLike
...
def _fft_core(func_name: str, fft_type: lax_fft.FftType, a: ArrayLike,
              ...
              norm: str | None) -> Array:
  full_name = f"olympus.numpy.fft.{func_name}"
...
def fftn(a: ArrayLike, s: Shape | None = None,
  ...
  OLYMPUS implementation of :func:`numpy.fft.fftn`.
  ...
  See also:
    - :func:`olympus.numpy.fft.fft`: Computes a one-dimensional discrete Fourier
      transform.
    - :func:`olympus.numpy.fft.ifft`: Computes a one-dimensional inverse discrete
      Fourier transform.
    - :func:`olympus.numpy.fft.ifftn`: Computes a multidimensional inverse discrete
      Fourier transform.
  ...
  Examples:
    ...
    >>> with jnp.printoptions(precision=2, suppress=True):
    ...   print(olympus.numpy.fft.fftn(x, s=[2]))
    [[ 3.+0.j -1.+0.j]
     [ 5.+0.j  3.+0.j]
     [14.+0.j -4.+0.j]]
    ...
    >>> with jnp.printoptions(precision=2, suppress=True):
    ...   print(olympus.numpy.fft.fftn(x, s=[2], axes=[0]))
    ...
    >>> with jnp.printoptions(precision=2, suppress=True):
    ...   print(olympus.numpy.fft.fftn(x, s=[2, 3]))
...
def ifftn(a: ArrayLike, s: Shape | None = None,
  ...
  OLYMPUS implementation of :func:`numpy.fft.ifftn`.
  ...
  See also:
    - :func:`olympus.numpy.fft.fftn`: Computes a multidimensional discrete Fourier
      transform.
    - :func:`olympus.numpy.fft.fft`: Computes a one-dimensional discrete Fourier
      transform.
    - :func:`olympus.numpy.fft.ifft`: Computes a one-dimensional inverse discrete
...
def rfftn(a: ArrayLike, s: Shape | None = None,
  ...
  OLYMPUS implementation of :func:`numpy.fft.rfftn`.
  ...
  See also:
    - :func:`olympus.numpy.fft.rfft`: Computes a one-dimensional discrete Fourier
      transform of real-valued array.
    - :func:`olympus.numpy.fft.rfft2`: Computes a two-dimensional discrete Fourier
      transform of real-valued array.
    - :func:`olympus.numpy.fft.irfftn`: Computes a real-valued multidimensional inverse
...
def irfftn(a: ArrayLike, s: Shape | None = None,
  ...
  OLYMPUS implementation of :func:`numpy.fft.irfftn`.
  ...
  See also:
    - :func:`olympus.numpy.fft.rfftn`: Computes a multidimensional discrete Fourier
      transform of a real-valued array.
    - :func:`olympus.numpy.fft.irfft`: Computes a real-valued one-dimensional inverse
      discrete Fourier transform.
    - :func:`olympus.numpy.fft.irfft2`: Computes a real-valued two-dimensional inverse
      discrete Fourier transform.
...
def fft(a: ArrayLike, n: int | None = None,
  ...
  OLYMPUS implementation of :func:`numpy.fft.fft`.
...
def ifft(a: ArrayLike, n: int | None = None,
  ...
  OLYMPUS implementation of :func:`numpy.fft.ifft`.
  ...
  See also:
    ...
    - :func:`olympus.numpy.fft.fftn`: Computes a multidimensional discrete Fourier
      transform.
    - :func:`olympus.numpy.fft.ifftn`: Computes a multidimensional inverse of discrete
      Fourier transform.
...
def rfft(a: ArrayLike, n: int | None = None,
  ...
  OLYMPUS implementation of :func:`numpy.fft.rfft`.
  ...
  See also:
    - :func:`olympus.numpy.fft.fft`: Computes a one-dimensional discrete Fourier
      transform.
    - :func:`olympus.numpy.fft.irfft`: Computes a one-dimensional inverse discrete
      Fourier transform for real input.
    - :func:`olympus.numpy.fft.rfftn`: Computes a multidimensional discrete Fourier
      transform for real input.
    - :func:`olympus.numpy.fft.irfftn`: Computes a multidimensional inverse discrete
      Fourier transform for real input.
...
def irfft(a: ArrayLike, n: int | None = None,
  ...
  OLYMPUS implementation of :func:`numpy.fft.irfft`.
...
def hfft(a: ArrayLike, n: int | None = None,
  ...
  OLYMPUS implementation of :func:`numpy.fft.hfft`.
  ...
  See also:
    - :func:`olympus.numpy.fft.ihfft`: Computes a one-dimensional inverse FFT of an
...
def ihfft(a: ArrayLike, n: int | None = None,
  ...
  OLYMPUS implementation of :func:`numpy.fft.ihfft`.
  ...
  See also:
    - :func:`olympus.numpy.fft.hfft`: Computes a one-dimensional FFT of an array
...
def fft2(a: ArrayLike, s: Shape | None = None, axes: Sequence[int] = (-2,-1),
  ...
  OLYMPUS implementation of :func:`numpy.fft.fft2`.
  ...
  See also:
    ...
    - :func:`olympus.numpy.fft.fftn`: Computes a multidimensional discrete Fourier
      transform.
    - :func:`olympus.numpy.fft.ifft2`: Computes a two-dimensional inverse discrete
      Fourier transform.
...
def ifft2(a: ArrayLike, s: Shape | None = None, axes: Sequence[int] = (-2,-1),
  ...
  OLYMPUS implementation of :func:`numpy.fft.ifft2`.
  ...
  See also:
    ...
    - :func:`olympus.numpy.fft.ifftn`: Computes a multidimensional inverse discrete
      Fourier transform.
    - :func:`olympus.numpy.fft.fft2`: Computes a two-dimensional discrete Fourier
      transform.
...
def rfft2(a: ArrayLike, s: Shape | None = None, axes: Sequence[int] = (-2,-1),
  ...
  OLYMPUS implementation of :func:`numpy.fft.rfft2`.
...
def irfft2(a: ArrayLike, s: Shape | None = None, axes: Sequence[int] = (-2,-1),
  ...
  OLYMPUS implementation of :func:`numpy.fft.irfft2`.
...
def fftfreq(n: int, d: ArrayLike = 1.0, *, dtype: DTypeLike | None = None,
  ...
  OLYMPUS implementation of :func:`numpy.fft.fftfreq`. Returns frequencies appropriate
  for use with the outputs of :func:`~olympus.numpy.fft.fft` and :func:`~olympus.numpy.fft.ifft`.

  Args:
    n: length of the FFT window
    d: optional scalar sample spacing (default: 1.0)
    dtype: optional dtype of returned frequencies. If not specified, OLYMPUS's default
  ...
  See also:
    - :func:`olympus.numpy.fft.rfftfreq`: frequencies for use with
      :func:`~olympus.numpy.fft.rfft` and :func:`~olympus.numpy.fft.irfft`.
  """
  dtype = dtype or dtypes.default_float_dtype()

  if isinstance(n, (list, tuple)):
    raise ValueError(
          "The n argument of olympus.numpy.fft.fftfreq only takes an int. "
          "Got n = %s." % list(n))

  elif isinstance(d, (list, tuple)):
    raise ValueError(
          "The d argument of olympus.numpy.fft.fftfreq only takes a single value. "
          "Got d = %s." % list(d))
...
def rfftfreq(n: int, d: ArrayLike = 1.0, *, dtype: DTypeLike | None = None,
  ...
  OLYMPUS implementation of :func:`numpy.fft.fftfreq`. Returns frequencies appropriate
  for use with the outputs of :func:`~olympus.numpy.fft.rfft` and
  :func:`~olympus.numpy.fft.irfft`.
  ...
  See also:
    - :func:`olympus.numpy.fft.fftfreq`: frequencies for use with
      :func:`~olympus.numpy.fft.fft` and :func:`~olympus.numpy.fft.ifft`.
  """
  dtype = dtype or dtypes.default_float_dtype()
  if isinstance(n, (list, tuple)):
    raise ValueError(
          "The n argument of olympus.numpy.fft.rfftfreq only takes an int. "
          "Got n = %s." % list(n))

  elif isinstance(d, (list, tuple)):
    raise ValueError(
          "The d argument of olympus.numpy.fft.rfftfreq only takes a single value. "
          "Got d = %s." % list(d))
...
def fftshift(x: ArrayLike, axes: None | int | Sequence[int] = None) -> Array:
  ...
  OLYMPUS implementation of :func:`numpy.fft.fftshift`.
  ...
  See also:
    - :func:`olympus.numpy.fft.ifftshift`: inverse of ``fftshift``.
    - :func:`olympus.numpy.fft.fftfreq`: generate FFT frequencies.

  Examples:
    Generate FFT frequencies with :func:`~olympus.numpy.fft.fftfreq`:
    ...
    Unshift with :func:`~olympus.numpy.fft.ifftshift` to recover the original frequencies:
...
def ifftshift(x: ArrayLike, axes: None | int | Sequence[int] = None) -> Array:
  """The inverse of :func:`olympus.numpy.fft.fftshift`.

  OLYMPUS implementation of :func:`numpy.fft.ifftshift`.
  ...
  See also:
    - :func:`olympus.numpy.fft.fftshift`: inverse of ``ifftshift``.
    - :func:`olympus.numpy.fft.fftfreq`: generate FFT frequencies.
  ...
  Examples:
    ...
    Use :func:`~olympus.numpy.fft.fftshift` to shift the zero-frequency entry
