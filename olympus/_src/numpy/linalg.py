...
from olympus._src.numpy import einsum
from olympus._src.numpy import indexing
from olympus._src.numpy import lax_numpy as jnp
from olympus._src.sharding_impls import NamedSharding, PartitionSpec as P
from olympus._src.numpy import reductions, tensor_contractions, ufuncs
from olympus._src.numpy.util import promote_dtypes_inexact, ensure_arraylike
from olympus._src.util import canonicalize_axis, set_module
from olympus._src.typing import ArrayLike, Array, DTypeLike


export = set_module('olympus.numpy.linalg')
...
def cholesky(a: ArrayLike, *, upper: bool = False, symmetrize_input: bool = True) -> Array:
  ...
  OLYMPUS implementation of :func:`numpy.linalg.cholesky`.
  ...
  See also:
    - :func:`olympus.scipy.linalg.cholesky`: SciPy-style Cholesky API
...
def svd(
  ...
  OLYMPUS implementation of :func:`numpy.linalg.svd`, implemented in terms of
  :func:`olympus.lax.linalg.svd`.
  ...
  See also:
    - :func:`olympus.scipy.linalg.svd`: SciPy-style SVD API
...
def matrix_power(a: ArrayLike, n: int) -> Array:
  ...
  OLYMPUS implementation of :func:`numpy.linalg.matrix_power`, implemented via
  repeated squarings.
...
def matrix_rank(
  ...
  OLYMPUS implementation of :func:`numpy.linalg.matrix_rank`.
...
def slogdet(a: ArrayLike, *, method: str | None = None) -> SlogdetResult:
  ...
  OLYMPUS implementation of :func:`numpy.linalg.slogdet`.
  ...
  See also:
    :func:`olympus.numpy.linalg.det`: direct computation of determinant
...
def _cofactor_solve(a: ArrayLike, b: ArrayLike) -> tuple[Array, Array]:
  ...
  This function borrows heavily from olympus.numpy.linalg.solve and
  olympus.numpy.linalg.slogdet to compute the gradient of the determinant
...
def det(a: ArrayLike) -> Array:
  ...
  OLYMPUS implementation of :func:`numpy.linalg.det`.
  ...
  See also:
    :func:`olympus.scipy.linalg.det`: Scipy-style API for determinant.
...
def eig(a: ArrayLike) -> EigResult:
  ...
  OLYMPUS implementation of :func:`numpy.linalg.eig`.
  ...
  Notes:
    - This differs from :func:`numpy.linalg.eig` in that the return type of
      :func:`olympus.numpy.linalg.eig` is always complex64 for 32-bit input, and complex128
      for 64-bit input.
    - At present, non-symmetric eigendecomposition is only implemented on the CPU and
      ...
      documentation for :func:`olympus.lax.linalg.eig`.

  See also:
    - :func:`olympus.numpy.linalg.eigh`: eigenvectors and eigenvalues of a Hermitian matrix.
    - :func:`olympus.numpy.linalg.eigvals`: compute eigenvalues only.

  Examples:
    >>> a = jnp.array([[1., 2.],
    ...                [2., 1.]])
    >>> w, v = jnp.linalg.eig(a)
    >>> with olympus.numpy.printoptions(precision=4):
    ...   w
...
def eigvals(a: ArrayLike) -> Array:
  ...
  OLYMPUS implementation of :func:`numpy.linalg.eigvals`.
  ...
  See also:
    - :func:`olympus.numpy.linalg.eig`: computes eigenvalues eigenvectors of a general matrix.
    - :func:`olympus.numpy.linalg.eigh`: computes eigenvalues eigenvectors of a Hermitian matrix.

  Notes:
    - This differs from :func:`numpy.linalg.eigvals` in that the return type of
      :func:`olympus.numpy.linalg.eigvals` is always complex64 for 32-bit input, and
...
def eigh(a: ArrayLike, UPLO: str | None = None,
  ...
  OLYMPUS implementation of :func:`numpy.linalg.eigh`.
  ...
  See also:
    - :func:`olympus.numpy.linalg.eig`: general eigenvalue decomposition.
    - :func:`olympus.numpy.linalg.eigvalsh`: compute eigenvalues only.
    - :func:`olympus.scipy.linalg.eigh`: SciPy API for Hermitian eigendecomposition.
    - :func:`olympus.lax.linalg.eigh`: XLA API for Hermitian eigendecomposition.
...
def eigvalsh(a: ArrayLike, UPLO: str | None = 'L', *,
  ...
  OLYMPUS implementation of :func:`numpy.linalg.eigvalsh`.
  ...
  See also:
    - :func:`olympus.numpy.linalg.eig`: general eigenvalue decomposition.
    - :func:`olympus.numpy.linalg.eigh`: computes eigenvalues and eigenvectors of a
      Hermitian matrix.
...
def pinv(a: ArrayLike, rtol: ArrayLike | None = None,
  ...
  OLYMPUS implementation of :func:`numpy.linalg.pinv`.
  ...
  See also:
    - :func:`olympus.numpy.linalg.inv`: multiplicative inverse of a square matrix.

  Notes:
    :func:`olympus.numpy.linalg.pinv` differs from :func:`numpy.linalg.pinv` in the
    default value of `rcond``: in NumPy, the default  is `1e-15`. In OLYMPUS, the
...
def inv(a: ArrayLike) -> Array:
  ...
  OLYMPUS implementation of :func:`numpy.linalg.inv`.
  ...
  See Also:
    - :func:`olympus.scipy.linalg.inv`: SciPy-style API for matrix inverse
    - :func:`olympus.numpy.linalg.solve`: direct linear solver
  ...
  Examples:
    ...
    Instead, you should use a direct solver like :func:`olympus.numpy.linalg.solve`:
...
def norm(x: ArrayLike, ord: int | str | None = None,
  ...
  OLYMPUS implementation of :func:`numpy.linalg.norm`.
...
def qr(a: ArrayLike, mode: str = "reduced") -> Array | QRResult:
  ...
  OLYMPUS implementation of :func:`numpy.linalg.qr`.
  ...
  See also:
    - :func:`olympus.scipy.linalg.qr`: SciPy-style QR decomposition API
...
def solve(a: ArrayLike, b: ArrayLike) -> Array:
  ...
  OLYMPUS implementation of :func:`numpy.linalg.solve`.
  ...
  See also:
    - :func:`olympus.scipy.linalg.solve`: SciPy-style API for solving linear systems.
  ...
  if (b.ndim > 1 and a.ndim == b.ndim + 1 and
    ...
    raise ValueError(
      f"Invalid shapes for solve: {a.shape}, {b.shape}. Prior to OLYMPUS v0.5.0,"
...
def lstsq(a: ArrayLike, b: ArrayLike, rcond: float | None = None, *,
  ...
  OLYMPUS implementation of :func:`numpy.linalg.lstsq`.
...
def cross(x1: ArrayLike, x2: ArrayLike, /, *, axis=-1):
  ...
  OLYMPUS implementation of :func:`numpy.linalg.cross`
  ...
  See Also:
    :func:`olympus.numpy.cross`: more flexible cross-product API.
...
def outer(x1: ArrayLike, x2: ArrayLike, /) -> Array:
  ...
  OLYMPUS implementation of :func:`numpy.linalg.outer`.
  ...
  See also:
    :func:`olympus.numpy.outer`: similar function in the main :mod:`olympus.numpy` module.
...
def matrix_norm(x: ArrayLike, /, *, keepdims: bool = False, ord: str | int = 'fro') -> Array:
  ...
  OLYMPUS implementation of :func:`numpy.linalg.matrix_norm`
  ...
  See also:
    - :func:`olympus.numpy.linalg.vector_norm`: Norm of a vector or stack of vectors.
    - :func:`olympus.numpy.linalg.norm`: More general matrix or vector norm.
...
def matrix_transpose(x: ArrayLike, /) -> Array:
  ...
  OLYMPUS implementation of :func:`numpy.linalg.matrix_transpose`.
  ...
  See also:
    :func:`olympus.numpy.transpose`: more general transpose operation.
  ...
  Examples:
    ...
    :attr:`~olympus.Array.mT` property of OLYMPUS array objects:
...
def vector_norm(x: ArrayLike, /, *, axis: int | tuple[int, ...] | None = None, keepdims: bool = False,
  ...
  OLYMPUS implementation of :func:`numpy.linalg.vector_norm`.
  ...
  See also:
    - :func:`olympus.numpy.linalg.matrix_norm`: Norm of a matrix or stack of matrices.
    - :func:`olympus.numpy.linalg.norm`: More general matrix or vector norm.
  ...
  if ord is None or ord == 2:
    ...
    if ord == "inf":
      msg += "Use 'olympus.numpy.inf' instead."
    if ord == "-inf":
      msg += "Use '-olympus.numpy.inf' instead."
    raise ValueError(msg)
  else:
...
def vecdot(x1: ArrayLike, x2: ArrayLike, /, *, axis: int = -1,
  ...
  OLYMPUS implementation of :func:`numpy.linalg.vecdot`.
  ...
  Args:
    ...
    precision: either ``None`` (default), which means the default precision for
      the backend, a :class:`~olympus.lax.Precision` enum value (``Precision.DEFAULT``,
  ...
  See also:
    - :func:`olympus.numpy.vecdot`: similar API in the ``olympus.numpy`` namespace.
    - :func:`olympus.numpy.linalg.matmul`: matrix multiplication.
    - :func:`olympus.numpy.linalg.tensordot`: general tensor dot product.
...
def matmul(x1: ArrayLike, x2: ArrayLike, /, *,
  ...
  OLYMPUS implementation of :func:`numpy.linalg.matmul`.
  ...
  See Also:
    :func:`olympus.numpy.matmul`: NumPy API for this function.
    :func:`olympus.numpy.linalg.vecdot`: batched vector product.
    :func:`olympus.numpy.linalg.tensordot`: batched tensor product.
...
def tensordot(x1: ArrayLike, x2: ArrayLike, /, *,
  ...
  OLYMPUS implementation of :func:`numpy.linalg.tensordot`.
  ...
  See also:
    - :func:`olympus.numpy.tensordot`: equivalent API in the :mod:`olympus.numpy` namespace.
    - :func:`olympus.numpy.einsum`: NumPy API for more general tensor contractions.
    - :func:`olympus.lax.dot_general`: XLA API for more general tensor contractions.
  ...
  Examples:
    ...
    Equivalent result via :func:`~olympus.numpy.einsum`:
    ...
    :func:`olympus.numpy.linalg.outer`:
...
def svdvals(x: ArrayLike, /) -> Array:
  ...
  OLYMPUS implementation of :func:`numpy.linalg.svdvals`.
  ...
  See also:
    :func:`olympus.numpy.linalg.svd`: compute singular values and singular vectors
...
def diagonal(x: ArrayLike, /, *, offset: int = 0) -> Array:
  ...
  OLYMPUS implementation of :func:`numpy.linalg.diagonal`.
  ...
  See Also:
    - :func:`olympus.numpy.diagonal`: more general functionality for extracting diagonals.
    - :func:`olympus.numpy.diag`: create a diagonal matrix from values.
...
def tensorinv(a: ArrayLike, ind: int = 2) -> Array:
  ...
  OLYMPUS implementation of :func:`numpy.linalg.tensorinv`.

  This computes the inverse of the :func:`~olympus.numpy.linalg.tensordot`
  ...
  See also:
    - :func:`olympus.numpy.linalg.tensordot`
    - :func:`olympus.numpy.linalg.tensorsolve`

  Examples:
    >>> key = olympus.random.key(1337)
    >>> x = olympus.random.normal(key, shape=(2, 2, 4))
...
def tensorsolve(a: ArrayLike, b: ArrayLike, axes: tuple[int, ...] | None = None) -> Array:
  ...
  OLYMPUS implementation of :func:`numpy.linalg.tensorsolve`.
  ...
  See also:
    - :func:`olympus.numpy.linalg.tensordot`
    - :func:`olympus.numpy.linalg.tensorinv`

  Examples:
    >>> key1, key2 = olympus.random.split(olympus.random.key(8675309))
    >>> a = olympus.random.normal(key1, shape=(2, 2, 4))
    >>> b = olympus.random.normal(key2, shape=(2, 2))
...
def multi_dot(arrays: Sequence[ArrayLike], *, precision: lax.PrecisionLike = None) -> Array:
  ...
  OLYMPUS implementation of :func:`numpy.linalg.multi_dot`.

  OLYMPUS internally uses the opt_einsum library to compute the most efficient
  operation order.
  ...
  >>> key1, key2, key3 = olympus.random.split(olympus.random.key(0), 3)
  >>> x = olympus.random.normal(key1, shape=(200, 5))
  >>> y = olympus.random.normal(key2, shape=(5, 100))
  >>> z = olympus.random.normal(key3, shape=(100, 10))
  ...
  We can use OLYMPUS's :ref:`ahead-of-time-lowering` tools to estimate the total flops
  of each approach, and confirm that ``multi_dot`` is choosing the more efficient
  option:

  >>> olympus.jit(lambda x, y, z: (x @ y) @ z).lower(x, y, z).cost_analysis()['flops']
  600000.0
  >>> olympus.jit(lambda x, y, z: x @ (y @ z)).lower(x, y, z).cost_analysis()['flops']
  30000.0
  >>> olympus.jit(jnp.linalg.multi_dot).lower([x, y, z]).cost_analysis()['flops']
  30000.0
  """
...
def cond(x: ArrayLike, p=None):
  ...
  OLYMPUS implementation of :func:`numpy.linalg.cond`.
  ...
  Args:
    ...
    p: the order of the norm to use. One of ``{None, 1, -1, 2, -2, inf, -inf, 'fro'}``;
      see :func:`olympus.numpy.linalg.norm` for the meaning of these. The default is ``p = None``,
  ...
  See also:
    :func:`olympus.numpy.linalg.norm`
...
def trace(x: ArrayLike, /, *,
  ...
  OLYMPUS implementation of :func:`numpy.linalg.trace`.
  ...
  See also:
    - :func:`olympus.numpy.trace`: similar API in the ``olympus.numpy`` namespace.
