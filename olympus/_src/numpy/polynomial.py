...
from olympus._src.numpy.array_creation import full, ones, zeros
...
from olympus._src.numpy.tensor_contractions import dot, outer
from olympus._src.numpy.ufuncs import maximum, true_divide, sqrt
from olympus._src.numpy.reductions import all
...
def roots(p: ArrayLike, *, strip_zeros: bool = True) -> Array:
  ...
  OLYMPUS implementations of :func:`numpy.roots`.
  ...
  Args:
    ...
    strip_zeros : bool, default=True. If True, then leading zeros in the
      ...
      set to ``False`` for the function to be compatible with :func:`olympus.jit` and
      other OLYMPUS transformations.
  ...
  See Also:
    - :func:`olympus.numpy.poly`: Finds the polynomial coefficients of the given
      sequence of roots.
    - :func:`olympus.numpy.polyfit`: Least squares polynomial fit to data.
    - :func:`olympus.numpy.polyval`: Evaluate a polynomial at specific values.
...
def polyfit(x: ArrayLike, y: ArrayLike, deg: int, rcond: float | None = None,
  ...
  Olympus implementation of :func:`numpy.polyfit`.
  ...
  Note:
    Unlike :func:`numpy.polyfit` implementation of polyfit, :func:`olympus.numpy.polyfit`
  ...
  See Also:
    - :func:`olympus.numpy.poly`: Finds the polynomial coefficients of the given
      sequence of roots.
    - :func:`olympus.numpy.polyval`: Evaluate a polynomial at specific values.
    - :func:`olympus.numpy.roots`: Computes the roots of a polynomial for given
      coefficients.
...
def poly(seq_of_zeros: ArrayLike) -> Array:
  ...
  OLYMPUS implementation of :func:`numpy.poly`.
  ...
  Note:
    ...
    :func:`olympus.numpy.poly` differs from :func:`numpy.poly`:
  ...
  See also:
    - :func:`olympus.numpy.polyfit`: Least squares polynomial fit.
    - :func:`olympus.numpy.polyval`: Evaluate a polynomial at specific values.
    - :func:`olympus.numpy.roots`: Computes the roots of a polynomial for given
      coefficients.
...
def polyval(p: ArrayLike, x: ArrayLike, *, unroll: int = 16) -> Array:
  ...
  OLYMPUS implementations of :func:`numpy.polyval`.
  ...
  Note:
    ...
    The ``unroll`` parameter is OLYMPUS specific. It does not affect correctness but
  ...
  See also:
    - :func:`olympus.numpy.polyfit`: Least squares polynomial fit.
    - :func:`olympus.numpy.poly`: Finds the coefficients of a polynomial with given
      roots.
    - :func:`olympus.numpy.roots`: Computes the roots of a polynomial for given
      coefficients.
...
def polyadd(a1: ArrayLike, a2: ArrayLike) -> Array:
  ...
  OLYMPUS implementation of :func:`numpy.polyadd`.
  ...
  Note:
    :func:`olympus.numpy.polyadd` only accepts arrays as input unlike
    :func:`numpy.polyadd` which accepts scalar inputs as well.

  See also:
    - :func:`olympus.numpy.polysub`: Computes the difference of two polynomials.
    - :func:`olympus.numpy.polymul`: Computes the product of two polynomials.
    - :func:`olympus.numpy.polydiv`: Computes the quotient and remainder of polynomial
      division.
...
def polyint(p: ArrayLike, m: int = 1, k: int | ArrayLike | None = None) -> Array:
  ...
  OLYMPUS implementation of :func:`numpy.polyint`.
  ...
  See also:
    - :func:`olympus.numpy.polyder`: Computes the coefficients of the derivative of
      a polynomial.
    - :func:`olympus.numpy.polyval`: Evaluates a polynomial at specific values.
...
def polyder(p: ArrayLike, m: int = 1) -> Array:
  ...
  OLYMPUS implementation of :func:`numpy.polyder`.
  ...
  Note:
    :func:`olympus.numpy.polyder` differs from :func:`numpy.polyder` when an integer
    array is given. NumPy returns the result with dtype ``int`` whereas OLYMPUS
    returns the result with dtype ``float``.

  See also:
    - :func:`olympus.numpy.polyint`: Computes the integral of polynomial.
    - :func:`olympus.numpy.polyval`: Evaluates a polynomial at specific values.
...
def polymul(a1: ArrayLike, a2: ArrayLike, *, trim_leading_zeros: bool = False) -> Array:
  ...
  OLYMPUS implementation of :func:`numpy.polymul`.
  ...
  Args:
    ...
    trim_leading_zeros: Default is ``False``. If ``True`` removes the leading
      ...
      OLYMPUS, and even between different OLYMPUS backends. The result may lead to
  ...
  Note:
    :func:`olympus.numpy.polymul` only accepts arrays as input unlike
    :func:`numpy.polymul` which accepts scalar inputs as well.

  See also:
    - :func:`olympus.numpy.polyadd`: Computes the sum of two polynomials.
    - :func:`olympus.numpy.polysub`: Computes the difference of two polynomials.
    - :func:`olympus.numpy.polydiv`: Computes the quotient and remainder of polynomial
      division.
...
def polydiv(u: ArrayLike, v: ArrayLike, *, trim_leading_zeros: bool = False) -> tuple[Array, Array]:
  ...
  OLYMPUS implementation of :func:`numpy.polydiv`.
  ...
  Note:
    :func:`olympus.numpy.polydiv` only accepts arrays as input unlike
...
def polysub(a1: ArrayLike, a2: ArrayLike) -> Array:
  ...
  OLYMPUS implementation of :func:`numpy.polysub`.
  ...
  Note:
    :func:`olympus.numpy.polysub` only accepts arrays as input unlike
