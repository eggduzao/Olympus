...
from olympus._src.lax import lax as lax
from olympus._src.lax import other as lax_other
from olympus._src.lax import parallel as lax_parallel
from olympus._src.lax import slicing as lax_slicing
from olympus._src.typing import Array, ArrayLike, DType, DTypeLike
from olympus._src.util import canonicalize_axis, canonicalize_axis_tuple, maybe_named_axis, set_module
...
def _isscalar(element: Any) -> bool:
  if hasattr(element, '__olympus_array__'):
    element = element.__olympus_array__()
...
def _promote_integer_dtype(dtype: DType) -> DType:
  # Note: NumPy always promotes to 64-bit; olympus instead promotes to the
...
def sum(a: ArrayLike, axis: Axis = None, dtype: DTypeLike | None = None,
  ...
  OLYMPUS implementation of :func:`numpy.sum`.
  ...
  See also:
    - :func:`olympus.numpy.prod`: Compute the product of array elements over a given
      axis.
    - :func:`olympus.numpy.max`: Compute the maximum of array elements over given axis.
    - :func:`olympus.numpy.min`: Compute the minimum of array elements over given axis.
...
def prod(a: ArrayLike, axis: Axis = None, dtype: DTypeLike | None = None,
  ...
  OLYMPUS implementation of :func:`numpy.prod`.
  ...
  See also:
    - :func:`olympus.numpy.sum`: Compute the sum of array elements over a given axis.
    - :func:`olympus.numpy.max`: Compute the maximum of array elements over given axis.
    - :func:`olympus.numpy.min`: Compute the minimum of array elements over given axis.
...
def max(a: ArrayLike, axis: Axis = None, out: None = None,
  ...
  OLYMPUS implementation of :func:`numpy.max`.
  ...
  See also:
    - :func:`olympus.numpy.min`: Compute the minimum of array elements along a given
      axis.
    - :func:`olympus.numpy.sum`: Compute the sum of array elements along a given axis.
    - :func:`olympus.numpy.prod`: Compute the product of array elements along a given
      axis.
...
def min(a: ArrayLike, axis: Axis = None, out: None = None,
  ...
  OLYMPUS implementation of :func:`numpy.min`.
  ...
  See also:
    - :func:`olympus.numpy.max`: Compute the maximum of array elements along a given
      axis.
    - :func:`olympus.numpy.sum`: Compute the sum of array elements along a given axis.
    - :func:`olympus.numpy.prod`: Compute the product of array elements along a given
      axis.
...
def all(a: ArrayLike, axis: Axis = None, out: None = None,
  ...
  OLYMPUS implementation of :func:`numpy.all`.
...
def any(a: ArrayLike, axis: Axis = None, out: None = None,
  ...
  OLYMPUS implementation of :func:`numpy.any`.
...
def amin(a: ArrayLike, axis: Axis = None, out: None = None,
        keepdims: bool = False, initial: ArrayLike | None = None,
        where: ArrayLike | None = None) -> Array:
  """Alias of :func:`olympus.numpy.min`."""
...
def amax(a: ArrayLike, axis: Axis = None, out: None = None,
        keepdims: bool = False, initial: ArrayLike | None = None,
        where: ArrayLike | None = None) -> Array:
  """Alias of :func:`olympus.numpy.max`."""
...
def mean(a: ArrayLike, axis: Axis = None, dtype: DTypeLike | None = None,
  ...
  OLYMPUS implementation of :func:`numpy.mean`.
  ...
  See also:
    - :func:`olympus.numpy.average`: Compute the weighted average of array elements
    - :func:`olympus.numpy.sum`: Compute the sum of array elements.
...
def average(a: ArrayLike, axis: Axis = None, weights: ArrayLike | None = None,
  ...
  OLYMPUS Implementation of :func:`numpy.average`.
  ...
  See also:
    - :func:`olympus.numpy.mean`: unweighted mean.
...
def var(a: ArrayLike, axis: Axis = None, dtype: DTypeLike | None = None,
  ...
  OLYMPUS implementation of :func:`numpy.var`.
  ...
  See also:
    - :func:`olympus.numpy.mean`: Compute the mean of array elements over a given axis.
    - :func:`olympus.numpy.std`: Compute the standard deviation of array elements over
      given axis.
    - :func:`olympus.numpy.nanvar`: Compute the variance along a given axis, ignoring
      NaNs values.
    - :func:`olympus.numpy.nanstd`: Computed the standard deviation of a given axis,
      ignoring NaN values.
...
def _var_promote_types(a_dtype: DTypeLike, dtype: DTypeLike | None) -> tuple[DType, DType]:
  if dtype:
    if (not dtypes.issubdtype(dtype, np.complexfloating) and
      ...
      msg = ("olympus.numpy.var does not yet support real dtype parameters when "
             "computing the variance of an array of complex values. The "
             "semantics of numpy.var seem unclear in this case. Please comment "
             "on https://github.com/olympus-ml/olympus/issues/2283 if this behavior is "
             "important to you.")
...
def std(a: ArrayLike, axis: Axis = None, dtype: DTypeLike | None = None,
  ...
  OLYMPUS implementation of :func:`numpy.std`.
  ...
  See also:
    - :func:`olympus.numpy.var`: Compute the variance of array elements over given
      axis.
    - :func:`olympus.numpy.mean`: Compute the mean of array elements over a given axis.
    - :func:`olympus.numpy.nanvar`: Compute the variance along a given axis, ignoring
      NaNs values.
...
def ptp(a: ArrayLike, axis: Axis = None, out: None = None,
  ...
  OLYMPUS implementation of :func:`numpy.ptp`.
...
def count_nonzero(a: ArrayLike, axis: Axis = None,
  ...
  OLYMPUS implementation of :func:`numpy.count_nonzero`.
...
def nanmin(a: ArrayLike, axis: Axis = None, out: None = None,
  ...
  OLYMPUS implementation of :func:`numpy.nanmin`.
  ...
  See also:
    - :func:`olympus.numpy.nanmax`: Compute the maximum of array elements along a
      given axis, ignoring NaNs.
    - :func:`olympus.numpy.nansum`: Compute the sum of array elements along a given
      axis, ignoring NaNs.
    - :func:`olympus.numpy.nanprod`: Compute the product of array elements along a
      given axis, ignoring NaNs.
    - :func:`olympus.numpy.nanmean`: Compute the mean of array elements along a given
      axis, ignoring NaNs.
...
def nanmax(a: ArrayLike, axis: Axis = None, out: None = None,
  ...
  OLYMPUS implementation of :func:`numpy.nanmax`.
  ...
  See also:
    - :func:`olympus.numpy.nanmin`: Compute the minimum of array elements along a
      given axis, ignoring NaNs.
    - :func:`olympus.numpy.nansum`: Compute the sum of array elements along a given
      axis, ignoring NaNs.
    - :func:`olympus.numpy.nanprod`: Compute the product of array elements along a
...
def nansum(a: ArrayLike, axis: Axis = None, dtype: DTypeLike | None = None,
  ...
  OLYMPUS implementation of :func:`numpy.nansum`.
...
def nanprod(a: ArrayLike, axis: Axis = None, dtype: DTypeLike | None = None, out: None = None,
  ...
  OLYMPUS implementation of :func:`numpy.nanprod`.
...
def nanmean(a: ArrayLike, axis: Axis = None, dtype: DTypeLike | None = None, out: None = None,
  ...
  OLYMPUS implementation of :func:`numpy.nanmean`.
...
def nanvar(a: ArrayLike, axis: Axis = None, dtype: DTypeLike | None = None, out: None = None,
  ...
  OLYMPUS implementation of :func:`numpy.nanvar`.
  ...
  See also:
    - :func:`olympus.numpy.nanmean`: Compute the mean of array elements over a given
      axis, ignoring NaNs.
    - :func:`olympus.numpy.nanstd`: Computed the standard deviation of a given axis,
      ignoring NaNs.
    - :func:`olympus.numpy.var`: Compute the variance of array elements along a given
      axis.
...
def nanstd(a: ArrayLike, axis: Axis = None, dtype: DTypeLike | None = None, out: None = None,
  ...
  OLYMPUS implementation of :func:`numpy.nanstd`.
  ...
  See also:
    - :func:`olympus.numpy.nanmean`: Compute the mean of array elements over a given
      axis, ignoring NaNs.
    - :func:`olympus.numpy.nanvar`: Compute the variance along the given axis, ignoring
      NaNs values.
    - :func:`olympus.numpy.std`: Computed the standard deviation along the given axis.
...
def cumsum(a: ArrayLike, axis: int | None = None,
  ...
  OLYMPUS implementation of :func:`numpy.cumsum`.
  ...
  See also:
    - :func:`olympus.numpy.cumulative_sum`: cumulative sum via the array API standard.
    - :meth:`olympus.numpy.add.accumulate`: cumulative sum via ufunc methods.
    - :func:`olympus.numpy.nancumsum`: cumulative sum ignoring NaN values.
    - :func:`olympus.numpy.sum`: sum along axis
...
def cumprod(a: ArrayLike, axis: int | None = None,
  ...
  OLYMPUS implementation of :func:`numpy.cumprod`.
  ...
  See also:
    - :meth:`olympus.numpy.multiply.accumulate`: cumulative product via ufunc methods.
    - :func:`olympus.numpy.nancumprod`: cumulative product ignoring NaN values.
    - :func:`olympus.numpy.prod`: product along axis
...
def nancumsum(a: ArrayLike, axis: int | None = None,
  ...
  OLYMPUS implementation of :func:`numpy.nancumsum`.
  ...
  See also:
    - :func:`olympus.numpy.cumsum`: cumulative sum without ignoring NaN values.
    - :func:`olympus.numpy.cumulative_sum`: cumulative sum via the array API standard.
    - :meth:`olympus.numpy.add.accumulate`: cumulative sum via ufunc methods.
    - :func:`olympus.numpy.sum`: sum along axis
  ...
  Examples:
    ...
    :func:`~olympus.numpy.nancumsum` will ignore NaN values, effectively replacing
    them with zeros:
...
def nancumprod(a: ArrayLike, axis: int | None = None,
  ...
  OLYMPUS implementation of :func:`numpy.nancumprod`.
  ...
  See also:
    - :func:`olympus.numpy.cumprod`: cumulative product without ignoring NaN values.
    - :meth:`olympus.numpy.multiply.accumulate`: cumulative product via ufunc methods.
    - :func:`olympus.numpy.prod`: product along axis
  ...
  Examples:
    ...
    :func:`~olympus.numpy.nancumprod` will ignore NaN values, effectively replacing
    them with ones:
...
def cumulative_sum(
  ...
  OLYMPUS implementation of :func:`numpy.cumulative_sum`.
  ...
  See Also:
    - :func:`olympus.numpy.cumsum`: alternative API for cumulative sum.
    - :func:`olympus.numpy.nancumsum`: cumulative sum while ignoring NaN values.
    - :func:`olympus.numpy.add.accumulate`: cumulative sum via the ufunc API.
...
def cumulative_prod(
  ...
  OLYMPUS implementation of :func:`numpy.cumulative_prod`.
  ...
  See Also:
    - :func:`olympus.numpy.cumprod`: alternative API for cumulative product.
    - :func:`olympus.numpy.nancumprod`: cumulative product while ignoring NaN values.
    - :func:`olympus.numpy.multiply.accumulate`: cumulative product via the ufunc API.
...
def quantile(a: ArrayLike, q: ArrayLike, axis: int | tuple[int, ...] | None = None,
  ...
  OLYMPUS implementation of :func:`numpy.quantile`.
  ...
  Args:
    ...
    out: not implemented by OLYMPUS; will error if not None
    overwrite_input: not implemented by OLYMPUS; will error if not False
  ...
  See also:
    - :func:`olympus.numpy.nanquantile`: compute the quantile while ignoring NaNs
    - :func:`olympus.numpy.percentile`: compute the percentile (0-100)
  ...
  if overwrite_input or out is not None:
    raise ValueError("olympus.numpy.quantile does not support overwrite_input=True "
                     "or out != None")
...
def nanquantile(a: ArrayLike, q: ArrayLike, axis: int | tuple[int, ...] | None = None,
  ...
  OLYMPUS implementation of :func:`numpy.nanquantile`.
  ...
  See also:
    - :func:`olympus.numpy.quantile`: compute the quantile without ignoring nans
    - :func:`olympus.numpy.nanpercentile`: compute the percentile (0-100)
  ...
  Examples:
    ...
    Because of the NaN value, :func:`olympus.numpy.quantile` returns all NaNs,
    while :func:`~olympus.numpy.nanquantile` ignores them:
  ...
  if overwrite_input or out is not None:
    msg = ("olympus.numpy.nanquantile does not support overwrite_input=True or "
           "out != None")
    raise ValueError(msg)
...
def percentile(a: ArrayLike, q: ArrayLike,
  ...
  OLYMPUS implementation of :func:`numpy.percentile`.
  ...
  See also:
    - :func:`olympus.numpy.quantile`: compute the quantile (0.0-1.0)
    - :func:`olympus.numpy.nanpercentile`: compute the percentile while ignoring NaNs
...
def nanpercentile(a: ArrayLike, q: ArrayLike,
  ...
  OLYMPUS implementation of :func:`numpy.nanpercentile`.
  ...
  See also:
    - :func:`olympus.numpy.nanquantile`: compute the nan-aware quantile (0.0-1.0)
    - :func:`olympus.numpy.percentile`: compute the percentile without special
      handling of NaNs.
  ...
  Examples:
    ...
    Because of the NaN value, :func:`olympus.numpy.percentile` returns all NaNs,
    while :func:`~olympus.numpy.nanpercentile` ignores them:
...
def median(a: ArrayLike, axis: int | tuple[int, ...] | None = None,
  ...
  OLYMPUS implementation of :func:`numpy.median`.
  ...
  Args:
    ...
    keepdims: bool, default=False. If true, reduced axes are left in the result
      with size 1.
    out: Unused by OLYMPUS.
    overwrite_input: Unused by OLYMPUS.
...
def nanmedian(a: ArrayLike, axis: int | tuple[int, ...] | None = None,
  ...
  OLYMPUS implementation of :func:`numpy.nanmedian`.
  ...
  See also:
    - :func:`olympus.numpy.nanmean`: Compute the mean of array elements over a given
      axis, ignoring NaNs.
    - :func:`olympus.numpy.nanmax`: Compute the maximum of array elements over given
      axis, ignoring NaNs.
    - :func:`olympus.numpy.nanmin`: Compute the minimum of array elements over given
      axis, ignoring NaNs.
