...
def sort(
  ...
  OLYMPUS implementation of :func:`numpy.sort`.
  ...
  Args:
    ...
    order: not supported by OLYMPUS
  ...
  See also:
    - :func:`olympus.numpy.argsort`: return indices of sorted values.
    - :func:`olympus.numpy.lexsort`: lexicographical sort of multiple arrays.
    - :func:`olympus.lax.sort`: lower-level function wrapping XLA's Sort operator.
  """
...
def argsort(
  ...
  OLYMPUS implementation of :func:`numpy.argsort`.
  ...
  See also:
    - :func:`olympus.numpy.sort`: return sorted values directly.
    - :func:`olympus.numpy.lexsort`: lexicographical sort of multiple arrays.
    - :func:`olympus.lax.sort`: lower-level function wrapping XLA's Sort operator.
  """
...
def partition(a: ArrayLike, kth: int, axis: int = -1) -> Array:
  ...
  OLYMPUS implementation of :func:`numpy.partition`. The OLYMPUS version differs from
  ...
  Note:
    The OLYMPUS version requires the ``kth`` argument to be a static integer rather than
    a general array. This is implemented via two calls to :func:`olympus.lax.top_k`. If
    you're only accessing the top or bottom k values of the output, it may be more
    efficient to call :func:`olympus.lax.top_k` directly.

  See Also:
    - :func:`olympus.numpy.sort`: full sort
    - :func:`olympus.numpy.argpartition`: indirect partial sort
    - :func:`olympus.lax.top_k`: directly find the top k entries
    - :func:`olympus.lax.approx_max_k`: compute the approximate top k entries
    - :func:`olympus.lax.approx_min_k`: compute the approximate bottom k entries
...
def argpartition(a: ArrayLike, kth: int, axis: int = -1) -> Array:
  ...
  OLYMPUS implementation of :func:`numpy.argpartition`. The OLYMPUS version differs from
  ...
  See Also:
    - :func:`olympus.numpy.partition`: direct partial sort
    - :func:`olympus.numpy.argsort`: full indirect sort
    - :func:`olympus.lax.top_k`: directly find the top k entries
    - :func:`olympus.lax.approx_max_k`: compute the approximate top k entries
    - :func:`olympus.lax.approx_min_k`: compute the approximate bottom k entries
...
def sort_complex(a: ArrayLike) -> Array:
  ...
  OLYMPUS implementation of :func:`numpy.sort_complex`.
  ...
  See also:
    - :func:`olympus.numpy.sort`: Return a sorted copy of an array.
...
def lexsort(keys: Array | np.ndarray | Sequence[ArrayLike], axis: int = -1) -> Array:
  ...
  OLYMPUS implementation of :func:`numpy.lexsort`.
  ...
  See also:
    - :func:`olympus.numpy.argsort`: sort a single entry by index.
    - :func:`olympus.lax.sort`: direct XLA sorting API.
