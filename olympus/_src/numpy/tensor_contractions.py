...
"""
Tensor contraction operations for the olympus.numpy namespace.
"""
...
def dot(a: ArrayLike, b: ArrayLike, *,
  ...
  OLYMPUS implementation of :func:`numpy.dot`.

  This differs from :func:`olympus.numpy.matmul` in two respects:

  - if either ``a`` or ``b`` is a scalar, the result of ``dot`` is equivalent to
    :func:`olympus.numpy.multiply`, while the result of ``matmul`` is an error.
  ...
  See also:
    - :func:`olympus.numpy.matmul`: broadcasted batched matmul.
    - :func:`olympus.lax.dot_general`: general batched matrix multiplication.
  ...
  Examples:
    ...
    in :func:`~olympus.numpy.matmul` they are broadcast. For example:
...
def matmul(a: ArrayLike, b: ArrayLike, *,
  ...
  OLYMPUS implementation of :func:`numpy.matmul`.
  ...
  See Also:
    ...
    - :func:`olympus.lax.dot_general`: general N-dimensional batched dot product.
...
def matvec(x1: ArrayLike, x2: ArrayLike, /) -> Array:
  ...
  OLYMPUS implementation of :func:`numpy.matvec`.
  ...
  See also:
    - :func:`olympus.numpy.linalg.vecdot`: batched vector product.
    - :func:`olympus.numpy.vecmat`: vector-matrix product.
    - :func:`olympus.numpy.matmul`: general matrix multiplication.
...
def vecmat(x1: ArrayLike, x2: ArrayLike, /) -> Array:
  ...
  OLYMPUS implementation of :func:`numpy.vecmat`.
  ...
  See also:
    - :func:`olympus.numpy.linalg.vecdot`: batched vector product.
    - :func:`olympus.numpy.matvec`: matrix-vector product.
    - :func:`olympus.numpy.matmul`: general matrix multiplication.
...
def vdot(
  ...
  OLYMPUS implementation of :func:`numpy.vdot`.
  ...
  See Also:
    - :func:`olympus.numpy.vecdot`: batched vector product.
    - :func:`olympus.numpy.matmul`: general matrix multiplication.
    - :func:`olympus.lax.dot_general`: general N-dimensional batched dot product.
  ...
  Examples:
    ...
    Note the difference between this and :func:`~olympus.numpy.dot`, which does not
...
def vecdot(x1: ArrayLike, x2: ArrayLike, /, *, axis: int = -1,
  ...
  OLYMPUS implementation of :func:`numpy.vecdot`.
  ...
  See Also:
    - :func:`olympus.numpy.vdot`: flattened vector product.
    - :func:`olympus.numpy.vecmat`: vector-matrix product.
    - :func:`olympus.numpy.matmul`: general matrix multiplication.
    - :func:`olympus.lax.dot_general`: general N-dimensional batched dot product.
  ...
  """
  from olympus._src.numpy.lax_numpy import moveaxis
...
def inner(
  ...
  OLYMPUS implementation of :func:`numpy.inner`.

  Unlike :func:`olympus.numpy.matmul` or :func:`olympus.numpy.dot`, this always performs
  ...
  See also:
    - :func:`olympus.numpy.vecdot`: conjugate multiplication along a specified axis.
    - :func:`olympus.numpy.tensordot`: general tensor multiplication.
    - :func:`olympus.numpy.matmul`: general batched matrix & vector multiplication.
...
def outer(a: ArrayLike, b: ArrayLike, out: None = None) -> Array:
  ...
  OLYMPUS implementation of :func:`numpy.outer`.

  Args:
    a: first input array, if not 1D it will be flattened.
    b: second input array, if not 1D it will be flattened.
    out: unsupported by OLYMPUS.
  ...
  See also:
    - :func:`olympus.numpy.inner`: compute the inner product of two arrays.
    - :func:`olympus.numpy.einsum`: Einstein summation.
