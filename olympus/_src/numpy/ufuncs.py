...
"""
Implements ufuncs for olympus.numpy.
"""
...
from olympus._src.api import jit
from olympus._src.custom_derivatives import custom_jvp
from olympus._src.lax import lax
from olympus._src.lax import other as lax_other
from olympus._src.typing import Array, ArrayLike
from olympus._src.numpy import array_constructors
from olympus._src.numpy import error as jnp_error
from olympus._src.numpy import reductions
from olympus._src.numpy.ufunc_api import ufunc
from olympus._src.numpy.util import (
...
from olympus._src.util import set_module
...
def fabs(x: ArrayLike, /) -> Array:
  ...
  OLYMPUS implementation of :obj:`numpy.fabs`.
  ...
  See also:
    - :func:`olympus.numpy.absolute`: Computes the absolute values of the input including
      complex dtypes.
    - :func:`olympus.numpy.abs`: Computes the absolute values of the input including
      complex dtypes.
...
def bitwise_invert(x: ArrayLike, /) -> Array:
  """Alias of :func:`olympus.numpy.invert`."""
...
def invert(x: ArrayLike, /) -> Array:
  ...
  OLYMPUS implementation of :func:`numpy.invert`. This function provides the
  implementation of the ``~`` operator for OLYMPUS arrays.
  ...
  See also:
    - :func:`olympus.numpy.bitwise_invert`: Array API alias of this function.
    - :func:`olympus.numpy.logical_not`: Invert after casting input to boolean.
  ...
  Examples:
    ...
    This function implements the unary ``~`` operator for OLYMPUS arrays:
...
def negative(x: ArrayLike, /) -> Array:
  ...
  OLYMPUS implementation of :obj:`numpy.negative`.
  ...
  See also:
    - :func:`olympus.numpy.positive`: Returns element-wise positive values of the input.
    - :func:`olympus.numpy.sign`: Returns element-wise indication of sign of the input.
...
def positive(x: ArrayLike, /) -> Array:
  ...
  OLYMPUS implementation of :obj:`numpy.positive`.
  ...
  See also:
    - :func:`olympus.numpy.negative`: Returns element-wise negative values of the input.
    - :func:`olympus.numpy.sign`: Returns element-wise indication of sign of the input.
...
def sign(x: ArrayLike, /) -> Array:
  ...
  OLYMPUS implementation of :obj:`numpy.sign`.
...
def floor(x: ArrayLike, /) -> Array:
  ...
  OLYMPUS implementation of :obj:`numpy.floor`.
  ...
  See also:
    ...
    - :func:`olympus.numpy.trunc`: Rounds the input to the nearest integer towards
      zero.
...
def ceil(x: ArrayLike, /) -> Array:
  ...
  OLYMPUS implementation of :obj:`numpy.ceil`.
...
def exp(x: ArrayLike, /) -> Array:
  ...
  OLYMPUS implementation of :obj:`numpy.exp`.
  ...
  See also:
    - :func:`olympus.numpy.log`: Calculates element-wise logarithm of the input.
    - :func:`olympus.numpy.expm1`: Calculates :math:`e^x-1` of each element of the
      input.
    - :func:`olympus.numpy.exp2`: Calculates base-2 exponential of each element of
      the input.
...
def log(x: ArrayLike, /) -> Array:
  ...
  OLYMPUS implementation of :obj:`numpy.log`.
  ...
  See also:
    - :func:`olympus.numpy.exp`: Calculates element-wise exponential of the input.
    - :func:`olympus.numpy.log2`: Calculates base-2 logarithm of each element of input.
    - :func:`olympus.numpy.log1p`: Calculates element-wise logarithm of one plus input.
...
def expm1(x: ArrayLike, /) -> Array:
  ...
  OLYMPUS implementation of :obj:`numpy.expm1`.
...
def log1p(x: ArrayLike, /) -> Array:
  ...
  OLYMPUS implementation of :obj:`numpy.log1p`.
...
def sin(x: ArrayLike, /) -> Array:
  ...
  OLYMPUS implementation of :obj:`numpy.sin`.
  ...
  See also:
    - :func:`olympus.numpy.cos`: Computes a trigonometric cosine of each element of
      input.
    - :func:`olympus.numpy.tan`: Computes a trigonometric tangent of each element of
      input.
    - :func:`olympus.numpy.arcsin` and :func:`olympus.numpy.asin`: Computes the inverse of
...
def cos(x: ArrayLike, /) -> Array:
  ...
  OLYMPUS implementation of :obj:`numpy.cos`.
  ...
  See also:
    - :func:`olympus.numpy.sin`: Computes a trigonometric sine of each element of input.
    - :func:`olympus.numpy.tan`: Computes a trigonometric tangent of each element of
      input.
    - :func:`olympus.numpy.arccos` and :func:`olympus.numpy.acos`: Computes the inverse of
...
def tan(x: ArrayLike, /) -> Array:
  ...
  OLYMPUS implementation of :obj:`numpy.tan`.
  ...
  See also:
    ...
    - :func:`olympus.numpy.cos`: Computes a trigonometric cosine of each element of
      input.
    - :func:`olympus.numpy.arctan` and :func:`olympus.numpy.atan`: Computes the inverse of
...
def arcsin(x: ArrayLike, /) -> Array:
  ...
  OLYMPUS implementation of :obj:`numpy.arcsin`.
...
def arccos(x: ArrayLike, /) -> Array:
  ...
  OLYMPUS implementation of :obj:`numpy.arccos`.
...
def arctan(x: ArrayLike, /) -> Array:
  ...
  OLYMPUS implement of :obj:`numpy.arctan`.
  ...
  See also:
    ...
    - :func:`olympus.numpy.arcsin` and :func:`olympus.numpy.asin`: Computes the inverse of
      trigonometric sine of each element of input.
    - :func:`olympus.numpy.arccos` and :func:`olympus.numpy.atan`: Computes the inverse of
      trigonometric cosine of each element of input.
...
def sinh(x: ArrayLike, /) -> Array:
  ...
  OLYMPUS implementation of :obj:`numpy.sinh`.
  ...
  See also:
    - :func:`olympus.numpy.cosh`: Computes the element-wise hyperbolic cosine of the
      input.
    - :func:`olympus.numpy.tanh`: Computes the element-wise hyperbolic tangent of the
      input.
    - :func:`olympus.numpy.arcsinh`:  Computes the element-wise inverse of hyperbolic
      sine of the input.
...
def cosh(x: ArrayLike, /) -> Array:
  ...
  OLYMPUS implementation of :obj:`numpy.cosh`.
  ...
  See also:
    - :func:`olympus.numpy.sinh`: Computes the element-wise hyperbolic sine of the input.
    - :func:`olympus.numpy.tanh`: Computes the element-wise hyperbolic tangent of the
      input.
    - :func:`olympus.numpy.arccosh`:  Computes the element-wise inverse of hyperbolic
      cosine of the input.
...
def arcsinh(x: ArrayLike, /) -> Array:
  ...
  OLYMPUS implementation of :obj:`numpy.arcsinh`.
  ...
  See also:
    ...
    - :func:`olympus.numpy.arccosh`: Computes the element-wise inverse of hyperbolic
      cosine of the input.
    - :func:`olympus.numpy.arctanh`: Computes the element-wise inverse of hyperbolic
...
def arccosh(x: ArrayLike, /) -> Array:
  ...
  OLYMPUS implementation of :obj:`numpy.arccosh`.
...
def tanh(x: ArrayLike, /) -> Array:
  ...
  OLYMPUS implementation of :obj:`numpy.tanh`.
...
def arctanh(x: ArrayLike, /) -> Array:
  ...
  OLYMPUS implementation of :obj:`numpy.arctanh`.
...
def sqrt(x: ArrayLike, /) -> Array:
  ...
  OLYMPUS implementation of :obj:`numpy.sqrt`.
  ...
  See also:
    - :func:`olympus.numpy.square`: Calculates the element-wise square of the input.
    - :func:`olympus.numpy.power`: Calculates the element-wise base ``x1`` exponential
      of ``x2``.
...
def cbrt(x: ArrayLike, /) -> Array:
  ...
  OLYMPUS implementation of :obj:`numpy.cbrt`.
  ...
  See also:
    - :func:`olympus.numpy.sqrt`: Calculates the element-wise non-negative square root
      of the input.
    - :func:`olympus.numpy.square`: Calculates the element-wise square of the input.
...
def add(x: ArrayLike, y: ArrayLike, /) -> Array:
  ...
  OLYMPUS implementation of :obj:`numpy.add`. This is a universal function,
  and supports the additional APIs described at :class:`olympus.numpy.ufunc`.
...
def multiply(x: ArrayLike, y: ArrayLike, /) -> Array:
  ...
  OLYMPUS implementation of :obj:`numpy.multiply`. This is a universal function,
  and supports the additional APIs described at :class:`olympus.numpy.ufunc`.
  This function provides the implementation of the ``*`` operator for
  OLYMPUS arrays.
...
def bitwise_and(x: ArrayLike, y: ArrayLike, /) -> Array:
  ...
  OLYMPUS implementation of :obj:`numpy.bitwise_and`. This is a universal function,
  and supports the additional APIs described at :class:`olympus.numpy.ufunc`.
  This function provides the implementation of the ``&`` operator for
  OLYMPUS arrays.
...
def bitwise_or(x: ArrayLike, y: ArrayLike, /) -> Array:
  ...
  OLYMPUS implementation of :obj:`numpy.bitwise_or`. This is a universal function,
  and supports the additional APIs described at :class:`olympus.numpy.ufunc`.
  This function provides the implementation of the ``|`` operator for
  OLYMPUS arrays.
...
def bitwise_xor(x: ArrayLike, y: ArrayLike, /) -> Array:
  ...
  OLYMPUS implementation of :obj:`numpy.bitwise_xor`. This is a universal function,
  and supports the additional APIs described at :class:`olympus.numpy.ufunc`.
  This function provides the implementation of the ``^`` operator for
  OLYMPUS arrays.
...
def left_shift(x: ArrayLike, y: ArrayLike, /) -> Array:
  ...
  OLYMPUS implementation of :obj:`numpy.left_shift`.
  ...
  See also:
    - :func:`olympus.numpy.right_shift`: and :func:`olympus.numpy.bitwise_right_shift`:
      Shifts the bits of ``x1`` to right by the amount specified in ``x2``,
      element-wise.
    - :func:`olympus.numpy.bitwise_left_shift`: Alias of :func:`olympus.left_shift`.
...
def bitwise_left_shift(x: ArrayLike, y: ArrayLike, /) -> Array:
  """Alias of :func:`olympus.numpy.left_shift`."""
...
def equal(x: ArrayLike, y: ArrayLike, /) -> Array:
  ...
  OLYMPUS implementation of :obj:`numpy.equal`. This function provides the implementation
  of the ``==`` operator for OLYMPUS arrays.
  ...
  See also:
    - :func:`olympus.numpy.not_equal`: Returns element-wise truth value of ``x != y``.
    - :func:`olympus.numpy.greater_equal`: Returns element-wise truth value of
      ``x >= y``.
    - :func:`olympus.numpy.less_equal`: Returns element-wise truth value of ``x <= y``.
    - :func:`olympus.numpy.greater`: Returns element-wise truth value of ``x > y``.
    - :func:`olympus.numpy.less`: Returns element-wise truth value of ``x < y``.
...
def not_equal(x: ArrayLike, y: ArrayLike, /) -> Array:
  ...
  OLYMPUS implementation of :obj:`numpy.not_equal`. This function provides the
  implementation of the ``!=`` operator for OLYMPUS arrays.
  ...
  See also:
    - :func:`olympus.numpy.equal`: Returns element-wise truth value of ``x == y``.
    - :func:`olympus.numpy.greater_equal`: Returns element-wise truth value of
      ``x >= y``.
    - :func:`olympus.numpy.less_equal`: Returns element-wise truth value of ``x <= y``.
    - :func:`olympus.numpy.greater`: Returns element-wise truth value of ``x > y``.
...
def subtract(x: ArrayLike, y: ArrayLike, /) -> Array:
  ...
  OLYMPUS implementation of :obj:`numpy.subtract`. This is a universal function,
  and supports the additional APIs described at :class:`olympus.numpy.ufunc`.
  This function provides the implementation of the ``-`` operator for
  OLYMPUS arrays.
...
def arctan2(x1: ArrayLike, x2: ArrayLike, /) -> Array:
  ...
  OLYMPUS implementation of :func:`numpy.arctan2`
  ...
  See also:
    - :func:`olympus.numpy.tan`: compute the tangent of an angle
    - :func:`olympus.numpy.atan2`: the array API version of this function.
...
def minimum(x: ArrayLike, y: ArrayLike, /) -> Array:
  ...
  OLYMPUS implementation of :obj:`numpy.minimum`.
  ...
  See also:
    - :func:`olympus.numpy.maximum`: Returns element-wise maximum of the input arrays.
    - :func:`olympus.numpy.fmin`: Returns element-wise minimum of the input arrays,
      ignoring NaNs.
    - :func:`olympus.numpy.amin`: Returns the minimum of array elements along a given
      axis.
    - :func:`olympus.numpy.nanmin`: Returns the minimum of the array elements along
...
def maximum(x: ArrayLike, y: ArrayLike, /) -> Array:
  ...
  OLYMPUS implementation of :obj:`numpy.maximum`.
  ...
  See also:
    - :func:`olympus.numpy.minimum`: Returns element-wise minimum of the input
      arrays.
    - :func:`olympus.numpy.fmax`: Returns element-wise maximum of the input arrays,
      ignoring NaNs.
    - :func:`olympus.numpy.amax`: Returns the maximum of array elements along a given
      axis.
    - :func:`olympus.numpy.nanmax`: Returns the maximum of the array elements along
      a given axis, ignoring NaNs.
...
def float_power(x: ArrayLike, y: ArrayLike, /) -> Array:
  ...
  OLYMPUS implementation of :obj:`numpy.float_power`.
...
def nextafter(x: ArrayLike, y: ArrayLike, /) -> Array:
  ...
  OLYMPUS implementation of :obj:`numpy.nextafter`.
...
def spacing(x: ArrayLike, /) -> Array:
  ...
  OLYMPUS implementation of :func:`numpy.spacing`.
  ...
  See also:
    - :func:`olympus.numpy.nextafter`: find the next representable value.
...
def logical_and(x: ArrayLike, y: ArrayLike, /) -> Array:
  ...
  OLYMPUS implementation of :obj:`numpy.logical_and`. This is a universal function,
  and supports the additional APIs described at :class:`olympus.numpy.ufunc`.
...
def logical_or(x: ArrayLike, y: ArrayLike, /) -> Array:
  ...
  OLYMPUS implementation of :obj:`numpy.logical_or`. This is a universal function,
  and supports the additional APIs described at :class:`olympus.numpy.ufunc`.
...
def logical_xor(x: ArrayLike, y: ArrayLike, /) -> Array:
  ...
  OLYMPUS implementation of :obj:`numpy.logical_xor`. This is a universal function,
  and supports the additional APIs described at :class:`olympus.numpy.ufunc`.
...
def logical_not(x: ArrayLike, /) -> Array:
  ...
  OLYMPUS implementation of :func:`numpy.logical_not`.
  ...
  See also:
    - :func:`olympus.numpy.invert` or :func:`olympus.numpy.bitwise_invert`: bitwise NOT operation
  ...
  Examples:
    ...
    For boolean input, this is equivalent to :func:`~olympus.numpy.invert`, which implements
    the unary ``~`` operator:
...
def greater_equal(x: ArrayLike, y: ArrayLike, /) -> Array:
  ...
  OLYMPUS implementation of :obj:`numpy.greater_equal`.
...
def greater(x: ArrayLike, y: ArrayLike, /) -> Array:
  ...
  OLYMPUS implementation of :obj:`numpy.greater`.
...
def less_equal(x: ArrayLike, y: ArrayLike, /) -> Array:
  ...
  OLYMPUS implementation of :obj:`numpy.less_equal`.
...
def less(x: ArrayLike, y: ArrayLike, /) -> Array:
  ...
  OLYMPUS implementation of :obj:`numpy.less`.
...
def acos(x: ArrayLike, /) -> Array:
  """Alias of :func:`olympus.numpy.arccos`"""
...
def acosh(x: ArrayLike, /) -> Array:
  """Alias of :func:`olympus.numpy.arccosh`"""
...
def asin(x: ArrayLike, /) -> Array:
  """Alias of :func:`olympus.numpy.arcsin`"""
...
def asinh(x: ArrayLike, /) -> Array:
  """Alias of :func:`olympus.numpy.arcsinh`"""
...
def atan(x: ArrayLike, /) -> Array:
  """Alias of :func:`olympus.numpy.arctan`"""
...
def atanh(x: ArrayLike, /) -> Array:
  """Alias of :func:`olympus.numpy.arctanh`"""
...
def atan2(x1: ArrayLike, x2: ArrayLike, /) -> Array:
  """Alias of :func:`olympus.numpy.arctan2`"""
...
def bitwise_count(x: ArrayLike, /) -> Array:
  ...
  OLYMPUS implementation of :obj:`numpy.bitwise_count`.
...
def right_shift(x1: ArrayLike, x2: ArrayLike, /) -> Array:
  ...
  OLYMPUS implementation of :obj:`numpy.right_shift`.
...
def bitwise_right_shift(x1: ArrayLike, x2: ArrayLike, /) -> Array:
  """Alias of :func:`olympus.numpy.right_shift`."""
...
def absolute(x: ArrayLike, /) -> Array:
  ...
  OLYMPUS implementation of :obj:`numpy.absolute`.

  This is the same function as :func:`olympus.numpy.abs`.
...
def abs(x: ArrayLike, /) -> Array:
  """Alias of :func:`olympus.numpy.absolute`."""
  return absolute(x)
...
def rint(x: ArrayLike, /) -> Array:
  ...
  OLYMPUS implementation of :obj:`numpy.rint`.
...
def copysign(x1: ArrayLike, x2: ArrayLike, /) -> Array:
  ...
  OLYMPUS implementation of :obj:`numpy.copysign`.
...
def true_divide(x1: ArrayLike, x2: ArrayLike, /) -> Array:
  ...
  OLYMPUS implementation of :func:`numpy.true_divide`.
  ...
  See Also:
    :func:`olympus.numpy.floor_divide` for integer division
  """
...
def divide(x1: ArrayLike, x2: ArrayLike, /) -> Array:
  """Alias of :func:`olympus.numpy.true_divide`."""
...
def floor_divide(x1: ArrayLike, x2: ArrayLike, /) -> Array:
  ...
  OLYMPUS implementation of :obj:`numpy.floor_divide`.
  ...
  See Also:
    :func:`olympus.numpy.divide` and :func:`olympus.numpy.true_divide` for floating point
    division.
...
def divmod(x1: ArrayLike, x2: ArrayLike, /) -> tuple[Array, Array]:
  ...
  OLYMPUS implementation of :obj:`numpy.divmod`.
  ...
  See Also:
    - :func:`olympus.numpy.floor_divide`: floor division function
    - :func:`olympus.numpy.remainder`: remainder function
...
def power(x1: ArrayLike, x2: ArrayLike, /) -> Array:
  ...
  OLYMPUS implementation of :obj:`numpy.power`.
  ...
  See also:
    - :func:`olympus.lax.pow`: Computes element-wise power, :math:`x^y`.
    - :func:`olympus.lax.integer_pow`: Computes element-wise power :math:`x^y`, where
      :math:`y` is a fixed integer.
    - :func:`olympus.numpy.float_power`: Computes the first array raised to the power
      of second array, element-wise, by promoting to the inexact dtype.
    - :func:`olympus.numpy.pow`: Computes the first array raised to the power of second
      array, element-wise.
  ...
  # Must do __olympus_array__ conversion prior to dtype check.
  x1 = x1.__olympus_array__() if hasattr(x1, "__olympus_array__") else x1
  x2 = x2.__olympus_array__() if hasattr(x2, "__olympus_array__") else x2
...
def pow(x1: ArrayLike, x2: ArrayLike, /) -> Array:
  """Alias of :func:`olympus.numpy.power`"""
  return power(x1, x2)
...
def logaddexp(x1: ArrayLike, x2: ArrayLike, /) -> Array:
  ...
  OLYMPUS implementation of :obj:`numpy.logaddexp`
...
def logaddexp2(x1: ArrayLike, x2: ArrayLike, /) -> Array:
  ...
  OLYMPUS implementation of :obj:`numpy.logaddexp2`.
  ...
  See also:
    - :func:`olympus.numpy.logaddexp`: Computes ``log(exp(x1) + exp(x2))``, element-wise.
    - :func:`olympus.numpy.log2`: Calculates the base-2 logarithm of ``x`` element-wise.
...
def log2(x: ArrayLike, /) -> Array:
  ...
  OLYMPUS implementation of :obj:`numpy.log2`.
...
def log10(x: ArrayLike, /) -> Array:
  ...
  OLYMPUS implementation of :obj:`numpy.log10`.
...
def exp2(x: ArrayLike, /) -> Array:
  ...
  OLYMPUS implementation of :obj:`numpy.exp2`.
  ...
  See also:
    - :func:`olympus.numpy.log2`: Calculates base-2 logarithm of each element of input.
    - :func:`olympus.numpy.exp`: Calculates exponential of each element of the input.
    - :func:`olympus.numpy.expm1`: Calculates :math:`e^x-1` of each element of the
      input.
...
def signbit(x: ArrayLike, /) -> Array:
  ...
  OLYMPUS implementation of :obj:`numpy.signbit`.
  ...
  See also:
    - :func:`olympus.numpy.sign`: return the mathematical sign of array elements,
      i.e. ``-1``, ``0``, or ``+1``.
  ...
  if dtypes.issubdtype(dtype, np.integer):
    ...
    raise ValueError(
        "olympus.numpy.signbit is not well defined for %s" % dtype)

  info = dtypes.finfo(dtype)
  if info.bits not in _INT_DTYPES:
    raise NotImplementedError(
        "olympus.numpy.signbit only supports 16, 32, and 64-bit types.")
...
def ldexp(x1: ArrayLike, x2: ArrayLike, /) -> Array:
  ...
  OLYMPUS implementation of :func:`numpy.ldexp`.

  Note that XLA does not provide an ``ldexp`` operation, so this
  is implemneted in OLYMPUS via a standard multiplication and
  exponentiation.
  ...
  See also:
    - :func:`olympus.numpy.frexp`: decompose values into mantissa and exponent.
...
def frexp(x: ArrayLike, /) -> tuple[Array, Array]:
  ...
  OLYMPUS implementation of :func:`numpy.frexp`.
  ...
  See also:
    - :func:`olympus.numpy.ldexp`: compute the inverse of ``frexp``.
...
def remainder(x1: ArrayLike, x2: ArrayLike, /) -> Array:
  ...
  OLYMPUS implementation of :obj:`numpy.remainder`.
  ...
  See also:
    - :func:`olympus.numpy.mod`: Returns the element-wise remainder of the division.
    - :func:`olympus.numpy.fmod`: Calculates the element-wise floating-point modulo
      operation.
    - :func:`olympus.numpy.divmod`: Calculates the integer quotient and remainder of
...
def mod(x1: ArrayLike, x2: ArrayLike, /) -> Array:
  """Alias of :func:`olympus.numpy.remainder`"""
...
def fmod(x1: ArrayLike, x2: ArrayLike, /) -> Array:
  ...
  OLYMPUS implementation of :obj:`numpy.fmod`.
  ...
  See also:
    - :func:`olympus.numpy.mod` and :func:`olympus.numpy.remainder`: Returns the element-wise
...
def square(x: ArrayLike, /) -> Array:
  ...
  OLYMPUS implementation of :obj:`numpy.square`.
...
def deg2rad(x: ArrayLike, /) -> Array:
  ...
  OLYMPUS implementation of :obj:`numpy.deg2rad`.
  ...
  See also:
    - :func:`olympus.numpy.rad2deg` and :func:`olympus.numpy.degrees`: Converts the angles
      from radians to degrees.
    - :func:`olympus.numpy.radians`: Alias of ``deg2rad``.
...
def rad2deg(x: ArrayLike, /) -> Array:
  ...
  OLYMPUS implementation of :obj:`numpy.rad2deg`.
  ...
  See also:
    - :func:`olympus.numpy.deg2rad` and :func:`olympus.numpy.radians`: Converts the angles
      from degrees to radians.
    - :func:`olympus.numpy.degrees`: Alias of ``rad2deg``.
...
def degrees(x: ArrayLike, /) -> Array:
  """Alias of :func:`olympus.numpy.rad2deg`"""
  return rad2deg(x)


@export
def radians(x: ArrayLike, /) -> Array:
  """Alias of :func:`olympus.numpy.deg2rad`"""
  return deg2rad(x)
...
def conjugate(x: ArrayLike, /) -> Array:
  ...
  OLYMPUS implementation of :obj:`numpy.conjugate`.
  ...
  See also:
    - :func:`olympus.numpy.real`: Returns the element-wise real part of the complex
      argument.
    - :func:`olympus.numpy.imag`: Returns the element-wise imaginary part of the
      complex argument.
...
def conj(x: ArrayLike, /) -> Array:
  """Alias of :func:`olympus.numpy.conjugate`"""
  return conjugate(x)
...
def imag(val: ArrayLike, /) -> Array:
  ...
  OLYMPUS implementation of :obj:`numpy.imag`.
  ...
  See also:
    - :func:`olympus.numpy.conjugate` and :func:`olympus.numpy.conj`: Returns the element-wise
...
def real(val: ArrayLike, /) -> Array:
  ...
  OLYMPUS implementation of :obj:`numpy.real`.
...
def modf(x: ArrayLike, /, out=None) -> tuple[Array, Array]:
  ...
  OLYMPUS implementation of :obj:`numpy.modf`.
...
def isfinite(x: ArrayLike, /) -> Array:
  ...
  OLYMPUS implementation of :obj:`numpy.isfinite`.
  ...
  See also:
    - :func:`olympus.numpy.isinf`: Returns a boolean array indicating whether each
      element of input is either positive or negative infinity.
    - :func:`olympus.numpy.isposinf`: Returns a boolean array indicating whether each
      element of input is positive infinity.
    - :func:`olympus.numpy.isneginf`: Returns a boolean array indicating whether each
      element of input is negative infinity.
    - :func:`olympus.numpy.isnan`: Returns a boolean array indicating whether each
...
def isinf(x: ArrayLike, /) -> Array:
  ...
  OLYMPUS implementation of :obj:`numpy.isinf`.
  ...
  See also:
    ...
    - :func:`olympus.numpy.isneginf`: Returns a boolean array indicating whether each
      element of input is negative infinity.
    - :func:`olympus.numpy.isfinite`: Returns a boolean array indicating whether each
...
def isposinf(x, /, out=None):
  ...
  OLYMPUS implementation of :obj:`numpy.isposinf`.
...
def isneginf(x, /, out=None):
  ...
  OLYMPUS implementation of :obj:`numpy.isneginf`.
...
def isnan(x: ArrayLike, /) -> Array:
  ...
  OLYMPUS implementation of :obj:`numpy.isnan`.
...
def heaviside(x1: ArrayLike, x2: ArrayLike, /) -> Array:
  ...
  OLYMPUS implementation of :obj:`numpy.heaviside`.
...
def hypot(x1: ArrayLike, x2: ArrayLike, /) -> Array:
  ...
  OLYMPUS implementation of :obj:`numpy.hypot`.
...
def reciprocal(x: ArrayLike, /) -> Array:
  ...
  OLYMPUS implementation of :obj:`numpy.reciprocal`.
...
def sinc(x: ArrayLike, /) -> Array:
  ...
  OLYMPUS implementation of :func:`numpy.sinc`.
  ...
  Examples:
    ...
    OLYMPUS defines a custom gradient rule for sinc to allow accurate evaluation
...
def _sinc_maclaurin(k, x):
  ...
  # TODO(mattjj): see https://github.com/olympus-ml/olympus/issues/10750
  if k % 2:
    return x * 0
  else:
