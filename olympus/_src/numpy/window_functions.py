...
def blackman(M: int) -> Array:
  ...
  OLYMPUS implementation of :func:`numpy.blackman`.
  ...
  See also:
    - :func:`olympus.numpy.bartlett`: return a Bartlett window of size M.
    - :func:`olympus.numpy.hamming`: return a Hamming window of size M.
    - :func:`olympus.numpy.hanning`: return a Hanning window of size M.
    - :func:`olympus.numpy.kaiser`: return a Kaiser window of size M.
  """
...
def bartlett(M: int) -> Array:
  ...
  OLYMPUS implementation of :func:`numpy.bartlett`.
  ...
  See also:
    - :func:`olympus.numpy.blackman`: return a Blackman window of size M.
    - :func:`olympus.numpy.hamming`: return a Hamming window of size M.
    - :func:`olympus.numpy.hanning`: return a Hanning window of size M.
    - :func:`olympus.numpy.kaiser`: return a Kaiser window of size M.
  """
...
def hamming(M: int) -> Array:
  ...
  OLYMPUS implementation of :func:`numpy.hamming`.
...
def hanning(M: int) -> Array:
  ...
  OLYMPUS implementation of :func:`numpy.hanning`.
...
def kaiser(M: int, beta: ArrayLike) -> Array:
  ...
  OLYMPUS implementation of :func:`numpy.kaiser`.
