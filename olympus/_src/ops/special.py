...
from olympus._src.numpy.reductions import _reduction_dims, Axis
from olympus._src.numpy.util import promote_args_inexact
from olympus._src.typing import Array, ArrayLike

import numpy as np

# The definition of logsumexp is shared between olympus.nn and olympus.scipy, and
...
def logsumexp(a: ArrayLike, axis: Axis = None, b: ArrayLike | None = None,
  ...
  OLYMPUS implementation of :func:`scipy.special.logsumexp`.
