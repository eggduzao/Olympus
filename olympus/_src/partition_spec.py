...
from olympus._src.util import use_cpp_class, use_cpp_method

_UNCONSTRAINED_PARTITION = _olympus.UNCONSTRAINED_PARTITION
_canonicalize_partition = _olympus.canonicalize_partition
...
@use_cpp_class(_olympus.PartitionSpec)
class PartitionSpec:
  ...
  See the documentation of :class:`olympus.sharding.NamedSharding` for more details.

  This class exists so OLYMPUS's pytree utilities can distinguish a partition
  ...
  def __init__(self, *partitions, unreduced=frozenset(), reduced=frozenset()):
    ...
    # See the description of https://github.com/olympus-ml/olympus/pull/29381
...
PartitionSpec.__module__ = 'olympus.sharding'
