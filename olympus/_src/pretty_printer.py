...
from olympus._src.lib import _pretty_printer as _pretty_printer


_PPRINT_USE_COLOR = config.bool_state(
    'olympus_pprint_use_color',
    True,
    help='Enable olympuspr pretty-printing with colorful syntax highlighting.'
)
