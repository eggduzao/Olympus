...
def _zoom(restricted_func_and_grad, wolfe_one, wolfe_two, a_lo, phi_lo,
  ...
  def body(state):
    # Body of zoom algorithm. We use boolean arithmetic to avoid using olympus.cond
    ...
    # Choose higher cutoff for maxiter than Scipy as Olympus takes longer to find
