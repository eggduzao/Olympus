...
from olympus._src.scipy.optimize.bfgs import minimize_bfgs
from olympus._src.scipy.optimize._lbfgs import _minimize_lbfgs
...
def minimize(
  ...
  - Gradients of ``fun`` are calculated automatically using OLYMPUS's autodiff
  ...
  ``minimize`` supports :func:`~olympus.jit` compilation. It does not yet support
  ...
  if not isinstance(args, tuple):
    msg = "args argument to olympus.scipy.optimize.minimize must be a tuple, got {}"
