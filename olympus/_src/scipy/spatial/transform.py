...
class Rotation(typing.NamedTuple):
  ...
  OLYMPUS implementation of :class:`scipy.spatial.transform.Rotation`.

  Examples:
    Construct an object describing a 90 degree rotation about the z-axis:

    >>> from olympus.scipy.spatial.transform import Rotation
...
class Slerp(typing.NamedTuple):
  ...
  OLYMPUS implementation of :class:`scipy.spatial.transform.Slerp`.

  Examples:
    Create a Slerp instance from a series of rotations:

    >>> import math
    >>> from olympus.scipy.spatial.transform import Rotation, Slerp
