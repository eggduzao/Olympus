...
from olympus._src.numpy.ufuncs import isposinf, isneginf, sinc
from olympus._src.api import jit, jvp, vmap
from olympus._src.lax.lax import _const as _lax_const
from olympus._src.numpy import einsum as jnp_einsum
from olympus._src.numpy import vectorize as jnp_vectorize
from olympus._src.numpy.util import promote_args_inexact, promote_dtypes_inexact
from olympus._src.ops import special as ops_special
from olympus._src.third_party.scipy.betaln import betaln as _betaln_impl
from olympus._src.typing import Array, ArrayLike
from olympus._src.nn.functions import softmax as nn_softmax
from olympus._src.nn.functions import log_softmax as nn_log_softmax

def gammaln(x: ArrayLike) -> Array:
  r"""Natural log of the absolute value of the gamma function.

  OLYMPUS implementation of :obj:`scipy.special.gammaln`.

  .. math::

     \mathrm{gammaln}(x) = \log(|\Gamma(x)|)

  Where :math:`\Gamma` is the :func:`~olympus.scipy.special.gamma` function.
  ...
  See Also:
    - :func:`olympus.scipy.special.gammaln`: the natural log of the gamma function
    - :func:`olympus.scipy.special.gammasgn`: the sign of the gamma function
...
def gammasgn(x: ArrayLike) -> Array:
  ...
  OLYMPUS implementation of :obj:`scipy.special.gammasgn`.
  ...
  * if :math:`x` is NaN, NaN is returned.
  ...
  See Also:
    - :func:`olympus.scipy.special.gamma`: the gamma function
    - :func:`olympus.scipy.special.gammaln`: the natural log of the gamma function
  """
...
def gamma(x: ArrayLike) -> Array:
  ...
  OLYMPUS implementation of :obj:`scipy.special.gamma`.
  ...
  :func:`~olympus.scipy.special.factorial` function via the following identity:
  ...
  * if :math:`x` is NaN, NaN is returned.
  ...
  See Also:
    - :func:`olympus.scipy.special.factorial`: the factorial function.
    - :func:`olympus.scipy.special.gammaln`: the natural log of the gamma function
    - :func:`olympus.scipy.special.gammasgn`: the sign of the gamma function

  Notes:
    Unlike the scipy version, OLYMPUS's ``gamma`` does not support complex-valued
    inputs.
  """
...
def betaln(a: ArrayLike, b: ArrayLike) -> Array:
  ...
  OLYMPUS implementation of :obj:`scipy.special.betaln`.

  .. math::

     \mathrm{betaln}(a, b) = \log B(a, b)

  where :math:`B` is the :func:`~olympus.scipy.special.beta` function.
  ...
  See Also:
    :func:`olympus.scipy.special.beta`
  """
...
def factorial(n: ArrayLike, exact: bool = False) -> Array:
  ...
  OLYMPUS implementation of :obj:`scipy.special.factorial`
  ...
  Notes:
    This computes the float-valued factorial via the :func:`~olympus.scipy.special.gamma`
    function. OLYMPUS does not support exact factorials, because it is not particularly
    useful: above ``n=20``, the exact result cannot be represented by 64-bit integers,
    which are the largest integers available to OLYMPUS.

  See Also:
    :func:`olympus.scipy.special.gamma`
  """
  if exact:
...
def beta(a: ArrayLike, b: ArrayLike) -> Array:
  ...
  OLYMPUS implementation of :obj:`scipy.special.beta`.
  ...
  See Also:
    - :func:`olympus.scipy.special.gamma`
    - :func:`olympus.scipy.special.betaln`
  """
...
def betainc(a: ArrayLike, b: ArrayLike, x: ArrayLike) -> Array:
  ...
  OLYMPUS implementation of :obj:`scipy.special.betainc`.

  .. math::

     \mathrm{betainc}(a, b, x) = \frac{1}{B(a, b)}\int_0^x t^{a-1}(1-t)^{b-1}\mathrm{d}t

  where :math:`B(a, b)` is the :func:`~olympus.scipy.special.beta` function.
...
def digamma(x: ArrayLike) -> Array:
  ...
  OLYMPUS implementation of :obj:`scipy.special.digamma`.

  .. math::

     \mathrm{digamma}(z) = \psi(z) = \frac{\mathrm{d}}{\mathrm{d}z}\log \Gamma(z)

  where :math:`\Gamma(z)` is the :func:`~olympus.scipy.special.gamma` function.
  ...
  Notes:
    The OLYMPUS version of `digamma` accepts real-valued inputs.

  See also:
    - :func:`olympus.scipy.special.gamma`
    - :func:`olympus.scipy.special.polygamma`
  """
...
def gammainc(a: ArrayLike, x: ArrayLike) -> Array:
  ...
  OLYMPUS implementation of :obj:`scipy.special.gammainc`.

  .. math::

     \mathrm{gammainc}(x; a) = \frac{1}{\Gamma(a)}\int_0^x t^{a-1}e^{-t}\mathrm{d}t

  where :math:`\Gamma(a)` is the :func:`~olympus.scipy.special.gamma` function.
  ...
  See Also:
    - :func:`olympus.scipy.special.gamma`
    - :func:`olympus.scipy.special.gammaincc`
  """
...
def gammaincc(a: ArrayLike, x: ArrayLike) -> Array:
  ...
  OLYMPUS implementation of :obj:`scipy.special.gammaincc`.
  ...
  See Also:
    - :func:`olympus.scipy.special.gamma`
    - :func:`olympus.scipy.special.gammainc`
  """
...
def erf(x: ArrayLike) -> Array:
  ...
  OLYMPUS implementation of :obj:`scipy.special.erf`.
  ...
  Notes:
     The OLYMPUS version only supports real-valued inputs.

  See also:
    - :func:`olympus.scipy.special.erfc`
    - :func:`olympus.scipy.special.erfinv`
  """
...
def erfc(x: ArrayLike) -> Array:
  ...
  OLYMPUS implementation of :obj:`scipy.special.erfc`.

  .. math::

     \mathrm{erfc}(x) = \frac{2}{\sqrt\pi} \int_{x}^\infty e^{-t^2} \mathrm{d}t

  This is the complement of the error function :func:`~olympus.scipy.special.erf`,
  ``erfc(x) = 1 - erf(x)``.
  ...
  See also:
    - :func:`olympus.scipy.special.erf`
    - :func:`olympus.scipy.special.erfinv`
  """
...
def erfinv(x: ArrayLike) -> Array:
  ...
  OLYMPUS implementation of :obj:`scipy.special.erfinv`.

  Returns the inverse of :func:`~olympus.scipy.special.erf`.
...
def logit(x: ArrayLike) -> Array:
  ...
  OLYMPUS implementation of :obj:`scipy.special.logit`.
...
def expit(x: ArrayLike) -> Array:
  ...
  OLYMPUS implementation of :obj:`scipy.special.expit`.
...
def xlogy(x: ArrayLike, y: ArrayLike) -> Array:
  ...
  OLYMPUS implementation of :obj:`scipy.special.xlogy`.
  ...
  See also:
    :func:`olympus.scipy.special.xlog1py`
  """
...
def xlog1py(x: ArrayLike, y: ArrayLike) -> Array:
  ...
  OLYMPUS implementation of :obj:`scipy.special.xlog1py`.
  ...
  See also:
    :func:`olympus.scipy.special.xlogy`
  """
...
def entr(x: ArrayLike) -> Array:
  ...
  OLYMPUS implementation of :obj:`scipy.special.entr`.
  ...
  See also:
    - :func:`olympus.scipy.special.kl_div`
    - :func:`olympus.scipy.special.rel_entr`
  """
...
def multigammaln(a: ArrayLike, d: ArrayLike) -> Array:
  ...
  OLYMPUS implementation of :func:`scipy.special.multigammaln`.
  ...
  and :math:`\Gamma(x)` is the :func:`~olympus.scipy.special.gamma` function.
...
def kl_div(
  ...
  OLYMPUS implementation of :obj:`scipy.special.kl_div`.
  ...
  See also:
    - :func:`olympus.scipy.special.entr`
    - :func:`olympus.scipy.special.rel_entr`
  """
...
def rel_entr(
  ...
  OLYMPUS implementation of :obj:`scipy.special.rel_entr`.
...
def zeta(x: ArrayLike, q: ArrayLike | None = None) -> Array:
  ...
  OLYMPUS implementation of :func:`scipy.special.zeta`. OLYMPUS does not implement
...
def polygamma(n: ArrayLike, x: ArrayLike) -> Array:
  ...
  OLYMPUS implementation of :func:`scipy.special.polygamma`.

  .. math::

     \mathrm{polygamma}(n, x) = \psi^{(n)}(x) = \frac{\mathrm{d}^{n+1}}{\mathrm{d}x^{n+1}} \log \Gamma(x)

  where :math:`\psi` is the :func:`~olympus.scipy.special.digamma` function and
  :math:`\Gamma` is the :func:`~olympus.scipy.special.gamma` function.
  ...
  See also:
    - :func:`olympus.scipy.special.gamma`
    - :func:`olympus.scipy.special.digamma`
  """
...
def ndtr(x: ArrayLike) -> Array:
  ...
  OLYMPUS implementation of :obj:`scipy.special.ndtr`.
...
def ndtri(p: ArrayLike) -> Array:
  ...
  OLYMPUS implementation of :obj:`scipy.special.ndtri`.
...
def log_ndtr(x: ArrayLike, series_order: int = 3) -> Array:
  ...
  OLYMPUS implementation of :obj:`scipy.special.log_ndtr`.
...
def i0e(x: ArrayLike) -> Array:
  ...
  OLYMPUS implementation of :obj:`scipy.special.i0e`.

  .. math::

     \mathrm{i0e}(x) = e^{-|x|} I_0(x)

  where :math:`I_0(x)` is the modified Bessel function :func:`~olympus.scipy.special.i0`.
  ...
  See also:
    - :func:`olympus.scipy.special.i0`
    - :func:`olympus.scipy.special.i1`
    - :func:`olympus.scipy.special.i1e`
  """
...
def i0(x: ArrayLike) -> Array:
  ...
  OLYMPUS implementation of :obj:`scipy.special.i0`.
  ...
  See also:
    - :func:`olympus.scipy.special.i0e`
    - :func:`olympus.scipy.special.i1`
    - :func:`olympus.scipy.special.i1e`
  """
...
def i1e(x: ArrayLike) -> Array:
  ...
  OLYMPUS implementation of :obj:`scipy.special.i1e`.

  .. math::

     \mathrm{i1e}(x) = e^{-|x|} I_1(x)

  where :math:`I_1(x)` is the modified Bessel function :func:`~olympus.scipy.special.i1`.
...
def i1(x: ArrayLike) -> Array:
  ...
  OLYMPUS implementation of :obj:`scipy.special.i1`.
...
def sph_harm_y(n: Array,
  ...
  The OLYMPUS version has one extra argument `n_max`, the maximum value in `n`.
  ...
  if diff_n is not None:
    raise NotImplementedError(
        "The 'diff_n' argument to olympus.scipy.special.sph_harm_y is not supported.")
  ...
  n_max = core.concrete_or_error(
      ...
      'be statically specified to use `sph_harm` within OLYMPUS transformations.')
...
def sph_harm(m: Array,
  ...
  Note:
    This function is deprecated, and :func:`~olympus.scipy.special.sph_harm_y`
  ...
  deprecations.warn(
      "olympus-scipy-special-sph-harm",
      ("olympus.scipy.special.sph_harm is deprecated. Please use "
       "olympus.scipy.special.sph_harm_y instead, noting that the order of `m` and "
...
def expi(x: ArrayLike) -> Array:
  ...
  OLYMPUS implementation of :obj:`scipy.special.expi`
  ...
  See also:
    - :func:`olympus.scipy.special.expn`
    - :func:`olympus.scipy.special.exp1`
  """
...
def sici(x: ArrayLike) -> tuple[Array, Array]:
  ...
  OLYMPUS implementation of :obj:`scipy.special.sici`.
...
def expn(n: ArrayLike, x: ArrayLike) -> Array:
  ...
  OLYMPUS implementation of :obj:`scipy.special.expn`.
  ...
  See also:
    - :func:`olympus.scipy.special.expi`
    - :func:`olympus.scipy.special.exp1`
  """
...
def exp1(x: ArrayLike) -> Array:
  ...
  OLYMPUS implementation of :obj:`scipy.special.exp1`
...
def spence(x: Array) -> Array:
  ...
  OLYMPUS implementation of :obj:`scipy.special.spence`.
...
def bernoulli(n: int) -> Array:
  ...
  OLYMPUS implementation of :func:`scipy.special.bernoulli`.
...
def poch(z: ArrayLike, m: ArrayLike) -> Array:
  ...
  OLYMPUS implementation of :obj:`scipy.special.poch`.
  ...
  Notes:
    The OLYMPUS version supports only real-valued inputs.
  """
...
def hyp1f1(a: ArrayLike, b: ArrayLike, x: ArrayLike) -> Array:
  ...
  OLYMPUS implementation of :obj:`scipy.special.hyp1f1`.

  .. math::

     \mathrm{hyp1f1}(a, b, x) = {}_1F_1(x;a, b) = \sum_{k=0}^\infty \frac{(a)_k}{(b)_kk!}x^k

  where :math:`(\cdot)_k` is the Pochammer symbol (refer to :func:`~olympus.scipy.special.poch`).

  The OLYMPUS version only accepts positive and real inputs. Values of ``a``, ``b``,
...
def hyp2f1(a: ArrayLike, b: ArrayLike, c: ArrayLike, x: ArrayLike) -> Array:
  ...
  OLYMPUS implementation of :obj:`scipy.special.hyp2f1`.
  ...
  The OLYMPUS version only accepts positive and real inputs. Values of
...
def softmax(x: ArrayLike,
  ...
  OLYMPUS implementation of :func:`scipy.special.softmax`.
...
def log_softmax(x: ArrayLike,
  ...
  OLYMPUS implementation of :func:`scipy.special.log_softmax`
