...
def logpmf(k: ArrayLike, p: ArrayLike, loc: ArrayLike = 0) -> Array:
  ...
  OLYMPUS implementation of :obj:`scipy.stats.bernoulli` ``logpmf``
  ...
  See Also:
    - :func:`olympus.scipy.stats.bernoulli.cdf`
    - :func:`olympus.scipy.stats.bernoulli.pmf`
    - :func:`olympus.scipy.stats.bernoulli.ppf`
  """
...
def pmf(k: ArrayLike, p: ArrayLike, loc: ArrayLike = 0) -> Array:
  ...
  OLYMPUS implementation of :obj:`scipy.stats.bernoulli` ``pmf``
  ...
  See Also:
    - :func:`olympus.scipy.stats.bernoulli.cdf`
    - :func:`olympus.scipy.stats.bernoulli.logpmf`
    - :func:`olympus.scipy.stats.bernoulli.ppf`
  """
...
def cdf(k: ArrayLike, p: ArrayLike) -> Array:
  ...
  OLYMPUS implementation of :obj:`scipy.stats.bernoulli` ``cdf``
...
def ppf(q: ArrayLike, p: ArrayLike) -> Array:
  ...
  OLYMPUS implementation of :obj:`scipy.stats.bernoulli` ``ppf``

  The percent point function is the inverse of the cumulative
  distribution function, :func:`olympus.scipy.stats.bernoulli.cdf`.
