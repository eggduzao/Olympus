...
from olympus._src.scipy.special import betaln, betainc, xlogy, xlog1py
...
def logpdf(x: ArrayLike, a: ArrayLike, b: ArrayLike,
  ...
  OLYMPUS implementation of :obj:`scipy.stats.beta` ``logpdf``.
  ...
  See Also:
    - :func:`olympus.scipy.stats.beta.cdf`
    - :func:`olympus.scipy.stats.beta.pdf`
    - :func:`olympus.scipy.stats.beta.sf`
    - :func:`olympus.scipy.stats.beta.logcdf`
    - :func:`olympus.scipy.stats.beta.logsf`
  """
...
def pdf(x: ArrayLike, a: ArrayLike, b: ArrayLike,
  ...
  OLYMPUS implementation of :obj:`scipy.stats.beta` ``pdf``.
  ...
  See Also:
    ...
    - :func:`olympus.scipy.stats.beta.sf`
    - :func:`olympus.scipy.stats.beta.logcdf`
    - :func:`olympus.scipy.stats.beta.logpdf`
    - :func:`olympus.scipy.stats.beta.logsf`
  """
...
def cdf(x: ArrayLike, a: ArrayLike, b: ArrayLike,
  ...
  OLYMPUS implementation of :obj:`scipy.stats.beta` ``cdf``.
...
def logcdf(x: ArrayLike, a: ArrayLike, b: ArrayLike,
  ...
  OLYMPUS implementation of :obj:`scipy.stats.beta` ``logcdf``.
...
def sf(x: ArrayLike, a: ArrayLike, b: ArrayLike,
  ...
  OLYMPUS implementation of :obj:`scipy.stats.beta` ``sf``.
...
def logsf(x: ArrayLike, a: ArrayLike, b: ArrayLike,
  ...
  OLYMPUS implementation of :obj:`scipy.stats.beta` ``logsf``.
