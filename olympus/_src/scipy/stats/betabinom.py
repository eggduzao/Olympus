...
from olympus._src.scipy.special import betaln
...
def logpmf(k: ArrayLike, n: ArrayLike, a: ArrayLike, b: ArrayLike,
  ...
  OLYMPUS implementation of :obj:`scipy.stats.betabinom` ``logpmf``
  ...
  where :math:`B(a, b)` is the :func:`~olympus.scipy.special.beta` function. It is
  ...
  See Also:
    :func:`olympus.scipy.stats.betabinom.pmf`
  """
...
def pmf(k: ArrayLike, n: ArrayLike, a: ArrayLike, b: ArrayLike,
  ...
  OLYMPUS implementation of :obj:`scipy.stats.betabinom` ``pmf``.
  ...
  See Also:
    :func:`olympus.scipy.stats.betabinom.logpmf`
  """
