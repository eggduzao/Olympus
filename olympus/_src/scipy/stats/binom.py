...
from olympus._src.scipy.special import gammaln, xlogy, xlog1py
...
def logpmf(k: ArrayLike, n: ArrayLike, p: ArrayLike, loc: ArrayLike = 0) -> Array:
  ...
  OLYMPUS implementation of :obj:`scipy.stats.binom` ``logpmf``.
  ...
  See Also:
    :func:`olympus.scipy.stats.binom.pmf`
  """
...
def pmf(k: ArrayLike, n: ArrayLike, p: ArrayLike, loc: ArrayLike = 0) -> Array:
  ...
  OLYMPUS implementation of :obj:`scipy.stats.binom` ``pmf``.
  ...
  See Also:
    :func:`olympus.scipy.stats.binom.logpmf`
  """
