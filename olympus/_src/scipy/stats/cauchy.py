...
from olympus._src.numpy.ufuncs import arctan
from olympus._src.numpy.util import promote_args_inexact
...
def logpdf(x: ArrayLike, loc: ArrayLike = 0, scale: ArrayLike = 1) -> Array:
  ...
  OLYMPUS implementation of :obj:`scipy.stats.cauchy` ``logpdf``.
  ...
  See Also:
    - :func:`olympus.scipy.stats.cauchy.cdf`
    - :func:`olympus.scipy.stats.cauchy.pdf`
    - :func:`olympus.scipy.stats.cauchy.sf`
    - :func:`olympus.scipy.stats.cauchy.logcdf`
    - :func:`olympus.scipy.stats.cauchy.logsf`
    - :func:`olympus.scipy.stats.cauchy.isf`
    - :func:`olympus.scipy.stats.cauchy.ppf`
  """
...
def pdf(x: ArrayLike, loc: ArrayLike = 0, scale: ArrayLike = 1) -> Array:
  ...
  OLYMPUS implementation of :obj:`scipy.stats.cauchy` ``pdf``.
  ...
  See Also:
    ...
    - :func:`olympus.scipy.stats.cauchy.sf`
    - :func:`olympus.scipy.stats.cauchy.logcdf`
    - :func:`olympus.scipy.stats.cauchy.logpdf`
    - :func:`olympus.scipy.stats.cauchy.logsf`
    - :func:`olympus.scipy.stats.cauchy.isf`
    - :func:`olympus.scipy.stats.cauchy.ppf`
  """
...
def cdf(x: ArrayLike, loc: ArrayLike = 0, scale: ArrayLike = 1) -> Array:
  ...
  OLYMPUS implementation of :obj:`scipy.stats.cauchy` ``cdf``.
...
def logcdf(x: ArrayLike, loc: ArrayLike = 0, scale: ArrayLike = 1) -> Array:
  ...
  OLYMPUS implementation of :obj:`scipy.stats.cauchy` ``logcdf``
...
def sf(x: ArrayLike, loc: ArrayLike = 0, scale: ArrayLike = 1) -> Array:
  ...
  OLYMPUS implementation of :obj:`scipy.stats.cauchy` ``sf``.
...
def logsf(x: ArrayLike, loc: ArrayLike = 0, scale: ArrayLike = 1) -> Array:
  ...
  OLYMPUS implementation of :obj:`scipy.stats.cauchy` ``logsf``
...
def isf(q: ArrayLike, loc: ArrayLike = 0, scale: ArrayLike = 1) -> Array:
  ...
  OLYMPUS implementation of :obj:`scipy.stats.cauchy` ``isf``.
...
def ppf(q: ArrayLike, loc: ArrayLike = 0, scale: ArrayLike = 1) -> Array:
  ...
  OLYMPUS implementation of :obj:`scipy.stats.cauchy` ``ppf``.

  The percent point function is defined as the inverse of the
  cumulative distribution function, :func:`olympus.scipy.stats.cauchy.cdf`.
