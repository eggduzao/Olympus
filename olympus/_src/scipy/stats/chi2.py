...
from olympus._src.scipy.special import gammainc, gammaincc
...
def logpdf(x: ArrayLike, df: ArrayLike, loc: ArrayLike = 0, scale: ArrayLike = 1) -> Array:
  ...
  OLYMPUS implementation of :obj:`scipy.stats.chi2` ``logpdf``.
  ...
  :func:`~olympus.scipy.special.gamma` function. OLYMPUS follows the scipy
  ...
  See Also:
    - :func:`olympus.scipy.stats.chi2.cdf`
    - :func:`olympus.scipy.stats.chi2.pdf`
    - :func:`olympus.scipy.stats.chi2.sf`
    - :func:`olympus.scipy.stats.chi2.logcdf`
    - :func:`olympus.scipy.stats.chi2.logsf`
  """
...
def pdf(x: ArrayLike, df: ArrayLike, loc: ArrayLike = 0, scale: ArrayLike = 1) -> Array:
  ...
  OLYMPUS implementation of :obj:`scipy.stats.chi2` ``pdf``.
  ...
  See Also:
    ...
    - :func:`olympus.scipy.stats.chi2.sf`
    - :func:`olympus.scipy.stats.chi2.logcdf`
    - :func:`olympus.scipy.stats.chi2.logpdf`
    - :func:`olympus.scipy.stats.chi2.logsf`
  """
...
def cdf(x: ArrayLike, df: ArrayLike, loc: ArrayLike = 0, scale: ArrayLike = 1) -> Array:
  ...
  OLYMPUS implementation of :obj:`scipy.stats.chi2` ``cdf``.
  ...
  :func:`olympus.scipy.stats.chi2.pdf`. OLYMPUS follows the scipy
  convention of using ``df`` to denote degrees of freedom.
...
def logcdf(x: ArrayLike, df: ArrayLike, loc: ArrayLike = 0, scale: ArrayLike = 1) -> Array:
  ...
  OLYMPUS implementation of :obj:`scipy.stats.chi2` ``logcdf``.
...
def sf(x: ArrayLike, df: ArrayLike, loc: ArrayLike = 0, scale: ArrayLike = 1) -> Array:
  ...
  OLYMPUS implementation of :obj:`scipy.stats.chi2` ``sf``.
  ...
  :func:`olympus.scipy.stats.chi2.cdf`. OLYMPUS follows the scipy
  convention of using ``df`` to denote degrees of freedom.
...
def logsf(x: ArrayLike, df: ArrayLike, loc: ArrayLike = 0, scale: ArrayLike = 1) -> Array:
  ...
  OLYMPUS implementation of :obj:`scipy.stats.chi2` ``logsf``.
