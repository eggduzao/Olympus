...
from olympus._src.scipy.special import gammaln, xlogy
...
def logpdf(x: ArrayLike, alpha: ArrayLike) -> Array:
  ...
  OLYMPUS implementation of :obj:`scipy.stats.dirichlet` ``logpdf``.
  ...
  where :math:`B(\mathbf{\alpha})` is the :func:`~olympus.scipy.special.beta` function
  ...
  See Also:
    :func:`olympus.scipy.stats.dirichlet.pdf`
  """
...
def pdf(x: ArrayLike, alpha: ArrayLike) -> Array:
  ...
  OLYMPUS implementation of :obj:`scipy.stats.dirichlet` ``pdf``.
  ...
  See Also:
    :func:`olympus.scipy.stats.dirichlet.logpdf`
  """
