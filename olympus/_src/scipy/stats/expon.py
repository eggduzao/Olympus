...
def logpdf(x: ArrayLike, loc: ArrayLike = 0, scale: ArrayLike = 1) -> Array:
  ...
  OLYMPUS implementation of :obj:`scipy.stats.expon` ``logpdf``.
  ...
  See Also:
    :func:`olympus.scipy.stats.expon.cdf`
    :func:`olympus.scipy.stats.expon.pdf`
    :func:`olympus.scipy.stats.expon.ppf`
    :func:`olympus.scipy.stats.expon.sf`
    :func:`olympus.scipy.stats.expon.logcdf`
    :func:`olympus.scipy.stats.expon.logpdf`
    :func:`olympus.scipy.stats.expon.logsf`
  """
...
def pdf(x: ArrayLike, loc: ArrayLike = 0, scale: ArrayLike = 1) -> Array:
  ...
  OLYMPUS implementation of :obj:`scipy.stats.expon` ``pdf``.
...
def cdf(x: ArrayLike, loc: ArrayLike = 0, scale: ArrayLike = 1) -> Array:
  ...
  OLYMPUS implementation of :obj:`scipy.stats.expon` ``cdf``.
...
def logcdf(x: ArrayLike, loc: ArrayLike = 0, scale: ArrayLike = 1) -> Array:
  ...
  OLYMPUS implementation of :obj:`scipy.stats.expon` ``logcdf``.
...
def logsf(x: ArrayLike, loc: ArrayLike = 0, scale: ArrayLike = 1) -> Array:
  ...
  OLYMPUS implementation of :obj:`scipy.stats.expon` ``logsf``.
...
def sf(x: ArrayLike, loc: ArrayLike = 0, scale: ArrayLike = 1) -> Array:
  ...
  OLYMPUS implementation of :obj:`scipy.stats.expon` ``sf``.
...
def ppf(q: ArrayLike, loc: ArrayLike = 0, scale: ArrayLike = 1) -> Array:
  ...
  OLYMPUS implementation of :obj:`scipy.stats.expon` ``ppf``.

  The percent point function is defined as the inverse of the
  cumulative distribution function, :func:`olympus.scipy.stats.expon.cdf`.
