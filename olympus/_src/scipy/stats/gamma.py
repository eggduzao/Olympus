...
from olympus._src.scipy.special import gammaln, xlogy, gammainc, gammaincc
...
def logpdf(x: ArrayLike, a: ArrayLike, loc: ArrayLike = 0, scale: ArrayLike = 1) -> Array:
  ...
  OLYMPUS implementation of :obj:`scipy.stats.gamma` ``logpdf``.
  ...
  See Also:
    - :func:`olympus.scipy.stats.gamma.cdf`
    - :func:`olympus.scipy.stats.gamma.pdf`
    - :func:`olympus.scipy.stats.gamma.sf`
    - :func:`olympus.scipy.stats.gamma.logcdf`
    - :func:`olympus.scipy.stats.gamma.logsf`
  """
...
def pdf(x: ArrayLike, a: ArrayLike, loc: ArrayLike = 0, scale: ArrayLike = 1) -> Array:
  ...
  OLYMPUS implementation of :obj:`scipy.stats.gamma` ``pdf``.
  ...
  See Also:
    ...
    - :func:`olympus.scipy.stats.gamma.sf`
    - :func:`olympus.scipy.stats.gamma.logcdf`
    - :func:`olympus.scipy.stats.gamma.logpdf`
    - :func:`olympus.scipy.stats.gamma.logsf`
  """
...
def cdf(x: ArrayLike, a: ArrayLike, loc: ArrayLike = 0, scale: ArrayLike = 1) -> Array:
  ...
  OLYMPUS implementation of :obj:`scipy.stats.gamma` ``cdf``.
...
def logcdf(x: ArrayLike, a: ArrayLike, loc: ArrayLike = 0, scale: ArrayLike = 1) -> Array:
  ...
  OLYMPUS implementation of :obj:`scipy.stats.gamma` ``logcdf``.
...
def sf(x: ArrayLike, a: ArrayLike, loc: ArrayLike = 0, scale: ArrayLike = 1) -> Array:
  ...
  OLYMPUS implementation of :obj:`scipy.stats.gamma` ``sf``.
...
def logsf(x: ArrayLike, a: ArrayLike, loc: ArrayLike = 0, scale: ArrayLike = 1) -> Array:
  ...
  OLYMPUS implementation of :obj:`scipy.stats.gamma` ``logsf``.
