...
def logpdf(x: ArrayLike, beta: ArrayLike) -> Array:
  ...
  OLYMPUS implementation of :obj:`scipy.stats.gennorm` ``logpdf``.
  ...
  where :math:`\Gamma` is the :func:`~olympus.scipy.special.gamma` function, and
  :math:`\beta > 0`.
  ...
  See Also:
    - :func:`olympus.scipy.stats.gennorm.cdf`
    - :func:`olympus.scipy.stats.gennorm.pdf`
  """
...
def cdf(x: ArrayLike, beta: ArrayLike) -> Array:
  ...
  OLYMPUS implementation of :obj:`scipy.stats.gennorm` ``cdf``.
  ...
  See Also:
    - :func:`olympus.scipy.stats.gennorm.pdf`
    - :func:`olympus.scipy.stats.gennorm.logpdf`
  """
...
def pdf(x: ArrayLike, beta: ArrayLike) -> Array:
  ...
  OLYMPUS implementation of :obj:`scipy.stats.gennorm` ``pdf``.
