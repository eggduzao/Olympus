...
from olympus._src.scipy.special import xlog1py
...
def logpmf(k: ArrayLike, p: ArrayLike, loc: ArrayLike = 0) -> Array:
  ...
  OLYMPUS implementation of :obj:`scipy.stats.geom` ``logpmf``.
  ...
  See Also:
    :func:`olympus.scipy.stats.geom.pmf`
  """
...
def pmf(k: ArrayLike, p: ArrayLike, loc: ArrayLike = 0) -> Array:
  ...
  OLYMPUS implementation of :obj:`scipy.stats.geom` ``pmf``.
  ...
  See Also:
    :func:`olympus.scipy.stats.geom.logpmf`
  """
