...
from olympus._src.scipy.special import xlogy, xlog1py
...
def logpdf(x: ArrayLike,
  ...
  See Also:
    - :func:`olympus.scipy.stats.gumbel_l.pdf`
    - :func:`olympus.scipy.stats.gumbel_l.logcdf`
    - :func:`olympus.scipy.stats.gumbel_l.cdf`
    - :func:`olympus.scipy.stats.gumbel_l.ppf`
    - :func:`olympus.scipy.stats.gumbel_l.logsf`
    - :func:`olympus.scipy.stats.gumbel_l.sf`
  """
...
def pdf(x: ArrayLike, loc: ArrayLike = 0, scale: ArrayLike = 1) -> Array:
  ...
  OLYMPUS implementation of :obj:`scipy.stats.gumbel_l` ``pdf``.
  ...
  See Also:
    - :func:`olympus.scipy.stats.gumbel_l.logpdf`
    - :func:`olympus.scipy.stats.gumbel_l.logcdf`
    - :func:`olympus.scipy.stats.gumbel_l.cdf`
    - :func:`olympus.scipy.stats.gumbel_l.ppf`
    - :func:`olympus.scipy.stats.gumbel_l.logsf`
...
def logcdf(x: ArrayLike,
  ...
  OLYMPUS implementation of :obj:`scipy.stats.gumbel_l` ``logcdf``.
...
def cdf(x: ArrayLike, loc: ArrayLike = 0, scale: ArrayLike = 1) -> Array:
  ...
  OLYMPUS implementation of :obj:`scipy.stats.gumbel_l` ``cdf``.
...
def ppf(p: ArrayLike, loc: ArrayLike = 0, scale: ArrayLike = 1) -> Array:
  ...
  OLYMPUS implementation of :obj:`scipy.stats.gumbel_l` ``ppf``.
...
def sf(x: ArrayLike, loc: ArrayLike = 0, scale: ArrayLike = 1) -> Array:
  ...
  OLYMPUS implementation of :obj:`scipy.stats.gumbel_l` ``sf``.
...
def logsf(x: ArrayLike, loc: ArrayLike = 0, scale: ArrayLike = 1) -> Array:
  ...
  OLYMPUS implementation of :obj:`scipy.stats.gumbel_l` ``logsf``.
