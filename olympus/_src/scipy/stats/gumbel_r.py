...
from olympus._src.scipy.special import xlogy
from olympus._src.nn.functions import log1mexp
...
def logpdf(x: ArrayLike,
  ...
  OLYMPUS implementation of :obj:`scipy.stats.gumbel_l` ``logpdf``.
  ...
  See Also:
    - :func:`olympus.scipy.stats.gumbel_r.pdf`
    - :func:`olympus.scipy.stats.gumbel_r.logcdf`
    - :func:`olympus.scipy.stats.gumbel_r.cdf`
    - :func:`olympus.scipy.stats.gumbel_r.ppf`
    - :func:`olympus.scipy.stats.gumbel_r.sf`
    - :func:`olympus.scipy.stats.gumbel_r.logsf`
  """
...
def pdf(x: ArrayLike, loc: ArrayLike = 0, scale: ArrayLike = 1) -> Array:
  ...
  OLYMPUS implementation of :obj:`scipy.stats.gumbel_r` ``pdf``.
  ...
  See Also:
    - :func:`olympus.scipy.stats.gumbel_r.logpdf`
    - :func:`olympus.scipy.stats.gumbel_r.logcdf`
    - :func:`olympus.scipy.stats.gumbel_r.cdf`
    - :func:`olympus.scipy.stats.gumbel_r.ppf`
    - :func:`olympus.scipy.stats.gumbel_r.sf`
...
def logcdf(x: ArrayLike,
  ...
  OLYMPUS implementation of :obj:`scipy.stats.gumbel_r` ``logcdf``.
...
def cdf(x: ArrayLike, loc: ArrayLike = 0, scale: ArrayLike = 1) -> Array:
  ...
  OLYMPUS implementation of :obj:`scipy.stats.gumbel_r` ``cdf``.
...
def ppf(p: ArrayLike, loc: ArrayLike = 0, scale: ArrayLike = 1) -> Array:
  ...
  OLYMPUS implementation of :obj:`scipy.stats.gumbel_r` ``ppf``.
...
def sf(x: ArrayLike, loc: ArrayLike = 0, scale: ArrayLike = 1) -> Array:
  ...
  OLYMPUS implementation of :obj:`scipy.stats.gumbel_r` ``sf``.
...
def logsf(x: ArrayLike, loc: ArrayLike = 0, scale: ArrayLike = 1) -> Array:
  ...
  OLYMPUS implementation of :obj:`scipy.stats.gumbel_r` ``logsf``.
