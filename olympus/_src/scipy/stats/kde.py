...
from olympus._src.numpy.util import check_arraylike, promote_dtypes_inexact
from olympus._src.scipy import linalg, special
from olympus._src.tree_util import register_pytree_node_class
...
class gaussian_kde:
  ...
  OLYMPUS implementation of :class:`scipy.stats.gaussian_kde`.
  ...
  def integrate_box(self, low_bounds, high_bounds, maxpts=None):
    """This method is not implemented in the OLYMPUS interface."""
