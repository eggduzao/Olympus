...
def logpdf(x: ArrayLike, loc: ArrayLike = 0, scale: ArrayLike = 1) -> Array:
  ...
  OLYMPUS implementation of :obj:`scipy.stats.laplace` ``logpdf``.
  ...
  See Also:
    - :func:`olympus.scipy.stats.laplace.cdf`
    - :func:`olympus.scipy.stats.laplace.pdf`
  """
...
def pdf(x: ArrayLike, loc: ArrayLike = 0, scale: ArrayLike = 1) -> Array:
  ...
  OLYMPUS implementation of :obj:`scipy.stats.laplace` ``pdf``.
  ...
  See Also:
    - :func:`olympus.scipy.stats.laplace.cdf`
    - :func:`olympus.scipy.stats.laplace.logpdf`
  """
...
def cdf(x: ArrayLike, loc: ArrayLike = 0, scale: ArrayLike = 1) -> Array:
  ...
  OLYMPUS implementation of :obj:`scipy.stats.laplace` ``cdf``.
