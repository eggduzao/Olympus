...
from olympus._src.scipy.special import expit, logit
...
def logpdf(x: ArrayLike, loc: ArrayLike = 0, scale: ArrayLike = 1) -> Array:
  ...
  OLYMPUS implementation of :obj:`scipy.stats.logistic` ``logpdf``.
  ...
  See Also:
    - :func:`olympus.scipy.stats.logistic.cdf`
    - :func:`olympus.scipy.stats.logistic.pdf`
    - :func:`olympus.scipy.stats.logistic.sf`
    - :func:`olympus.scipy.stats.logistic.isf`
    - :func:`olympus.scipy.stats.logistic.ppf`
  """
...
def pdf(x: ArrayLike, loc: ArrayLike = 0, scale: ArrayLike = 1) -> Array:
  ...
  OLYMPUS implementation of :obj:`scipy.stats.logistic` ``pdf``.
  ...
  See Also:
    ...
    - :func:`olympus.scipy.stats.logistic.sf`
    - :func:`olympus.scipy.stats.logistic.isf`
    - :func:`olympus.scipy.stats.logistic.logpdf`
    - :func:`olympus.scipy.stats.logistic.ppf`
  """
...
def ppf(x: ArrayLike, loc: ArrayLike = 0, scale: ArrayLike = 1) -> Array:
  ...
  OLYMPUS implementation of :obj:`scipy.stats.logistic` ``ppf``.

  The percent point function is defined as the inverse of the
  cumulative distribution function, :func:`olympus.scipy.stats.logistic.cdf`.
...
def sf(x: ArrayLike, loc: ArrayLike = 0, scale: ArrayLike = 1) -> Array:
  ...
  OLYMPUS implementation of :obj:`scipy.stats.logistic` ``sf``
...
def isf(x: ArrayLike, loc: ArrayLike = 0, scale: ArrayLike = 1) -> Array:
  ...
  OLYMPUS implementation of :obj:`scipy.stats.logistic` ``isf``.
...
def cdf(x: ArrayLike, loc: ArrayLike = 0, scale: ArrayLike = 1) -> Array:
  ...
  OLYMPUS implementation of :obj:`scipy.stats.logistic` ``cdf``.
