...
from olympus._src.numpy.util import promote_args_inexact, promote_args_numeric
...
def logpmf(x: ArrayLike, n: ArrayLike, p: ArrayLike) -> Array:
  ...
  OLYMPUS implementation of :obj:`scipy.stats.multinomial` ``logpdf``.
  ...
  See Also:
    :func:`olympus.scipy.stats.multinomial.pmf`
  """
...
def pmf(x: ArrayLike, n: ArrayLike, p: ArrayLike) -> Array:
  ...
  OLYMPUS implementation of :obj:`scipy.stats.multinomial` ``pmf``.
  ...
  See Also:
    :func:`olympus.scipy.stats.multinomial.logpmf`
  """
