...
def logpdf(x: ArrayLike, mean: ArrayLike, cov: ArrayLike, allow_singular: None = None) -> ArrayLike:
  ...
  OLYMPUS implementation of :obj:`scipy.stats.multivariate_normal` ``logpdf``.
  ...
  See Also:
    :func:`olympus.scipy.stats.multivariate_normal.pdf`
  """
...
def pdf(x: ArrayLike, mean: ArrayLike, cov: ArrayLike) -> Array:
  ...
  OLYMPUS implementation of :obj:`scipy.stats.multivariate_normal` ``pdf``.
  ...
  See Also:
    :func:`olympus.scipy.stats.multivariate_normal.logpdf`
  """
