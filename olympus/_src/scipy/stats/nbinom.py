...
def logpmf(k: ArrayLike, n: ArrayLike, p: ArrayLike, loc: ArrayLike = 0) -> Array:
  ...
  OLYMPUS implementation of :obj:`scipy.stats.nbinom` ``logpmf``.
  ...
  See Also:
    :func:`olympus.scipy.stats.nbinom.pmf`
  """
...
def pmf(k: ArrayLike, n: ArrayLike, p: ArrayLike, loc: ArrayLike = 0) -> Array:
  ...
  OLYMPUS implementation of :obj:`scipy.stats.nbinom` ``pmf``.
  ...
  See Also:
    :func:`olympus.scipy.stats.nbinom.logpmf`
  """
