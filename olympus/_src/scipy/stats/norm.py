...
from olympus._src.scipy import special
...
def logpdf(x: ArrayLike, loc: ArrayLike = 0, scale: ArrayLike = 1) -> Array:
  ...
  OLYMPUS implementation of :obj:`scipy.stats.norm` ``logpdf``.
  ...
  See Also:
    - :func:`olympus.scipy.stats.norm.cdf`
    - :func:`olympus.scipy.stats.norm.pdf`
    - :func:`olympus.scipy.stats.norm.sf`
    - :func:`olympus.scipy.stats.norm.logcdf`
    - :func:`olympus.scipy.stats.norm.logsf`
    - :func:`olympus.scipy.stats.norm.isf`
    - :func:`olympus.scipy.stats.norm.ppf`
  """
...
def pdf(x: ArrayLike, loc: ArrayLike = 0, scale: ArrayLike = 1) -> Array:
  ...
  OLYMPUS implementation of :obj:`scipy.stats.norm` ``pdf``.
  ...
  See Also:
    ...
    - :func:`olympus.scipy.stats.norm.sf`
    - :func:`olympus.scipy.stats.norm.logcdf`
    - :func:`olympus.scipy.stats.norm.logpdf`
    - :func:`olympus.scipy.stats.norm.logsf`
    - :func:`olympus.scipy.stats.norm.isf`
    - :func:`olympus.scipy.stats.norm.ppf`
  """
...
def cdf(x: ArrayLike, loc: ArrayLike = 0, scale: ArrayLike = 1) -> Array:
  ...
  OLYMPUS implementation of :obj:`scipy.stats.norm` ``cdf``.
...
def logcdf(x: ArrayLike, loc: ArrayLike = 0, scale: ArrayLike = 1) -> Array:
  ...
  OLYMPUS implementation of :obj:`scipy.stats.norm` ``logcdf``.
...
def ppf(q: ArrayLike, loc: ArrayLike = 0, scale: ArrayLike = 1) -> Array:
  ...
  OLYMPUS implementation of :obj:`scipy.stats.norm` ``ppf``.

  The percent point function is defined as the inverse of the
  cumulative distribution function, :func:`olympus.scipy.stats.norm.cdf`.
...
def logsf(x: ArrayLike, loc: ArrayLike = 0, scale: ArrayLike = 1) -> Array:
  ...
  OLYMPUS implementation of :obj:`scipy.stats.norm` ``logsf``.
...
def sf(x: ArrayLike, loc: ArrayLike = 0, scale: ArrayLike = 1) -> Array:
  ...
  OLYMPUS implementation of :obj:`scipy.stats.norm` ``sf``.
...
def isf(q: ArrayLike, loc: ArrayLike = 0, scale: ArrayLike = 1) -> Array:
  ...
  OLYMPUS implementation of :obj:`scipy.stats.norm` ``isf``.
