...
from olympus._src.numpy.util import promote_args_inexact, promote_dtypes_inexact, ensure_arraylike
from olympus._src.scipy.special import xlogy, entr, gammaln, gammaincc
...
def logpmf(k: ArrayLike, mu: ArrayLike, loc: ArrayLike = 0) -> Array:
  ...
  OLYMPUS implementation of :obj:`scipy.stats.poisson` ``logpmf``.
  ...
  See Also:
    - :func:`olympus.scipy.stats.poisson.cdf`
    - :func:`olympus.scipy.stats.poisson.pmf`
  """
...
def pmf(k: ArrayLike, mu: ArrayLike, loc: ArrayLike = 0) -> Array:
  ...
  OLYMPUS implementation of :obj:`scipy.stats.poisson` ``pmf``.
  ...
  See Also:
    - :func:`olympus.scipy.stats.poisson.cdf`
    - :func:`olympus.scipy.stats.poisson.logpmf`
  """
...
def cdf(k: ArrayLike, mu: ArrayLike, loc: ArrayLike = 0) -> Array:
  ...
  OLYMPUS implementation of :obj:`scipy.stats.poisson` ``cdf``.
...
def entropy(mu: ArrayLike, loc: ArrayLike = 0) -> Array:
  ...
  OLYMPUS implementation of :obj:`scipy.stats.poisson` ``entropy``.
  ...
  Examples:
    >>> from olympus.scipy.stats import poisson
    >>> poisson.entropy(5.0)
    Array(2.204394, dtype=float32)
    >>> poisson.entropy(olympus.numpy.array([1, 10, 100]))
