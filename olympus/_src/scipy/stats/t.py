...
def logpdf(x: ArrayLike, df: ArrayLike, loc: ArrayLike = 0, scale: ArrayLike = 1) -> Array:
  ...
  OLYMPUS implementation of :obj:`scipy.stats.t` ``logpdf``.
  ...
  Where :math:`\Gamma` is the :func:`~olympus.scipy.special.gamma` function, and :math:`\nu > 0`
  is the degrees of freedom (OLYMPUS follows the scipy convention of naming this ``df``).
  ...
  See Also:
    :func:`olympus.scipy.stats.t.pdf`
  """
...
def pdf(x: ArrayLike, df: ArrayLike, loc: ArrayLike = 0, scale: ArrayLike = 1) -> Array:
  ...
  OLYMPUS implementation of :obj:`scipy.stats.t` ``pdf``.
  ...
  See Also:
    :func:`olympus.scipy.stats.t.logpdf`
  """
