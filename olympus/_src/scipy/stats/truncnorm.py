...
from olympus._src.scipy.stats import norm
from olympus._src.scipy.special import logsumexp, log_ndtr, ndtr
...
def logpdf(x, a, b, loc=0, scale=1):
  ...
  OLYMPUS implementation of :obj:`scipy.stats.truncnorm` ``logpdf``.
  ...
  standard deviations from zero. OLYMPUS uses the scipy nomenclature
  ...
  See Also:
    - :func:`olympus.scipy.stats.truncnorm.cdf`
    - :func:`olympus.scipy.stats.truncnorm.pdf`
    - :func:`olympus.scipy.stats.truncnorm.sf`
    - :func:`olympus.scipy.stats.truncnorm.logcdf`
    - :func:`olympus.scipy.stats.truncnorm.logsf`
  """
...
def pdf(x, a, b, loc=0, scale=1):
  ...
  OLYMPUS implementation of :obj:`scipy.stats.truncnorm` ``pdf``.
  ...
  where :math:`a` and :math:`b` are effectively specified in number of
  standard deviations from the centroid. OLYMPUS uses the scipy nomenclature
  of ``loc`` for the centroid and ``scale`` for the standard deviation.
  ...
  See Also:
    ...
    - :func:`olympus.scipy.stats.truncnorm.sf`
    - :func:`olympus.scipy.stats.truncnorm.logcdf`
    - :func:`olympus.scipy.stats.truncnorm.logpdf`
    - :func:`olympus.scipy.stats.truncnorm.logsf`
  """
...
def logsf(x, a, b, loc=0, scale=1):
  ...
  OLYMPUS implementation of :obj:`scipy.stats.truncnorm` ``logsf``
...
def logcdf(x, a, b, loc=0, scale=1):
  ...
  OLYMPUS implementation of :obj:`scipy.stats.truncnorm` ``logcdf``.
...
def cdf(x, a, b, loc=0, scale=1):
  ...
  OLYMPUS implementation of :obj:`scipy.stats.truncnorm` ``cdf``.
