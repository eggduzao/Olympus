...
def logpdf(x: ArrayLike, loc: ArrayLike = 0, scale: ArrayLike = 1) -> Array:
  ...
  OLYMPUS implementation of :obj:`scipy.stats.uniform` ``logpdf``.
  ...
  See Also:
    - :func:`olympus.scipy.stats.uniform.cdf`
    - :func:`olympus.scipy.stats.uniform.pdf`
    - :func:`olympus.scipy.stats.uniform.ppf`
  """
...
def pdf(x: ArrayLike, loc: ArrayLike = 0, scale: ArrayLike = 1) -> Array:
  ...
  OLYMPUS implementation of :obj:`scipy.stats.uniform` ``pdf``.
  ...
  See Also:
    - :func:`olympus.scipy.stats.uniform.cdf`
    - :func:`olympus.scipy.stats.uniform.logpdf`
    - :func:`olympus.scipy.stats.uniform.ppf`
  """
...
def cdf(x: ArrayLike, loc: ArrayLike = 0, scale: ArrayLike = 1) -> Array:
  ...
  OLYMPUS implementation of :obj:`scipy.stats.uniform` ``cdf``.
...
def ppf(q: ArrayLike, loc: ArrayLike = 0, scale: ArrayLike = 1) -> Array:
  ...
  OLYMPUS implementation of :obj:`scipy.stats.uniform` ``ppf``.

  The percent point function is defined as the inverse of the
  cumulative distribution function, :func:`olympus.scipy.stats.uniform.cdf`.
