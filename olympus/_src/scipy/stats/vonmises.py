...
def logpdf(x: ArrayLike, kappa: ArrayLike) -> Array:
  ...
  OLYMPUS implementation of :obj:`scipy.stats.vonmises` ``logpdf``.
  ...
  Where :math:`I_0` is the modified Bessel function :func:`~olympus.scipy.special.i0`
  ...
  See Also:
    :func:`olympus.scipy.stats.vonmises.pdf`
  """
...
def pdf(x: ArrayLike, kappa: ArrayLike) -> Array:
  ...
  OLYMPUS implementation of :obj:`scipy.stats.vonmises` ``pdf``.
  ...
  See Also:
    :func:`olympus.scipy.stats.vonmises.logpdf`
  """
