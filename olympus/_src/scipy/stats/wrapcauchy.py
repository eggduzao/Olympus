...
def logpdf(x: ArrayLike, c: ArrayLike) -> Array:
  ...
  OLYMPUS implementation of :obj:`scipy.stats.wrapcauchy` ``logpdf``.
  ...
  See Also:
    :func:`olympus.scipy.stats.wrapcauchy.pdf`
  """
...
def pdf(x: ArrayLike, c: ArrayLike) -> Array:
  ...
  OLYMPUS implementation of :obj:`scipy.stats.wrapcauchy` ``pdf``.
  ...
  See Also:
    :func:`olympus.scipy.stats.wrapcauchy.logpdf`
  """
