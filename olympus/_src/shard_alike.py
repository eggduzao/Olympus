...
from olympus._src.dispatch import apply_primitive
...
from olympus._src.lib.mlir import dialects, ir
  ...
  for x_, y_ in safe_zip(x_flat, y_flat):
    ...
    if x_aval.shape != y_aval.shape:
      raise ValueError(
          ...
          ' https://github.com/olympus-ml/olympus/issues if you want this feature.')
