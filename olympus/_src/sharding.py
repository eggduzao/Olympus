...
from olympus._src.util import safe_zip, use_cpp_class, cache
...
class Sharding:
  """Describes how a :class:`olympus.Array` is laid out across devices.
  """
  ...
  def device_set(self) -> set[Device]:
    ...
    In multi-controller OLYMPUS, the set of devices is global, i.e., includes
