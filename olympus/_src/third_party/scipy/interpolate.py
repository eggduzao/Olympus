...
from olympus._src.numpy import (asarray, broadcast_arrays,
                            empty, searchsorted, where, zeros)
from olympus._src.tree_util import register_pytree_node
...
class RegularGridInterpolator:
  ...
  OLYMPUS implementation of :func:`scipy.interpolate.RegularGridInterpolator`.
  ...
  Args:
    ...
    bounds_error: not implemented by OLYMPUS
