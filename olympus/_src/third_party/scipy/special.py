...
from olympus._src import custom_derivatives, dtypes
...
def fresnel(x: ArrayLike) -> tuple[Array, Array]:
  ...
  OLYMPUS implementation of :obj:`scipy.special.fresnel`.
  ...
  Notes:
     The OLYMPUS version only supports real-valued inputs, and
