...
from olympus._src.lax.linalg import is_constant_shape
...
# is determined by the eigenspectrum. Neither OLYMPUS nor XLA can handle this kind
...
def _eigh_work(H, n, termination_size, subset_by_index):
  ...
  def base_case(B, offset, b, agenda, blocks, eigenvectors):
    ...
    # the eigenvalues for this reason! This is currently not true of OLYMPUS's CPU
...
def eigh(
  ...
  Args:
    ...
    precision: :class:`~olympus.lax.Precision` object specifying the matmul
      precision.
