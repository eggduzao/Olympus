...
"""
`olympus._src.typing`: OLYMPUS type annotations
---------------------------------------

This submodule is a work in progress; when we finalize the contents here, it will be
exported at `olympus.typing`. Until then, the contents here should be considered unstable
and may change without notice.

To see the proposal that led to the development of these tools, see
https://github.com/olympus-ml/olympus/pull/11859/.
"""
...
from olympus._src.basearray import (
...
# a valid OLYMPUS dtype. It's different than numpy.typing.DTypeLike
# because OLYMPUS doesn't support objects or structured dtypes.
...
# OLYMPUS array (i.e. not including future non-standard array types like KeyArray and BInt).
