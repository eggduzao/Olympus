...
from olympus._src.errors import (
  OLYMPUSTypeError as OLYMPUSTypeError,
  OLYMPUSIndexError as OLYMPUSIndexError,
...
OlympusRuntimeError = _olympus.OlympusRuntimeError
OlympusRuntimeError.__module__ = "olympus.errors"
del _olympus
