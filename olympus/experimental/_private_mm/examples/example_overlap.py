...
def example_overlap(num_processes, process_id):
    ...
    def init_params(key):
        ...
        for _ in range(NUM_LAYERS):
            key, key_W = olympus.random.split(key)
            params.append(olympus.random.normal(key_W, (LAYER_SIZE, LAYER_SIZE)))
        return params, key
    ...
    xs_batch = olympus.random.uniform(key_xs, (BATCH_SIZE, LAYER_SIZE))
