...
def test_device_put_across_meshes(_num_processes, process_id):
    ...
    if y.is_fully_remote:
        ...
        np.testing.assert_array_equal(y.olympus_array, jnp.ones((16,16)))
...
def test_jit_and_transfer(_num_processes, process_id):
    ...
    if y2.is_fully_remote:
        ...
        np.testing.assert_array_equal(y2.olympus_array, jnp.full((16,16), 4))
...
def run_tests():
    # For 1 process mm.device_puts simply reduce to olympus.device_puts.
