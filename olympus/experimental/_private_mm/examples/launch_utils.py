...
"""Utilities to launch multi-process OLYMPUS examples on a single host."""
...
def launch_example(num_processes, user_main, num_devices=8):
    ...
    Example code my_example.py:
        def my_example(num_processes, process_id):
            # Do some distributed OLYMPUS stuff.
            ...
    ...
    Usage:
        ...
        my_example.py 4
        # Run with olympus.profiler + annotations
        PROFILE=olympus python3 my_example.py 4
