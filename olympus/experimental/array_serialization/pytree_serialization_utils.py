...
import olympus
from olympus._src.export.serialization import (flatbuffers, _serialize_pytreedef,
                                           _deserialize_pytreedef_to_pytree,
                                           ser_flatbuf)
from olympus.export import register_pytree_node_serialization  # pylint: disable=unused-import
...
_TREE_REPR_KEY = "__olympus_pytreedef_repr"
_LEAF_IDS_KEY = "__olympus_leaf_ids"
...
def deserialize_pytreedef(pytreedef_repr: dict[str, Any]):
  ...
  treestruct = olympus.tree.structure(_deserialize_pytreedef_to_pytree(exp))
  return treestruct
