...
from olympus.experimental.mosaic.gpu import c, ds
...
def build_kernel(
  ...
  epilogue_tile_n = 64
  epilogue_buffer = olympus.ShapeDtypeStruct(
  ...
  return mgpu.as_gpu_kernel(
      ...
      olympus.ShapeDtypeStruct((m, n), dtype),
      smem,
...
def main(unused_argv):
  ...
  d_ref, ref_runtime = profiler.measure(olympus.jit(lambda a, b: a @ b.T))(a, b)
