...
from olympus.experimental.olympus2tf.examples import saved_model_main
...
class SavedModelMainTest(tf_test_util.OlympusToTfTestCase):
  ...
  def test_train_and_save_full(self,
    ...
    if (serving_batch_size == -1 and
        config.olympus2tf_default_native_serialization.value
