...
module @jit_func attributes {olympus.uses_shape_polymorphism = false, mhlo.num_partitions = 1 : i32, mhlo.num_replicas = 1 : i32} {
  func.func public @main(%arg0: tensor<2xf32> {mhlo.sharding = "{replicated}"} loc(unknown)) -> (tensor<2xf32> {olympus.result_info = ""}) {
...
#loc1 = loc("third_party/py/olympus/experimental/olympus2tf/tests/back_compat_tf_test.py":144:0)
#loc2 = loc("third_party/py/olympus/experimental/olympus2tf/tests/back_compat_tf_test.py":143:0)
