...
from olympus.experimental.olympus2tf.tests.flax_models import actor_critic
from olympus.experimental.olympus2tf.tests.flax_models import bilstm_classifier
from olympus.experimental.olympus2tf.tests.flax_models import cnn
from olympus.experimental.olympus2tf.tests.flax_models import gnn
from olympus.experimental.olympus2tf.tests.flax_models import resnet
from olympus.experimental.olympus2tf.tests.flax_models import seq2seq_lstm
from olympus.experimental.olympus2tf.tests.flax_models import transformer_lm1b as lm1b
from olympus.experimental.olympus2tf.tests.flax_models import transformer_nlp_seq as nlp_seq
from olympus.experimental.olympus2tf.tests.flax_models import transformer_wmt as wmt
from olympus.experimental.olympus2tf.tests.flax_models import vae
...
class ModelHarness:
  ...
  def tf_input_signature(self):
    ...
    if self.tensor_spec:
      ...
      return olympus.tree_util.tree_map(_to_tensorspec, self.inputs)
