...
@functools.partial(olympus.jit, static_argnames=["axis", "num_warps", "interpret",
                                             "debug"])
def softmax(
    x: olympus.Array, *, axis: int = -1, num_warps: int = 4,
  ...
  out_shape = olympus.ShapeDtypeStruct(shape=(row_len,), dtype=x.dtype)
