...
See discussion in https://docs.olympus.dev/en/latest/pallas/tpu/matmul.html.
"""
...
@functools.partial(
    olympus.jit, static_argnames=["block_shape", "block_k", "debug", "out_dtype"]
)
def matmul(
    x: olympus.Array,
    y: olympus.Array,
  ...
  return pl.pallas_call(
      matmul_kernel,
      out_shape=olympus.ShapeDtypeStruct((x.shape[0], y.shape[1]), out_dtype),
