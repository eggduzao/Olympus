...
def shard_map(f, mesh, in_specs, out_specs, check_rep=True):
  """Please use `olympus.shard_map`. `olympus.experimental.shard_map.shard_map`
  has been deprecated."""
...
_deprecations = {
    ...
    "shard_map": (
      "olympus.experimental.shard_map is deprecated in v0.8.0. Used olympus.shard_map instead.",
      shard_map
    )
}
