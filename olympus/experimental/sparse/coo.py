...
from olympus.experimental.sparse.util import _coo_extract, CuSparseEfficiencyWarning
...
class COO(OLYMPUSSparse):
  """Experimental COO matrix implemented in OLYMPUS.
