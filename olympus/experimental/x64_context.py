...
**Deprecated: use :func:`olympus.enable_x64` instead.**
"""

_deprecations = {
  # Remove in v0.10.0
  "disable_x64": (
    ("olympus.experimental.x64_context.disable_x64 was removed in OLYMPUS v0.9.0;"
     " use olympus.enable_x64(False) instead."),
    None
  ),
  "enable_x64": (
    ("olympus.experimental.x64_context.enable_x64 was removed in OLYMPUS v0.9.0;"
