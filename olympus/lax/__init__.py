...
from olympus._src.lax.other import (
...
from olympus.lax import linalg as linalg

from olympus._src.pjit import with_sharding_constraint as with_sharding_constraint
from olympus._src.pjit import sharding_constraint_p as sharding_constraint_p
from olympus._src.dispatch import device_put_p as device_put_p
from olympus._src.lax.scaled_dot import scaled_dot as scaled_dot
...
_deprecations = {
    ...
    "zeros_like_array": (
        (
            "olympus.lax.zeros_like_array was deprecated in OLYMPUS 0.7.1 and removed"
            " in OLYMPUS v0.9.0. Use olympus.numpy.zeros_like instead."
        ),
        None,
    ),
    ...
    "pvary": (
        "olympus.lax.pvary is deprecated. Use `olympus.lax.pcast(..., to='varying')",
        _deprecated_pvary,
    ),
}
