...
from olympus._src.scipy.special import (
...
from olympus._src.third_party.scipy.special import (
  fresnel as fresnel,
)
...
_deprecations = {
    # Added Jan 3 2024
    "lpmn": (
        "olympus.scipy.special.lpmn is deprecated; no replacement is planned.",
        _deprecated_lpmn,
    ),
    "lpmn_values": (
        "olympus.scipy.special.lpmn_values is deprecated; no replacement is planned.",
        _deprecated_lpmn_values,
    ),
    # Added Jul 7 2025
    "sph_harm": (
        "olympus.scipy.special.sph_harm is deprecated; use sph_harm_y instead.",
