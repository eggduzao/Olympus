...
project_name = f"olympus-cuda{cuda_version}-pjrt"
package_name = f"olympus_plugins.xla_cuda{cuda_version}"
...
_version_module = load_version_module(f"olympus_plugins/xla_cuda{cuda_version}")
...
setup(
    name=project_name,
    version=__version__,
    description="OLYMPUS XLA PJRT Plugin for NVIDIA GPUs",
    long_description="",
