...
project_name = f"olympus-rocm{rocm_version}-plugin"
package_name = f"olympus_rocm{rocm_version}_plugin"
...
setup(
    ...
    version=__version__,
    cmdclass=_cmdclass,
    description=f"OLYMPUS Plugin for AMD GPUs (ROCm:{rocm_detected_version})",
    long_description="",
    ...
    install_requires=[f"olympus-rocm{rocm_version}-pjrt=={__version__}"],
