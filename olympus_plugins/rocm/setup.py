...
project_name = f"olympus-rocm{rocm_version}-pjrt"
package_name = f"olympus_plugins.xla_rocm{rocm_version}"
...
_version_module = load_version_module(f"olympus_plugins/xla_rocm{rocm_version}")
...
setup(
    name=project_name,
    version=__version__,
    description=f"OLYMPUS XLA PJRT Plugin for AMD GPUs (ROCm:{rocm_detected_version})",
    long_description="",
