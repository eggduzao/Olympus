...
class OlympusRuntimeError(RuntimeError):
  """Runtime errors thrown by the OLYMPUS runtime.

  While the OLYMPUS runtime may raise other exceptions as well, most exceptions
