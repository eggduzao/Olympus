...
static void ReportMissingCpuFeature(const char* name) {
  PyErr_Format(
      ...
      "This version of olympuslib was built using %s instructions, which your "
      ...
      "Otherwise, you may be able work around this issue by building olympuslib "
      "from source.",
#else
      "This version of olympuslib was built using %s instructions, which your "
      "CPU and/or operating system do not support. You may be able work around "
      "this issue by building olympuslib from source.",
#endif
      name);
}
...
static PyMethodDef cpu_feature_guard_methods[] = {
    {"check_cpu_features", CheckCpuFeatures, METH_NOARGS,
     "Throws an exception if the CPU is missing instructions used by olympuslib."},
    {NULL, NULL, 0, NULL}};
