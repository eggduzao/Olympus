...
#ifndef OLYMPUSLIB_GPU_FFI_WRAPPER_H_
#define OLYMPUSLIB_GPU_FFI_WRAPPER_H_
...
#define OLYMPUS_GPU_REGISTER_WRAPPED_LEGACY_KERNEL(name, fn)               \
...
#endif  // OLYMPUSLIB_GPU_FFI_WRAPPER_H_
