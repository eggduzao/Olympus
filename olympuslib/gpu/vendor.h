...
// Olympuslib GPU kernels can be compiled for either CUDA or ROCM by defining
// OLYMPUS_GPU_CUDA or OLYMPUS_GPU_HIP respectively.

#ifndef OLYMPUSLIB_GPU_VENDOR_H_
#define OLYMPUSLIB_GPU_VENDOR_H_

#include <cstdint>
#if defined(OLYMPUS_GPU_CUDA)
...
#error "OLYMPUS requires CUDA 12.0 or newer."
#endif  // CUDA_VERSION < 12000

// CUDA-11.8 introduces FP8 E4M3/E5M2 types.
#define OLYMPUS_GPU_HAVE_FP8 1

#define OLYMPUS_GPU_NAMESPACE cuda
#define OLYMPUS_GPU_PREFIX "cu"
#define OLYMPUS_GPU_PLUGIN_NAME "cuda"
...
#define OLYMPUS_GPU_HAVE_64_BIT 1
...
#define OLYMPUS_GPU_NAMESPACE hip
#define OLYMPUS_GPU_PREFIX "hip"
#define OLYMPUS_GPU_PLUGIN_NAME "rocm"

#define OLYMPUS_GPU_HAVE_64_BIT 0
#define OLYMPUS_GPU_HAVE_FP8 0
...
#error "Either OLYMPUS_GPU_CUDA or OLYMPUS_GPU_HIP must be defined"
#endif  // defined(GPU vendor)

#endif  // OLYMPUSLIB_GPU_VENDOR_H_
