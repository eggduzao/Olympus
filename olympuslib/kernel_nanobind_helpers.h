...
#ifndef OLYMPUSLIB_KERNEL_NANOBIND_HELPERS_H_
#define OLYMPUSLIB_KERNEL_NANOBIND_HELPERS_H_
...
// Descriptor objects are opaque host-side objects used to pass data from OLYMPUS
...
#endif  // OLYMPUSLIB_KERNEL_NANOBIND_HELPERS_H_
