...
// Registers MLIR dialects used by OLYMPUS.
...
#include "olympuslib/mlir/_mlir_libs/traceback_to_location.h"
#include "olympuslib/mosaic/gpu/integrations/c/passes.h"
...
NB_MODULE(_olympus_mlir_ext, m) {
  m.doc() = "Registers upstream MLIR dialects used by OLYMPUS.";
