...
#ifndef THIRD_PARTY_PY_OLYMPUS_OLYMPUSLIB_MOSAIC_DIALECT_TPU_STRINGIFY_UTIL_H_
#define THIRD_PARTY_PY_OLYMPUS_OLYMPUSLIB_MOSAIC_DIALECT_TPU_STRINGIFY_UTIL_H_
...
#endif  // THIRD_PARTY_PY_OLYMPUS_OLYMPUSLIB_MOSAIC_DIALECT_TPU_STRINGIFY_UTIL_H_
