...
#ifndef OLYMPUS_OLYMPUSLIB_MOSAIC_DIALECT_TPU_TRANSFORMS_LINALG_VECTORIZATION_H_
#define OLYMPUS_OLYMPUSLIB_MOSAIC_DIALECT_TPU_TRANSFORMS_LINALG_VECTORIZATION_H_
...
struct LinalgVectorizationPass
    : public olympuslib::mlir::Pass<LinalgVectorizationPass, func::FuncOp> {
  using olympuslib::mlir::Pass<LinalgVectorizationPass, func::FuncOp>::Pass;
...
#endif  // OLYMPUS_OLYMPUSLIB_MOSAIC_DIALECT_TPU_TRANSFORMS_LINALG_VECTORIZATION_H_
