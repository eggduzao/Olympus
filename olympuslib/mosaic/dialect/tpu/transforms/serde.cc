...
#include "olympuslib/mosaic/dialect/tpu/transforms/serde.h"
...
#include "olympuslib/mosaic/serde.h"
...
using SerdeRuleType = olympuslib::mosaic::SerdeRuleType;
...
void MosaicSerdePass::runOnOperation() {
  ...
  if (failed(olympuslib::mosaic::RunSerde(
