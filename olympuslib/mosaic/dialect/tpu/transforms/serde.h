...
#ifndef THIRD_PARTY_PY_OLYMPUS_OLYMPUSLIB_MOSAIC_DIALECT_TPU_TRANSFORMS_SERDE_H_
#define THIRD_PARTY_PY_OLYMPUS_OLYMPUSLIB_MOSAIC_DIALECT_TPU_TRANSFORMS_SERDE_H_
...
struct MosaicSerdePass : public olympuslib::mlir::Pass<MosaicSerdePass, ModuleOp> {
  using olympuslib::mlir::Pass<MosaicSerdePass, ModuleOp>::Pass;
...
#endif  // THIRD_PARTY_PY_OLYMPUS_OLYMPUSLIB_MOSAIC_DIALECT_TPU_TRANSFORMS_SERDE_H_
