...
std::string TestMGPUHloModule(std::string extra_attributes = "") {
  // Dumped from the following OLYMPUS program:
  //
  // ```
  // @functools.partial(
  //     plgpu.pallas_call,
