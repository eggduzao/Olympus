...
#include "olympuslib/mosaic/gpu/passes.h"
...
#include "olympuslib/mosaic/pass_boilerplate.h"
...
class ConvertGpuToLLVMPass
    : public olympuslib::mlir::Pass<ConvertGpuToLLVMPass, mlir::ModuleOp> {
 public:
  using olympuslib::mlir::Pass<ConvertGpuToLLVMPass, mlir::ModuleOp>::Pass;
...
class ByvalInsertionPass
    : public olympuslib::mlir::Pass<ByvalInsertionPass, mlir::gpu::GPUModuleOp> {
 public:
  using olympuslib::mlir::Pass<ByvalInsertionPass, mlir::gpu::GPUModuleOp>::Pass;
...
class LLVMAttrInsertionPass
    : public olympuslib::mlir::Pass<LLVMAttrInsertionPass, mlir::gpu::GPUModuleOp> {
 public:
  using olympuslib::mlir::Pass<LLVMAttrInsertionPass, mlir::gpu::GPUModuleOp>::Pass;
...
class ResolveTrivialLocationsPass
    : public olympuslib::mlir::Pass<ResolveTrivialLocationsPass, mlir::ModuleOp> {
 public:
  using olympuslib::mlir::Pass<ResolveTrivialLocationsPass, mlir::ModuleOp>::Pass;
  static constexpr llvm::StringLiteral kArgumentName =
...
class MosaicGpuSinkMemRefDescriptorsPass
    : public olympuslib::mlir::Pass<MosaicGpuSinkMemRefDescriptorsPass,
                                mlir::ModuleOp> {
 public:
  using olympuslib::mlir::Pass<MosaicGpuSinkMemRefDescriptorsPass,
                           mlir::ModuleOp>::Pass;
  static constexpr llvm::StringLiteral kArgumentName =
