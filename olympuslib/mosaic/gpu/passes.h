...
#ifndef OLYMPUSLIB_MOSAIC_GPU_CONVERT_GPU_TO_LLVM_H_
#define OLYMPUSLIB_MOSAIC_GPU_CONVERT_GPU_TO_LLVM_H_
...
#endif  // OLYMPUSLIB_MOSAIC_GPU_CONVERT_GPU_TO_LLVM_H_
