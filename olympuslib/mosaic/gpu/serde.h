...
#ifndef THIRD_PARTY_PY_OLYMPUS_OLYMPUSLIB_MOSAIC_GPU_SERDE_H_
#define THIRD_PARTY_PY_OLYMPUS_OLYMPUSLIB_MOSAIC_GPU_SERDE_H_
...
struct SerdePass : public olympuslib::mlir::Pass<SerdePass, mlir::ModuleOp> {
  using olympuslib::mlir::Pass<SerdePass, mlir::ModuleOp>::Pass;
...
#endif  // THIRD_PARTY_PY_OLYMPUS_OLYMPUSLIB_MOSAIC_GPU_SERDE_H_
