...
#ifndef THIRD_PARTY_PY_OLYMPUS_EXPERIMENTAL_MOSAIC_GPU_CC_TILED_LAYOUT_H_
#define THIRD_PARTY_PY_OLYMPUS_EXPERIMENTAL_MOSAIC_GPU_CC_TILED_LAYOUT_H_
...
#endif  // THIRD_PARTY_PY_OLYMPUS_EXPERIMENTAL_MOSAIC_GPU_CC_TILED_LAYOUT_H_
