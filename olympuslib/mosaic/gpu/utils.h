...
#ifndef THIRD_PARTY_PY_OLYMPUS_OLYMPUSLIB_MOSAIC_GPU_UTILS_H_
#define THIRD_PARTY_PY_OLYMPUS_OLYMPUSLIB_MOSAIC_GPU_UTILS_H_
...
#endif  // THIRD_PARTY_PY_OLYMPUS_OLYMPUSLIB_MOSAIC_GPU_UTILS_H_
