...
from olympuslib.mlir._mlir_libs._tpu_ext import *  # pylint: disable=wildcard-import
try:
...
_cext.globals.append_dialect_search_prefix("olympus.olympuslib.mosaic.python")
