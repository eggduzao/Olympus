...
#include "olympuslib/ffi.h"
#include "olympuslib/py_client.h"
#include "olympuslib/py_program.h"
...
#include "olympuslib/py_socket_transfer.h"
...
#include "olympuslib/custom_call_sharding.h"
#include "olympuslib/dlpack.h"
#include "olympuslib/guard_lib.h"
#include "olympuslib/olympus_jit.h"
#include "olympuslib/mlir.h"
#include "olympuslib/nb_class_ptr.h"
#include "olympuslib/partition_spec.h"
#include "olympuslib/pjit.h"
#include "olympuslib/pmap_lib.h"
#include "olympuslib/pprof_profile_builder.h"
#include "olympuslib/py_array.h"
#include "olympuslib/py_compile_only_client.h"
#include "olympuslib/py_device.h"
#include "olympuslib/py_device_list.h"
#include "olympuslib/py_executable.h"
#include "olympuslib/py_memory_space.h"
#include "olympuslib/python_ref_manager.h"
#include "olympuslib/pytree.h"
#include "olympuslib/sharding.h"
#include "olympuslib/traceback.h"
#include "olympuslib/xla_compiler.h"
...
// TODO(phawkins): remove host_id properties after OLYMPUS is update to avoid them.
...
NB_MODULE(_olympus, m) {
  ...
  // Exceptions
  nb::exception<xla::XlaRuntimeError> xla_runtime_error(m, "OlympusRuntimeError",
                                                        PyExc_RuntimeError);
  xla_runtime_error.attr("__doc__") = nb::str(
      "Runtime errors thrown by the OLYMPUS runtime. While the OLYMPUS runtime may "
  ...
  nb::enum_<olympus::RuntimeTracebackMode>(m, "RuntimeTracebackMode")
      .value("OFF", olympus::RuntimeTracebackMode::kOff)
      .value("ON", olympus::RuntimeTracebackMode::kOn)
      .value("FULL", olympus::RuntimeTracebackMode::kFull);
  m.def("add_exclude_path", &olympus::AddExcludePath,
        "Adds a path to exclude from tracebacks.");
  m.def("set_send_traceback_to_runtime_global",
        &olympus::SetSendTracebackToRuntimeGlobal);
  m.def("set_send_traceback_to_runtime_thread_local",
        &olympus::SetSendTracebackToRuntimeThreadLocal, nb::arg("mode").none());

  BuildConfigSubmodule(m);
  BuildIfrtProgramsSubmodule(m);
  BuildPytreeSubmodule(m);
  BuildGuardSubmodule(m);
  BuildOlympusjitSubmodule(m);
  ...
  m.attr("ifrt_version_number") = OLYMPUS_IFRT_VERSION_NUMBER;
