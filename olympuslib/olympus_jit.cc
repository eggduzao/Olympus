...
// This files implements the `olympus.jit` dispatch and just-in-time feature.
//
...
void BuildOlympusjitSubmodule(nb::module_& m) {
  nb::module_ jitlib = m.def_submodule("olympus_jit", "Olympus C++ jit library");
  ...
  jitlib.def(
      ...
      R"doc(Parses the arguments to a function as olympus.jit would.
