...
#ifndef OLYMPUSLIB_OLYMPUS_JIT_H_
#define OLYMPUSLIB_OLYMPUS_JIT_H_
...
struct CallSignature {
  ...
  // The sharding of the olympus.Array arguments.
  std::vector<nanobind::object> dynamic_arg_shardings;

  // The layout of the olympus.Array arguments.
...
void BuildOlympusjitSubmodule(nanobind::module_& m);

}  // namespace olympus

#endif  // OLYMPUSLIB_OLYMPUS_JIT_H_
