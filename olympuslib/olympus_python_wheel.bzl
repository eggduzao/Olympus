...
""" Repository rule to generate a file with OLYMPUS wheel version. """

def _olympus_python_wheel_repository_impl(repository_ctx):
...
olympus_python_wheel_repository = repository_rule(
    implementation = _olympus_python_wheel_repository_impl,
    attrs = {
