...
#ifndef OLYMPUSLIB_PY_ARRAY_H_
#define OLYMPUSLIB_PY_ARRAY_H_
...
// The C++ implementation of olympus.Array. A few key methods and data members are
...
class PyArray : public nanobind::object {
 public:
  ...
  // olympus that cannot possibly have consistency issues (e.g. `sharding` devices
