...
#ifndef OLYMPUSLIB_PY_CLIENT_H_
#define OLYMPUSLIB_PY_CLIENT_H_
...
class PyClient {
 public:
  ...
  std::string_view platform_name() const {
    ...
    // we haven't yet updated OLYMPUS clients that expect "gpu". Migrate users and
    // remove this code.
