...
#ifndef OLYMPUSLIB_PY_COMPILE_ONLY_CLIENT_H_
#define OLYMPUSLIB_PY_COMPILE_ONLY_CLIENT_H_
...
// descriptions are better integrated into olympus's Python code. It returns a
...
#endif  // OLYMPUSLIB_PY_COMPILE_ONLY_CLIENT_H_
