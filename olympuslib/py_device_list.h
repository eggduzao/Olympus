...
#ifndef OLYMPUSLIB_PY_DEVICE_LIST_H_
#define OLYMPUSLIB_PY_DEVICE_LIST_H_
...
class PyDeviceList {
 public:
  ...
  // refs {
  //   module_path: "third_party/py/olympus/olympuslib/py_device_list.cc"
  //   module_arg {}
  // }
 ...
 private:
  ...
  // OLYMPUS backends and tests are migrated to use an `xla::ifrt::Device` type
  // for OLYMPUS devices.
...
#endif  // OLYMPUSLIB_PY_DEVICE_LIST_H_
