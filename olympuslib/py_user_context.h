...
#ifndef OLYMPUSLIB_PY_USER_CONTEXT_H_
#define OLYMPUSLIB_PY_USER_CONTEXT_H_
...
// IFRT `UserContext` implementation for OLYMPUS that captures a Python traceback.
...
class PyUserContext
 ...
 public:
  ...
  // Creates a `PyUserContext` with a new `Traceback`. If OLYMPUS `Traceback` is not
...
#endif  // OLYMPUSLIB_PY_USER_CONTEXT_H_
