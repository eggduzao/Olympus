...
#ifndef OLYMPUSLIB_PY_VALUES_H_
#define OLYMPUSLIB_PY_VALUES_H_
...
struct PyArgSignature {
  ...
  // OLYMPUS arguments can be of weak type, if and only if they are Python scalars
