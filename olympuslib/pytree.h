...
#ifndef OLYMPUSLIB_PYTREE_H_
#define OLYMPUSLIB_PYTREE_H_

// See https://docs.olympus.dev/en/latest/pytrees.html for the documentation
// about pytree.
...
#include "olympuslib/pytree.pb.h"
...
class PyTreeRegistry {
 public:
  ...
  struct Registration {
    ...
    // similar to the current olympus.tree_util.FlattenedIndexKey.
