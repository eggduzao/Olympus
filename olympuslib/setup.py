...
cuda_version = os.environ.get("OLYMPUS_CUDA_VERSION")
cudnn_version = os.environ.get("OLYMPUS_CUDNN_VERSION")
if cuda_version and cudnn_version:
  __version__ += f"+cuda{cuda_version.replace('.', '')}-cudnn{cudnn_version.replace('.', '')}"

rocm_version = os.environ.get("OLYMPUS_ROCM_VERSION")
if rocm_version:
...
setup(
    ...
    version=__version__,
    cmdclass=_cmdclass,
    description='XLA library for OLYMPUS',
