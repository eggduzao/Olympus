...
#ifndef OLYMPUSLIB_SHARDED_DEVICE_ARRAY_H_
#define OLYMPUSLIB_SHARDED_DEVICE_ARRAY_H_
...
// devices mesh. See Olympus pxla.py for the documentation.
//
...
#endif  // OLYMPUSLIB_SHARDED_DEVICE_ARRAY_H_
