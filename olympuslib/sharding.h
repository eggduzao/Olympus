...
#ifndef OLYMPUSLIB_SHARDING_H_
#define OLYMPUSLIB_SHARDING_H_
...
#include "olympuslib/cached_py_object.h"
...
// Gets `PyDeviceList` from a OLYMPUS Sharding.
...
// The C++ implementation of olympus.PmapSharding in python. It contains a few key
...
class GSPMDSharding : public Sharding {
 ...
 private:
  ...
  bool IsOpShardingReplicated() const {
    // For OLYMPUS, shardings with 1 device are considered as replicated in its
