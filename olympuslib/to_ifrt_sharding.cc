...
// Gets `xla::ifrt::DeviceList` from a OLYMPUS Sharding.
...
// Gets `xla::ifrt::MemoryKind` from a OLYMPUS Sharding.
...
// Converts a OLYMPUS Sharding into `xla::ifrt::HloSharding`.
...
// Converts a OLYMPUS Sharding into `xla::ifrt::ConcreteEvenSharding`.
...
// Converts a OLYMPUS Sharding into `xla::ifrt::ConcreteSharding`.
