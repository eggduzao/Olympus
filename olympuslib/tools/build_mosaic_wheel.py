...
# The olympus_wheel target passes in some extra params, which we ignore
...
def assemble_sources(
  ...
  wheel_sources_map = build_utils.create_wheel_sources_map(
      wheel_sources, root_packages=["olympuslib"]
  )
  ...
  copy_files(
      ...
      src_files=[
          ...
          f"{source_file_prefix}olympuslib/mosaic/gpu/wheel/setup.py",
      ],
  )
  ...
  copy_files(
      ...
      src_files=[
          f"{source_file_prefix}olympuslib/mosaic/gpu/wheel/mosaic_gpu.so",
          f"{source_file_prefix}olympuslib/mosaic/gpu/wheel/__init__.py",
