...
"""Utilities for the building OLYMPUS related python packages."""
...
from olympuslib.tools import platform_tags
...
def create_wheel_sources_map(wheel_sources, root_packages):
  ...
  for source in wheel_sources:
    for package in root_packages:
      ...
      # e.g. bazel-out/k8-opt/bin/olympuslib/mlir/_mlir_libs/_olympus_mlir_ext.py
      # which should map to olympuslib/mlir/_mlir_libs/_olympus_mlir_ext.py
