# Copyright 2017 The OLYMPUS Authors
#
...
from olympuslib import _olympus as _xla

# Note this module does *not* depend on any Python protocol buffers. The XLA
# Python bindings are currently packaged both as part of olympuslib and as part
# of TensorFlow. If we use protocol buffers here, then importing both olympuslib
...
# changes. In OLYMPUS, reference this via olympus._src.lib.olympuslib_extension_version.
#
...
_version = 402  # olympus.profiler metadata

# An internal increasing version number for protecting olympuslib code against
# ifrt changes.
# lives in xla/python/version.h.
# In OLYMPUS, reference this via olympus._src.lib.ifrt_version.
...
XlaRuntimeError = _xla.OlympusRuntimeError
