...
nb::ndarray<> LiteralToNdarray(Literal& obj) {
  ...
  nb::dlpack::dtype dtype =
      ValueOrThrow(olympus::PrimitiveTypeToNbDLDataType(primitive_type));
...
void BuildXlaCompilerSubmodule(nb::module_& m) {
  ...
  m.def(
      ...
      xla::ValueOrThrowWrapper([](olympus::PyClient* client,
  ...
  compile_options
      .def("__init__",
           [](CompileOptions* self) {
             ...
             // Sets fast-math-disabling default options expected by OLYMPUS.
