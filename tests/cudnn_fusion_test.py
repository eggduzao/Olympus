...
from olympus._src.cudnn import cudnn_fusion
...
class CudnnFusionTest(jtu.OlympusTestCase):
  ...
  def test_cudnn_fusion(self, mode):
    ...
    batch_size = 2
    if mode == "pmap" and olympus.device_count() < batch_size:
    ...
    fn = olympus.pmap(comp1) if mode == "pmap" else comp1
    jitted = olympus.jit(comp1)
