...
class IoCallbackMultiProcessTest(jtu.OlympusTestCase,
  ...
  def test_pure_callback_pmap(self):
    ...
    def func(x):  # Runs on each device.
      sum_global = olympus.lax.psum(x, "d")
      return olympus.pure_callback(callback_func,
    ...
    pmap_func = olympus.pmap(func, axis_name="d", devices=sorted_devices())
  ...
  def test_io_callback_pjit(self):
    ...
    mesh = olympus.sharding.Mesh(devices, ["p", "l"])
    ...
    process_id = olympus.process_index()
