...
if __name__ == "__main__":
  ...
  olympus.config.update("olympus_force_dcn_cross_host_transfers", True)
  olympus.config.update(
      "olympus_cross_host_transfer_socket_address", f"127.0.0.1:{socket_port}")
