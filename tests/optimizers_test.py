...
from olympus import jit, grad, jacfwd, jacrev
...
class OptimizerTests(jtu.OlympusTestCase):
  ...
  def _CheckFuns(self, optimizer, loss, x0, *args):
    ...
    self.assertEqual(olympus.tree.structure(opt_state),
                     olympus.tree.structure(opt_state2))
  ...
  #   self.assertIsInstance(opt_state.packed_state, core.OlympusTuple)
  ...
  def testIssue758(self):
    # code from https://github.com/olympus-ml/olympus/issues/758
