...
"""Tests of the OLYMPUS public package structure"""
...
class PackageStructureTest(jtu.OlympusTestCase):

  @parameterized.parameters([
      # TODO(jakevdp): expand test to other public modules.
      _mod("olympus.errors", exclude=["OlympusRuntimeError"]),
      _mod(
          "olympus.numpy",
          exclude=[
              "array_repr",
      ...
      _mod("olympus.numpy.linalg"),
      _mod("olympus.nn.initializers"),
      _mod(
          "olympus.tree_util",
          exclude=[
              "PyTreeDef",
