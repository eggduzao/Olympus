...
from olympus._src.internal_test_util.export_back_compat_test_data.pallas import mosaic_gpu_add_one
from olympus._src.internal_test_util.export_back_compat_test_data.pallas import mosaic_matmul
from olympus._src.internal_test_util.export_back_compat_test_data.pallas import mosaic_semaphore_dma
from olympus._src.internal_test_util.export_back_compat_test_data.pallas import triton_add_one
...
from olympus.experimental.pallas.ops.tpu import matmul
...
@jtu.with_config(olympus_include_full_tracebacks_in_locations=False)
  ...
  def test_triton_add_one(self):
    ...
    def func(x):
      ...
      return pl.pallas_call(add_one,
                            out_shape=olympus.ShapeDtypeStruct((8,), jnp.float32),
