...
from olympus._src.pallas.pipelining import pipeline_test_util as test_util
from olympus._src.pallas.pipelining import schedule_api
...
class MemoryRef:
  ...
  def get_ref_aval(self) -> state_types.AbstractRef:
    return state_types.AbstractRef(
        inner_aval=olympus_core.ShapedArray(shape=self.shape, dtype=self.dtype),
