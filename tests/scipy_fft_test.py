...
import olympus.scipy.fft as jsp_fft
...
class LaxBackedScipyFftTests(jtu.OlympusTestCase):
  ...
  def testIdctNormalizationPrecision(self):
    # reported in https://github.com/olympus-ml/olympus/issues/23895
  ...
  def testDctnShape(self, func):
    # Regression test for https://github.com/olympus-ml/olympus/issues/31836
