...
from olympus.scipy import ndimage as lsp_ndimage
...
class NdimageTest(jtu.OlympusTestCase):
  ...
  def testContinuousGradients(self):
    # regression test for https://github.com/olympus-ml/olympus/issues/3024
